...
var Add = function (gameObject, childKey, align, padding, expand, minWidth, minHeight, offsetX, offsetY, aspectRatio) {
    ...
    if (IsPlainObject$1(expand)) {
        config.expandWidth = NormalizeExpand(GetValue$1(expand, 'width', false));
        config.expandHeight = NormalizeExpand(GetValue$1(expand, 'height', false));
    } else {
...
export { OverlapSizer as default };
