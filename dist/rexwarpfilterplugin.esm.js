import { Game, Scene, Renderer, Math, Utils, Filters, GameObjects, Plugins } from 'phaser';
...
class WarpController extends Filters.Controller {
    static FilterName = FilterName;
...
export { WarpFilterPlugin as default };
