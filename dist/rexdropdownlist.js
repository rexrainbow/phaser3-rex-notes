(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncPosition = GetValue$Y(config, 'syncPosition', true);
      state.syncRotation = GetValue$Y(config, 'syncRotation', true);
      state.syncScale = GetValue$Y(config, 'syncScale', true);
      state.syncAlpha = GetValue$Y(config, 'syncAlpha', true);
      state.syncScrollFactor = GetValue$Y(config, 'syncScrollFactor', true);
      state.syncCameraFilter = GetValue$Y(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$Y(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  var Snapshot = function Snapshot(config) {
    ...
    var x = GetValue$X(config, 'x', undefined);
    var y = GetValue$X(config, 'y', undefined);
    var width = GetValue$X(config, 'width', undefined);
    var height = GetValue$X(config, 'height', undefined);
    var originX = GetValue$X(config, 'originX', 0);
    var originY = GetValue$X(config, 'originY', 0);
    var padding = GetValue$X(config, 'padding', 0);
    var scrollX, scrollY;
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$W(config, 'color');
      lineWidth = GetValue$W(config, 'lineWidth');
      fillColor = GetValue$W(config, 'fillColor');
      fillAlpha = GetValue$W(config, 'fillAlpha', 1);
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    var drawContainer = GetValue$V(config, 'drawContainer', true);
    var gameObjects = GetValue$V(config, 'children');
  ...
  Object.assign(methods$b, Parent, AddChild$2, RemoveChild$2, ChildState, Transform, Position, Rotation, Scale$1, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture);
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$R(config, 'eventEmitter', true));
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$Q(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$Q(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$Q(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$Q(o, 'onUpdateViewportCallbackScope');
  ...
  var methods$a = {};
  Object.assign(methods$a, ScaleMethods);
  methods$a.onInitScale = function () {
  ...
  var methods$9 = {};
  Object.assign(methods$9, FadeMethods);
  methods$9.onInitFade = function () {
  ...
  var methods$8 = {};
  Object.assign(methods$8, EaseMoveMethods);
  methods$8.onInitEaseMove = function () {
  ...
  var ShakePosition = /*#__PURE__*/function (_TickTask) {
    ...
    _createClass(ShakePosition, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setAxisMode(GetValue$I(o, "axis", 0));
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.setTransitInTime(GetValue$F(config, 'duration.in', 200));
      _this.setTransitOutTime(GetValue$F(config, 'duration.out', 200));
      _this.setTransitInCallback(GetValue$F(config, 'transitIn'));
      _this.setTransitOutCallback(GetValue$F(config, 'transitOut'));
      _this.oneShotMode = GetValue$F(config, 'destroy', false);
      _this.delayCallTimer = undefined;
      _this._state = new State(_assertThisInitialized(_this), {
        eventEmitter: false,
        initState: GetValue$F(config, 'initState', 'IDLE')
      });
  ...
  var TouchEventStop = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TouchEventStop, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setHitAreaMode(GetValue$E(o, 'hitAreaMode', 0));
        this.setEnable(GetValue$E(o, 'enable', true));
        this.setStopMode(GetValue$E(o, 'stopAllLevels', true));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Cover = /*#__PURE__*/function (_FullWindowRectangle) {
    ...
    function Cover(scene, config) {
      ...
      var fillColor = GetValue$D(config, 'color', 0x0);
      var fillAlpha = GetValue$D(config, 'alpha', 0.8);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      config.destroy = GetValue$C(config, 'destroy', true);
      _this = _callSuper(this, Modal, [gameObject, config]);
      // this.parent = gameObject;
      // this.scene

      // Cover : key of modal, to block touch input        
      var coverConfig = GetValue$C(config, 'cover');
      _this.cover = coverConfig !== false ? CreateCover(gameObject, coverConfig) : undefined;
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$C(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$C(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }

      // Close conditions:
      var touchOutsideClose = GetValue$C(config, 'touchOutsideClose', false);
      var timeOutDuration = GetValue$C(config, 'duration.hold', -1);
      var timeOutClose = GetValue$C(config, 'timeOutClose', timeOutDuration >= 0);
      var anyTouchClose = GetValue$C(config, 'anyTouchClose', false);
      var manualClose = GetValue$C(config, 'manualClose', false);
      if (manualClose) {
      ...
      if (GetValue$C(config, 'openOnStart', true)) {
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setClickInterval(GetValue$B(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$B(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var ClickOutside = /*#__PURE__*/function (_ComponentBase) {
    ...
    function ClickOutside(gameObject, config) {
      ...
      _this._enable = undefined;
      var inputConfig = GetValue$A(config, "inputConfig", undefined);
      if (inputConfig) {
    ...
    _createClass(ClickOutside, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$A(o, "mode", 1));
        this.setClickInterval(GetValue$A(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$A(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$z(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
    _createClass(InTouching, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setCooldown(GetValue$z(o, 'cooldown', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var DownChild = function DownChild(config) {
    var downConfig = GetValue$y(config, 'down', undefined);
    if (downConfig === false) {
      return;
  ...
  var UpChild = function UpChild(config) {
    var upConfig = GetValue$x(config, 'up', undefined);
    if (upConfig === false) {
      return;
  ...
  var OverChild = function OverChild(config) {
    var overConfig = GetValue$w(config, 'over', undefined);
    if (overConfig === false) {
      return;
    ...
    _createClass(OnePointerTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        if (this.gameObject === undefined) {
          this.setDetectBounds(GetValue$u(o, 'bounds', undefined));
        } else {
          this.setDetectBounds();
        }
  ...
  var Tap = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Tap, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setHoldTime(GetValue$t(o, 'time', 250)); // min-hold-time of Press is 251
        this.setTapInterval(GetValue$t(o, 'tapInterval', 200));
        this.setDragThreshold(GetValue$t(o, 'threshold', 9));
        this.setTapOffset(GetValue$t(o, 'tapOffset', 10));
        var taps = GetValue$t(o, 'taps', undefined);
        if (taps !== undefined) {
          this.setTaps(taps);
        } else {
          this.setMaxTaps(GetValue$t(o, 'maxTaps', undefined));
          this.setMinTaps(GetValue$t(o, 'minTaps', undefined));
        }
        return this;
      }
    }, {
  ...
  var Press = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Press, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setDragThreshold(GetValue$s(o, 'threshold', 9));
        this.setHoldTime(GetValue$s(o, 'time', 251));
        return this;
      }
    }, {
      key: "onDragStart",
  ...
  var Swipe = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Swipe, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setVelocityThreshold(GetValue$r(o, 'velocityThreshold', 1000));
        this.setDirectionMode(GetValue$r(o, 'dir', '8dir'));
        return this;
      }
    }, {
      key: "onDragStart",
  ...
  var TwoPointersTracer = /*#__PURE__*/function () {
    ...
    _createClass(TwoPointersTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.bounds = GetValue$q(o, 'bounds', undefined);
  ...
  var Rotate = /*#__PURE__*/function (_TwoPointersTracer) {
    ...
    _createClass(Rotate, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setDragThreshold(GetValue$p(o, 'threshold', 0));
        return this;
      }
    }, {
      key: "onDrag2Start",
  ...
  var TapChild = function TapChild(config) {
    var tapConfig = GetValue$o(config, 'tap', undefined);
    if (tapConfig === false) {
      return;
  ...
  var PressChild = function PressChild(config) {
    var pressConfig = GetValue$n(config, 'press', undefined);
  ...
  var SwipeChild = function SwipeChild(config) {
    var swipeConfig = GetValue$m(config, 'swipe', undefined);
  ...
  var SetChildrenInteractive$1 = function SetChildrenInteractive(gameObject, config) {
    gameObject.setInteractive();
    if (GetValue$l(config, 'dropZone', false)) {
      gameObject.input.dropZone = true;
    }
    gameObject._childrenInteractive = {
      targetSizers: GetValue$l(config, 'targets', [gameObject]),
      targetMode: GetValue$l(config, 'targetMode', 'parent'),
      eventEmitter: GetValue$l(config, 'eventEmitter', gameObject),
      eventNamePrefix: GetValue$l(config, 'inputEventPrefix', 'child.')
    };
  ...
  Object.assign(methods$5, PaddingMethods, AddChildMethods$4, RemoveChildMethods$4, GetParentSizerMethods, methods$a, methods$9, methods$8, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  var Base$1 = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      var origin = GetValue$k(config, 'origin', 0.5);
      var originX = GetValue$k(config, 'originX', origin);
      var originY = GetValue$k(config, 'originY', origin);
      _this.setOrigin(originX, originY);
      _this.setMinSize(minWidth, minHeight);
      _this.setName(GetValue$k(config, 'name', ''));
      _this.rexSizer = {};
      _this.space = {};
      ...
      var anchorConfig = GetValue$k(config, 'anchor', undefined);
      if (anchorConfig) {
        _this.setAnchor(anchorConfig);
      }
      _this.setInnerPadding(GetValue$k(config, 'space', 0));
      var draggable = GetValue$k(config, 'draggable', false);
      if (draggable) {
        _this.setDraggable(draggable);
      }
      _this.setSizerEventsEnable(GetValue$k(config, 'sizerEvents', false));
      _this.setDirty(true);
      if (GetValue$k(config, 'enableLayer', false)) {
        _this.enableLayer();
      }
      return _this;
    }
  ...
  Object.assign(Base$1.prototype, methods$5);
  ...
  var Add$3 = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    AddChild$1.call(this, gameObject);
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$j(config, 'proportion', undefined);
      align = GetValue$j(config, 'align', ALIGN_CENTER$1);
      paddingConfig = GetValue$j(config, 'padding', 0);
      expand = GetValue$j(config, 'expand', false);
      childKey = GetValue$j(config, 'key', undefined);
      index = GetValue$j(config, 'index', undefined);
      if (!gameObject.isRexSizer) {
        minWidth = GetValue$j(config, 'minWidth', undefined);
        minHeight = GetValue$j(config, 'minHeight', undefined);
      }
      fitRatio = GetValue$j(config, 'fitRatio', 0); // width/height
    }
  ...
  var AddChildMethods$3 = {
    ...
    insertSpace: function insertSpace(index, proportion) {
      ...
      Add$3.call(this, new Space$1(this.scene), {
    ...
    insert: function insert(index, gameObject, proportion, align, paddingConfig, expand, childKey, minSize) {
      ...
      Add$3.call(this, gameObject, proportion, align, paddingConfig, expand, childKey, index, minSize);
      // No problem if sizer.add is override
      return this;
    },
  ...
  Object.assign(methods$4, AddChildMethods$3, RemoveChildMethods$3, AlignMethods, ProportionMethods, ExpandMethods, SortChildrenMethods);
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      if (IsPlainObject$3(x)) {
        ...
        orientation = GetValue$i(config, 'orientation', 0);
      ...
      _this.setStartChildIndex(GetValue$i(config, 'startChildIndex', 0));
  ...
  Object.assign(LabelBase.prototype, methods$3);
  ...
  var DataMethods = {
    ...
    getData: function getData(key, defaultValue) {
      this.enableData();
      return key === undefined ? this.data : GetValue$G(this.data, key, defaultValue);
    },
  ...
  var RenderBase = /*#__PURE__*/function (_Base) {
    ...
    _createClass(RenderBase, [{
      ...
      value: function modifyPorperties(o) {
        ...
        // ScaleX, ScaleY
        var width = GetValue$h(o, 'width', undefined);
        var height = GetValue$h(o, 'height', undefined);
        var scaleX = GetValue$h(o, 'scaleX', undefined);
        var scaleY = GetValue$h(o, 'scaleY', undefined);
        if (width !== undefined) {
    ...
    _createClass(RoundRectangle, [{
      ...
      set: function set(value) {
        ...
        if (typeof value === 'number') {
          ...
          defaultRadiusX = GetValue$g(value, 'x', 0);
          defaultRadiusY = GetValue$g(value, 'y', 0);
        }
        var radius = this.cornerRadius;
        radius.tl = GetRadius(GetValue$g(value, 'tl', undefined), defaultRadiusX, defaultRadiusY);
        radius.tr = GetRadius(GetValue$g(value, 'tr', undefined), defaultRadiusX, defaultRadiusY);
        radius.bl = GetRadius(GetValue$g(value, 'bl', undefined), defaultRadiusX, defaultRadiusY);
        radius.br = GetRadius(GetValue$g(value, 'br', undefined), defaultRadiusX, defaultRadiusY);
      }
    }, {
      key: "radiusTL",
      get: function get() {
  ...
  var SetRadius = function SetRadius(radius, value) {
    if (typeof value === 'number') {
      ...
      radius.x = GetValue$g(value, 'x', 0);
      radius.y = GetValue$g(value, 'y', 0);
    }
    SetConvex(radius);
  };
  ...
  var Background = /*#__PURE__*/function (_RenderBase) {
    ...
    function Background(parent, config) {
      ...
      _this.setColor(GetValue$f(config, 'color', null), GetValue$f(config, 'color2', null), GetValue$f(config, 'horizontalGradient', true));
      _this.setStroke(GetValue$f(config, 'stroke', null), GetValue$f(config, 'strokeThickness', 2));
      _this.setCornerRadius(GetValue$f(config, 'cornerRadius', 0), GetValue$f(config, 'cornerIteration', null));
      return _this;
    }
  ...
  var InnerBounds = /*#__PURE__*/function (_RenderBase) {
    ...
    function InnerBounds(parent, config) {
      ...
      _this.setScrollFactor(0);
      _this.setColor(GetValue$e(config, 'color', null), GetValue$e(config, 'color2', null), GetValue$e(config, 'horizontalGradient', true));
      _this.setStroke(GetValue$e(config, 'stroke', null), GetValue$e(config, 'strokeThickness', 2));
      return _this;
    }
    _createClass(InnerBounds, [{
      ...
      value: function modifyPorperties(o) {
        ...
        if (o.hasOwnProperty('color')) {
          this.setColor(o.color, GetValue$e(o, 'color2', null), GetValue$e(o, 'horizontalGradient', true));
        }
        if (o.hasOwnProperty('stroke')) {
          this.setStroke(o.stroke, GetValue$e(o, 'strokeThickness', 2));
        }
      }
    }, {
      key: "renderContent",
  ...
  var TextStyle = /*#__PURE__*/function () {
    ...
    _createClass(TextStyle, [{
      ...
      value: function set(o) {
        this.setBold(GetValue$d(o, 'bold', false));
        this.setItalic(GetValue$d(o, 'italic', false));
        this.setFontSize(GetValue$d(o, 'fontSize', '16px'));
        this.setFontFamily(GetValue$d(o, 'fontFamily', 'Courier'));
        this.setColor(GetValue$d(o, 'color', '#fff'));
        this.setStrokeStyle(GetValue$d(o, 'stroke', null), GetValue$d(o, 'strokeThickness', 0));
        this.setShadow(GetValue$d(o, 'shadowColor', null), GetValue$d(o, 'shadowOffsetX', 0), GetValue$d(o, 'shadowOffsetY', 0), GetValue$d(o, 'shadowBlur', 0));
        this.setOffset(GetValue$d(o, 'offsetX', 0), GetValue$d(o, 'offsetY', 0));
        this.setSpace(GetValue$d(o, 'leftSpace', 0), GetValue$d(o, 'rightSpace', 0));
        this.setAlign(GetValue$d(o, 'align', undefined));
        this.setBackgroundColor(GetValue$d(o, 'backgroundColor', null));
        this.setBackgroundHeight(GetValue$d(o, 'backgroundHeight', undefined));
        this.setBackgroundBottomY(GetValue$d(o, 'backgroundBottomY', undefined));
        return this;
      }
    }, {
      key: "modify",
  ...
  var RunWordWrap$1 = function RunWordWrap(config) {
    ...
    var lineHeight = GetValue$c(config, 'lineHeight');
    var ascent = GetValue$c(config, 'ascent', lineHeight);
    var maxLines;
    if (lineHeight === undefined) {
      // Calculate lineHeight
      var useDefaultTextHeight = GetValue$c(config, 'useDefaultTextHeight', false);
      ...
      if (this.fixedHeight > 0) {
        ...
        maxLines = GetValue$c(config, 'maxLines');
    ...
    var wrapMode = GetValue$c(config, 'wrapMode');
    if (wrapMode === undefined) {
      var charWrap = GetValue$c(config, 'charWrap', false);
    ...
    // Get wrapWidth
    var wrapWidth = GetValue$c(config, 'wrapWidth', undefined);
    ...
    var hAlign = GetValue$c(config, 'hAlign', 0);
    var vAlign = GetValue$c(config, 'vAlign', 0);
    var justifyPercentage = GetValue$c(config, 'justifyPercentage', 0.25);
  ...
  var RunVerticalWrap$1 = function RunVerticalWrap(config) {
    // Parse parameters
    var startIndex = GetValue$b(config, 'start', 0);
    SetPadding$1(this.wrapPadding, GetValue$b(config, 'padding', 0));
    var paddingVertical = this.padding.top + this.padding.bottom + this.wrapPadding.top + this.wrapPadding.bottom;
    var paddingHorizontal = this.padding.left + this.padding.right + this.wrapPadding.left + this.wrapPadding.right;
    var lineWidth = GetValue$b(config, 'lineWidth', undefined);
    var maxLines;
    if (lineWidth === undefined) {
      // Calculate lineWidth via maxLines, in fixedWidth mode
      maxLines = GetValue$b(config, 'maxLines', 0);
      if (this.fixedWidth > 0) {
      ...
      if (this.fixedWidth > 0) {
        ...
        maxLines = GetValue$b(config, 'maxLines', undefined);
        if (maxLines === undefined) {
          var innerWidth = this.fixedWidth - paddingHorizontal;
          maxLines = Math.floor(innerWidth / lineWidth) + 1;
        }
      } else {
        maxLines = GetValue$b(config, 'maxLines', 0); // Default is show all lines
      }
    }
    var showAllLines = maxLines === 0;

    // Get fixedCharacterHeight
    var fixedCharacterHeight = GetValue$b(config, 'fixedCharacterHeight', undefined);
    if (fixedCharacterHeight === undefined) {
      var charPerLine = GetValue$b(config, 'charPerLine', undefined);
    ...
    // Get wrapHeight
    var wrapHeight = GetValue$b(config, 'wrapHeight', undefined);
    ...
    var letterSpacing = GetValue$b(config, 'letterSpacing', 0);
    var rtl = GetValue$b(config, 'rtl', true);
    var hAlign = GetValue$b(config, 'hAlign', rtl ? 2 : 0);
    var vAlign = GetValue$b(config, 'vAlign', 0);
    var result = CreateWrapResultData({
      // Override properties
  ...
  var RunWrap = function RunWrap(config) {
    var wrapCallback = GetValue$a(this.wrapConfig, 'callback');
    if (!wrapCallback) {
      wrapCallback = GetValue$a(config, 'callback', this.runWordWrap);
    }
  ...
  var DynamicText = /*#__PURE__*/function (_Canvas) {
    ...
    function DynamicText(scene, x, y, fixedWidth, fixedHeight, config) {
      ...
      if (IsPlainObject$2(x)) {
        ...
        fixedWidth = GetValue$9(config, 'width', 0);
        fixedHeight = GetValue$9(config, 'height', 0);
      ...
      var textStyleConfig = GetValue$9(config, 'style', undefined);
      _this.defaultTextStyle = new TextStyle(null, textStyleConfig);
      _this.textStyle = _this.defaultTextStyle.clone();
      _this.setTestString(GetValue$9(config, 'testString', '|MÉqgy'));
      _this._textOX = 0;
      _this._textOY = 0;
      _this.background = new Background(_assertThisInitialized(_this), GetValue$9(config, 'background', undefined));
      _this.innerBounds = new InnerBounds(_assertThisInitialized(_this), GetValue$9(config, 'innerBounds', undefined));
      _this.children = [];
      ...
      _this.setPadding(GetValue$9(config, 'padding', 0));
      _this.setWrapConfig(GetValue$9(config, 'wrap', undefined));
      _this.setChildrenInteractiveEnable(GetValue$9(config, 'childrenInteractive', false));
      var text = GetValue$9(config, 'text', undefined);
      if (text) {
        _this.setText(text);
      }
      return _this;
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      var icon = GetValue$8(config, 'icon', undefined);
      var iconMask = GetValue$8(config, 'iconMask', undefined);
      var text = GetValue$8(config, 'text', undefined);
      var action = GetValue$8(config, 'action', undefined);
      var actionMask = GetValue$8(config, 'actionMask', undefined);
      // Align
      var align = GetValue$8(config, 'align', undefined); // undefined/left/top: no space
      ...
      if (icon) {
        ...
        if (_this.orientation === 0) {
          if (text || action) {
            padding = {
              right: GetValue$8(config, 'space.icon', 0),
              top: GetValue$8(config, 'space.iconTop', 0),
              bottom: GetValue$8(config, 'space.iconBottom', 0),
              left: GetValue$8(config, 'space.iconLeft', 0)
            };
          }
        } else {
          if (text || action) {
            padding = {
              bottom: GetValue$8(config, 'space.icon', 0),
              left: GetValue$8(config, 'space.iconLeft', 0),
              right: GetValue$8(config, 'space.iconRight', 0),
              top: GetValue$8(config, 'space.iconTop', 0)
            };
          }
        }
        var fitRatio = GetValue$8(config, 'squareFitIcon', false) ? 1 : 0;
        _this.add(icon, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var iconSize = GetValue$8(config, 'iconSize', undefined);
          _this.setIconSize(GetValue$8(config, 'iconWidth', iconSize), GetValue$8(config, 'iconHeight', iconSize));
        }
      }
      if (text) {
        var wrapText = GetValue$8(config, 'wrapText', false);
        if (wrapText) {
          if (wrapText === true) {
            wrapText = 'word';
          }
        ...
        var textSpace = GetValue$8(config, 'space.text', 0);
        var expandTextWidth = GetValue$8(config, 'expandTextWidth', false);
        var expandTextHeight = GetValue$8(config, 'expandTextHeight', false);
      ...
      if (action) {
        ...
        if (_this.orientation === 0) {
          padding = {
            top: GetValue$8(config, 'space.actionTop', 0),
            bottom: GetValue$8(config, 'space.actionBottom', 0),
            right: GetValue$8(config, 'space.actionRight', 0)
          };
        } else {
          padding = {
            left: GetValue$8(config, 'space.actionLeft', 0),
            right: GetValue$8(config, 'space.actionRight', 0),
            bottom: GetValue$8(config, 'space.actionBottom', 0)
          };
        }
        var fitRatio = GetValue$8(config, 'squareFitAction', false) ? 1 : 0;
        _this.add(action, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var actionSize = GetValue$8(config, 'actionSize');
          _this.setActionSize(GetValue$8(config, 'actionWidth', actionSize), GetValue$8(config, 'actionHeight', actionSize));
        }
      }
  ...
  var ButtonsTypeMethods = {
    setButtonsType: function setButtonsType(config) {
      ...
      var buttonsType = GetValue$7(config, 'buttonsType', config.type);
      ...
      setValueCallback = GetValue$7(config, 'setValueCallback', undefined);
      setValueCallbackScope = GetValue$7(config, 'setValueCallbackScope', undefined);
      if (setValueCallback === undefined) {
        setValueCallback = GetValue$7(config, 'setButtonStateCallback', undefined);
        setValueCallbackScope = GetValue$7(config, 'setButtonStateCallbackScope', undefined);
      }
  ...
  Object.assign(ButtonGroup.prototype, AddMethods, RemoveMethods, ButtonsTypeMethods, ButtonMethods, methods$1);
  ...
  var Buttons$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Buttons(scene, config) {
      ...
      _this.buttonGroup = new ButtonGroup({
        ...
        eventEmitter: GetValue$6(config, 'eventEmitter', _assertThisInitialized(_this)),
        groupName: GetValue$6(config, 'groupName', undefined),
        clickConfig: GetValue$6(config, 'click', undefined)
      }).setButtonsType(config);

      // Add elements
      var background = GetValue$6(config, 'background', undefined);
      var buttons = GetValue$6(config, 'buttons', undefined);

      // Buttons properties
      _this.buttonsExpand = GetValue$6(config, 'expand', false);
      _this.buttonsAlign = GetValue$6(config, 'align', undefined); // undefined/left/top: no space                
  ...
  Object.assign(methods, AddChildMethods$1, RemoveChildMethods$1, SortChildrenMethods);
  ...
  var FixWidthSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function FixWidthSizer(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setLineSpacing(GetValue$4(config, 'space.line', 0));
      _this.setIntentLeft(GetValue$4(config, 'space.indentLeftOdd', 0), GetValue$4(config, 'space.indentLeftEven', 0));
      _this.setIntentTop(GetValue$4(config, 'space.indentTopOdd', 0), GetValue$4(config, 'space.indentTopEven', 0));
      _this.setAlign(GetValue$4(config, 'align', 0));
      _this.setJustifyPercentage(GetValue$4(config, 'justifyPercentage', 0.25));
  ...
  var Buttons = /*#__PURE__*/function (_FixWidthSizer) {
    ...
    function Buttons(scene, config) {
      ...
      _this.buttonGroup = new ButtonGroup({
        parent: _assertThisInitialized(_this),
        eventEmitter: GetValue$3(config, 'eventEmitter', _assertThisInitialized(_this)),
        groupName: GetValue$3(config, 'groupName', undefined),
        clickConfig: GetValue$3(config, 'click', undefined)
      }).setButtonsType(config);

      // Add elements
      var background = GetValue$3(config, 'background', undefined);
      var buttons = GetValue$3(config, 'buttons', undefined);

      // Buttons properties
      _this.buttonsAlign = GetValue$3(config, 'align', undefined);
      if (background) {
        _this.addBackground(background);
      }
      if (buttons) {
  ...
  var GetValueFromAliasKeys = function GetValueFromAliasKeys(source, key0, key1, key2, defaultValue) {
    if (HasValue(source, key0)) {
      return GetValue$G(source, key0);
    } else if (key1 && HasValue(source, key1)) {
      return GetValue$G(source, key1);
    } else if (key2 && HasValue(source, key2)) {
      return GetValue$G(source, key2);
    } else {
      return defaultValue;
    }
  };
  ...
  Object.assign(Methods, methods$2, FocusButtonMethods);
  ...
  var DropDownList = /*#__PURE__*/function (_Label) {
    ...
    function DropDownList(scene, config) {
      ...
      _this.setListAlignmentSide(GetValue(listConfig, 'alignSide', ''));
      _this.setListBounds(GetValue(listConfig, 'bounds'));
      _this.setListSpace(GetValue(listConfig, 'space'));
      _this.setListDraggable(GetValue(listConfig, 'draggable', false));
      _this.setValueChangeCallback(GetValue(config, 'setValueCallback'), GetValue(config, 'setValueCallbackScope'));
      _this.setValue(GetValue(config, 'value'));
