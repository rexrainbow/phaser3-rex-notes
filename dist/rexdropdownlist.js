  ...
  */
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this = _super.call(this, parent, config);
      _this.tickEventName = GetValue$z(config, 'tickEventName', 'update');
      return _this;
    }
  ...
  var ClickOutside = /*#__PURE__*/function (_ComponentBase) {
    ...
    function ClickOutside(gameObject, config) {
      ...
      _this._enable = undefined;
      var inputConfig = GetValue$q(config, "inputConfig", undefined);
      if (inputConfig) {
  ...
  var ResolveHeight = function ResolveHeight(parent, height) {
    var height = ResolveHeight$1.call(this, parent, height);
  ...
  var Label = /*#__PURE__*/function (_Sizer) {
    ...
    function Label(scene, config) {
      ...
      var icon = GetValue$6(config, 'icon', undefined);
      var iconMask = GetValue$6(config, 'iconMask', undefined);
      var text = GetValue$6(config, 'text', undefined);
      var action = GetValue$6(config, 'action', undefined);
      var actionMask = GetValue$6(config, 'actionMask', undefined);
      // Align
      var align = GetValue$6(config, 'align', undefined); // undefined/left/top: no space
      // Space
      var iconSpace = GetValue$6(config, 'space.icon', 0);
      var textSpace = GetValue$6(config, 'space.text', 0);
      if (background) {
      ...
      var iconSize = GetValue$6(config, 'iconSize');
      _this.setIconSize(GetValue$6(config, 'iconWidth', iconSize), GetValue$6(config, 'iconHeight', iconSize));
      if (text) {
        var expandTextWidth = GetValue$6(config, 'expandTextWidth', false);
        var expandTextHeight = GetValue$6(config, 'expandTextHeight', false);
      ...
      var actionSize = GetValue$6(config, 'actionSize');
      _this.setActionSize(GetValue$6(config, 'actionWidth', actionSize), GetValue$6(config, 'actionHeight', actionSize));
  ...
  var Initialize = function Initialize(config) {
    ...
    var dataManager = GetValue$5(config, 'dataManager', undefined);
    ...
    setValueCallback = GetValue$5(config, 'setValueCallback', undefined);
    setValueCallbackScope = GetValue$5(config, 'setValueCallbackScope', undefined);
    if (setValueCallback === undefined) {
      setValueCallback = GetValue$5(config, 'setButtonStateCallback', undefined);
      setValueCallbackScope = GetValue$5(config, 'setButtonStateCallbackScope', undefined);
    }
  ...
  var SetTypeMethods = {
    setButtonsType: function setButtonsType(config) {
      ...
      var buttonsType = GetValue$5(config, 'buttonsType', config.type);
  ...
  var Buttons$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Buttons(scene, config) {
      ...
      // Buttons properties
      _this.buttonsExpand = GetValue$4(config, 'expand', false);
      _this.buttonsAlign = GetValue$4(config, 'align', undefined); // undefined/left/top: no space                
  ...
  var Buttons = /*#__PURE__*/function (_FixWidthSizer) {
    ...
    function Buttons(scene, config) {
      ...
      // Buttons properties
      _this.buttonsAlign = GetValue$1(config, 'align', undefined);
      if (background) {
        _this.addBackground(background);
      }
      if (buttons) {
