...
class FishEyeFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class FishEyeController extends Filters.Controller {
    static FilterName = FilterName;
...
export { FishEyeFilterPlugin as default };
