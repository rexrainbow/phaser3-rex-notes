import { Events, Actions, Game, Scene, GameObjects, Renderer, Utils, Filters, Geom, Math as Math$1, Cameras, Plugins } from 'phaser';
...
class CircleController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setThickness(GetValue$5(o, 'thickness', 8));
        this.setScale(GetValue$5(o, 'scale', 1));
        this.setFeather(GetValue$5(o, 'feather', 0.005));
        this.setColor(GetValue$5(o, 'color', 0xFF33B2));
        this.setBackgroundColor(GetValue$5(o, 'backgroundColor', 0xFF0000));
        this.setBackgroundAlpha(GetValue$5(o, 'backgroundAlpha', 0.4));
...
class GradientController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setAlpha(GetValue$4(o, 'alpha', 0.2));
        this.setFromPosition(GetValue$4(o, 'fromX', 0), GetValue$4(o, 'fromY', 0));
        this.setToPosition(GetValue$4(o, 'toX', 0), GetValue$4(o, 'toY', 1));
        this.setColor1(GetValue$4(o, 'color1', 0xff0000));
        this.setColor2(GetValue$4(o, 'color2', 0x00ff00));
        this.setSize(GetValue$4(o, 'size', 0));
...
class ShineController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setSpeed(GetValue$3(o, 'speed', 0.5));
        this.setLineWidth(GetValue$3(o, 'lineWidth', 0.5));
        this.setGradient(GetValue$3(o, 'gradient', 3));
        this.setReveal(GetValue$3(o, 'reveal', false));
...
class LayerManagerPlugin extends Plugins.BasePlugin {
...
export { LayerManagerPlugin as default };
