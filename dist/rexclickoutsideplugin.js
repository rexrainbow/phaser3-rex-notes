(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexclickoutsideplugin = factory());
  ...
  var ClickOutsidePlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(ClickOutsidePlugin, _Phaser$Plugins$BaseP);
    function ClickOutsidePlugin(pluginManager) {
      _classCallCheck(this, ClickOutsidePlugin);
      return _callSuper(this, ClickOutsidePlugin, [pluginManager]);
    }
    _createClass(ClickOutsidePlugin, [{
      key: "start",
