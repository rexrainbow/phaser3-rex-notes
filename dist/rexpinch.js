(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexpinch = factory());
  ...
  var FSM = /*#__PURE__*/function () {
    ...
    */
    function FSM(config) {
      ...
      var states = GetValue$4(config, 'states', undefined);
      ...
      var extend = GetValue$4(config, 'extend', undefined);
      ...
      var eventEmitter = GetValue$4(config, 'eventEmitter', undefined);
      var EventEmitterClass = GetValue$4(config, 'EventEmitterClass', undefined);
    ...
    _createClass(FSM, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.start(GetValue$4(o, 'start', undefined));
        var init = GetValue$4(o, 'init', undefined);
      ...
      value: function addState(name, config) {
        var getNextStateCallback = GetValue$4(config, 'next', undefined);

        if (getNextStateCallback) {
          this['next_' + name] = getNextStateCallback;
        }

        var exitCallback = GetValue$4(config, 'exit', undefined);

        if (exitCallback) {
          this['exit_' + name] = exitCallback;
        }

        var enterCallback = GetValue$4(config, 'enter', undefined);
