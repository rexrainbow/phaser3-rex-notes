...
var WebGLRenderer$3 = function (renderer, container, drawingContext, parentMatrix, renderStep, displayList, displayListIndex) {
...
const Components$3 = GameObjects.Components;
Class.mixin(Base$4,
    [
        Components$3.Alpha,
        Components$3.Flip
...
const Rectangle$6 = Geom.Rectangle;
...
const GetAdvancedValue$4 = Utils$3.Objects.GetAdvancedValue;
...
var RemoveItem$4 = Utils$3.Array.Remove;
...
const Rectangle$3 = GameObjects.Rectangle;
...
const TransformMatrix$3 = GameObjects.Components.TransformMatrix;
...
var GetMaskFilterViewTransformByScaleFactor = function (maskGameObject, scaleFactor, maskType, viewTransform) {
    ...
    if (viewTransform === undefined) {
        viewTransform = new TransformMatrix$3();
    }
...
const ParentTransform = new TransformMatrix$3();
...
class RectangleMask extends Base$2 {
    constructor(parent, padding) {
        ...
        this._maskFilterViewTransform = new TransformMatrix$2();
...
const UUID$1 = Utils$3.String.UUID;
const DefaultImageNodes$1 = Renderer$1.WebGL.RenderNodes.Defaults.DefaultImageNodes;
...
const Components$2 = GameObjects.Components;
Class.mixin(Canvas,
    [
        Components$2.Alpha,
        ...
        Components$2.Lighting,
        Components$2.Mask,
        Components$2.Origin,
        Components$2.RenderNodes,
...
var DrawFrameToCanvas = function (frame, canvasOrContext, x, y, width, height, color, autoRound, tintMode) {
    ...
    if (color === undefined || color === null || typeof tintMode !== 'number') {
        ...
        // Get tempCanvas
        var tempCanvas = CanvasPool$3.create(null, width, height, CANVAS, true);
...
const GetFastValue$1 = Utils$3.Objects.GetFastValue;
...
class StyleManager extends ComponentBase {
    constructor(gameObject, config) {
        ...
        this.style = GetValue$z(config, 'style', this);

        var propertiesMap = GetValue$z(config, 'propertiesMap');
        ...
        this.onModifyStyle = GetValue$z(config, 'onModifyStyle');
    }
...
function ProgressBase (BaseClass) {
    class ProgressBase extends BaseClass {
        bootProgressBase(config) {
            this.eventEmitter = GetValue$y(config, 'eventEmitter', this);
            ...
            this
                ...
                .setEaseValueDuration(GetValue$y(config, 'easeValue.duration', 0))
                .setEaseValueFunction(GetValue$y(config, 'easeValue.ease', 'Linear'));
...
class LineProgress extends ProgressBase(BaseShapes) {
    constructor(scene, x, y, width, height, barColor, value, config) {
        ...
        this.setTrackColor(GetValue$x(config, 'trackColor', undefined));
        this.setBarColor(barColor);
        this.setTrackStroke(GetValue$x(config, 'trackStrokeThickness', 2), GetValue$x(config, 'trackStrokeColor', undefined));

        this.setSkewX(GetValue$x(config, 'skewX', 0));
...
class GradientController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setAlpha(GetValue$w(o, 'alpha', 0.2));
        this.setFromPosition(GetValue$w(o, 'fromX', 0), GetValue$w(o, 'fromY', 0));
        this.setToPosition(GetValue$w(o, 'toX', 0), GetValue$w(o, 'toY', 1));
        this.setColor1(GetValue$w(o, 'color1', 0xff0000));
        this.setColor2(GetValue$w(o, 'color2', 0x00ff00));
        this.setSize(GetValue$w(o, 'size', 0));
 ...
 */
var Clamp$4 = function (value, min, max)
{
    ...
    Object.defineProperty(gameObject, 'revealLeft', {
        ...
        set: function (value) {
            ...
            if ((revealLeft === null) || (revealLeft === false)) {
                ...
                revealLeft = Clamp$4(revealLeft, 0, 1);
    ...
    Object.defineProperty(gameObject, 'revealRight', {
        ...
        set: function (value) {
            ...
            if ((revealRight === null) || (revealRight === false)) {
                ...
                revealRight = Clamp$4(revealRight, 0, 1);
    ...
    Object.defineProperty(gameObject, 'revealDown', {
        ...
        set: function (value) {
            ...
            if ((revealDown === null) || (revealDown === false)) {
                ...
                revealDown = Clamp$4(revealDown, 0, 1);
...
class ShineController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setSpeed(GetValue$v(o, 'speed', 0.5));
        this.setLineWidth(GetValue$v(o, 'lineWidth', 0.5));
        this.setGradient(GetValue$v(o, 'gradient', 3));
        this.setReveal(GetValue$v(o, 'reveal', false));
    ...
    Object.defineProperty(gameObject, 'wipeRight', {
        ...
        set: function (value) {
            ...
            if ((wipeRight === null) || (wipeRight === false)) {
                ...
                wipeRight = Clamp$4(wipeRight, 0, 1);
...
var NinePatchBase = function (GOClass, type) {
    class NinePatch extends GOClass {
        constructor(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
            ...
            this.setGetFrameNameCallback(GetValue$r(config, 'getFrameNameCallback', undefined));
            this.setStretchMode(GetValue$r(config, 'stretchMode', 0));
            this.setPreserveRatio(GetValue$r(config, 'preserveRatio', true));
...
const PhaserText = GameObjects.Text;
const GetValue$p = Utils$3.Objects.GetValue;
...
class Pen {
    ...
    resetFromJSON(o) { // (txt, x, y, width, height, ascent, descent, prop, newLineMode, startIndex)
        ...
        this.ascent = GetValue$n(o, 'ascent', 0);
        this.descent = GetValue$n(o, 'descent', 0);
        var height = GetValue$n(o, 'height', null);
        if (height == null) {
...
class Text extends TextBase {
    constructor(scene, x, y, text, style, type, parser) {
        ...
        this.setUrlTagCursor(GetValue$k(style, 'urlTagCursorStyle', 'pointer'));
...
const PhaserBitmapText = GameObjects.BitmapText;
const GetValue$i = Utils$3.Objects.GetValue;
...
class GridSizer extends Base$3 {
    constructor(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
        ...
        this.sizerChildren = [];
        this.addChildrenMap('items', this.sizerChildren);
        this.setCreateCellContainerCallback(GetValue$f(config, 'createCellContainerCallback'));

        this.setIndentLeft(
            GetValue$f(config, 'space.indentLeftOdd', 0),
            GetValue$f(config, 'space.indentLeftEven', 0)
        );
        this.setIndentTop(
            GetValue$f(config, 'space.indentTopOdd', 0),
            GetValue$f(config, 'space.indentTopEven', 0)
        );

        this.resetGrid(
            columnCount, rowCount,
            columnProportions, rowProportions,
            GetValue$f(config, 'space', undefined)
        );
        ...
        childParent.add(child,
            {
                ...
                expand: {
                    width: GetValue$e(childConfig, 'expandWidth', true),  // Private
...
class Slider extends ProgressBase(Sizer) {
    constructor(scene, config) {
        ...
        this.reverseAxis = GetValue$c(config, 'reverseAxis', false);
...
class ScrollBar extends Sizer {
    constructor(scene, config) {
        ...
        this.setValue(GetValue$b(config, 'value', 0));
        this.setScrollStep(GetValue$b(buttonsConfig, 'step', 0.01));
    }
...
class DragSpeed extends ComponentBase {
    constructor(gameObject, config) {
        ...
        this.rectBoundsInteractive = GetValue$a(config, 'rectBoundsInteractive', false);
...
class Scroller extends ComponentBase {
    constructor(gameObject, config) {
        ...
        var drapSpeedConfig = {
            rectBoundsInteractive: GetValue$8(config, 'rectBoundsInteractive', false),
        ...
        this.setSnapStep(GetValue$8(config, 'snapStep', undefined));
...
class MouseWheelScroller extends ComponentBase {
    constructor(gameObject, config) {
        ...
        if (this.parent !== this.scene) {
            this.focusMode = GetValue$7(config, 'focus', true);
        } else {
        ...
        this.setSpeed(GetValue$7(config, 'speed', 0.1));
        this.setEnable(GetValue$7(config, 'enable', true));
        ...
        switch (this.focusMode) {
            ...
            default:  // case 1
                gameObject
                    .setInteractive(GetValue$7(config, "inputConfig", undefined))
...
var AddSlider = function (topPatent, sliderParent, axis, config) {
    ...
    if (isScrollXYMode) {
        snapStep = GetValue$6(config, snapStepKey, undefined);
    } else {
        var snapStep = GetValue$6(config, 'snapStep', undefined);
    ...
    if (sliderConfig) {
        ...
        3. space.child
        */
        var sliderPadding = GetValue$6(config, `space.slider${axis}`, undefined);
            ...
            if (sliderPosition === 0) { // right
                ...
                if (childPadding === undefined) {
                    ...
                    if (isNumberChildPadding) {
                        ...
                        padding = { left: GetValue$6(childPadding, 'right', 0) };
                    }
                }
                ...
                if (childPadding === undefined) {
                    ...
                    if (isNumberChildPadding) {
                        ...
                        padding = { right: GetValue$6(childPadding, 'left', 0) };
                    }
                }
            }
            ...
            if (sliderPosition === 0) { // bottom
                ...
                if (childPadding === undefined) {
                    ...
                    if (isNumberChildPadding) {
                        ...
                        padding = { top: GetValue$6(childPadding, 'bottom', 0) };
                    }
                }
                ...
                if (childPadding === undefined) {
                    ...
                    if (isNumberChildPadding) {
                        ...
                        padding = { bottom: GetValue$6(childPadding, 'top', 0) };
                    }
                }
            }
        }
        ...
        topPatent[`hideUnscrollableSlider${axis}`] = GetValue$6(sliderConfig, 'hideUnscrollableSlider', false);
        topPatent[`disableUnscrollableDrag${axis}`] = GetValue$6(sliderConfig, 'disableUnscrollableDrag', false);
        topPatent[`adaptThumb${axis}SizeMode`] = GetValue$6(sliderConfig, 'adaptThumbSize', false);
        topPatent[`minThumb${axis}Size`] = GetValue$6(sliderConfig, 'minThumbSize', undefined);
    ...
    var scrollDetectionMode = GetValue$6(config, 'scrollDetectionMode');
    ...
    var mouseWheelScrollerConfig = GetValue$6(config, ((isScrollXYMode) ? `mouseWheelScroller${axis}` : 'mouseWheelScroller'), false),
        mouseWheelScroller;
...
class Scrollable extends Sizer {
    constructor(scene, config) {
        ...
        super(scene, config);
        this.type = GetValue$4(config, 'type', 'rexScrollable');
        ...
        if (header) {
            ...
            var headerAlign = GetValue$4(config, 'align.header', 'center');
            var headerExpand = GetValue$4(config, 'expand.header', true);
        ...
        if (footer) {
            ...
            var footerAlign = GetValue$4(config, 'align.footer', 'center');
            var footerExpand = GetValue$4(config, 'expand.footer', true);
...
class BaseTextBlock extends Base$3 {
    constructor(scene, x, y, minWidth, minHeight, config) {
        ...
        this.text = GetValue$3(config, 'content', '');
        this._textOY = 0;
        this.execeedTopState = false;
        this.execeedBottomState = false;

        this.setClampMode(GetValue$3(config, 'clampTextOY', true));

        this.alwaysScrollable = GetValue$3(config, 'alwaysScrollable', false);
        ...
        this.textCropEnable = GetValue$3(config, 'textCrop', !!textObject.setCrop);
        var textMaskEnable = GetValue$3(config, 'textMask', !this.textCropEnable);
...
class TextArea extends Scrollable {
    constructor(scene, config) {
        ...
        var textBlockConfig = {
            ...
            content: content,
            clampTextOY: GetValue$2(config, 'clampChildOY', false),
