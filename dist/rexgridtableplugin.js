(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexgridtableplugin = factory(global.Phaser));
    ...
    let Base$2 = class Base extends Zone {
    ...
    */
    ...
    var DrawBounds$1 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$7(config, 'fillAlpha');
            padding = GetValue$7(config, 'padding');
            includeParent = GetValue$7(config, 'includeParent');
        }
    ...
    var ChildrenMaskMethods = {
        setupChildrenMask(config) {
            ...
            var maskType = GetValue$2(config, 'maskType');
            if (!maskType) {
                if (this.layerRendererEnable) {
                    maskType = 'layer';
                } else {
