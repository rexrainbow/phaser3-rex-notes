(function (global, factory) {
  ...
  */
  ...
  var ResolveWidth = function ResolveWidth(self, width, runWidthWrap) {
  ...
  var ResolveHeight = function ResolveHeight(self, height, runHeightWrap) {
  ...
  */
  ...
  Object.assign(methods$2, PaddingMethods, AddChildMethods$2, RemoveChildMethods$2, GetParentSizerMethods, methods$7, methods$6, methods$5, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  Object.assign(methods$1, AddChildMethods$1, RemoveChildMethods$1, SortChildrenMethods);
  ...
  var FixWidthSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function FixWidthSizer(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setIntentLeft(GetValue$2(config, 'space.indentLeftOdd', 0), GetValue$2(config, 'space.indentLeftEven', 0));
      _this.setIntentTop(GetValue$2(config, 'space.indentTopOdd', 0), GetValue$2(config, 'space.indentTopEven', 0));
  ...
  Object.assign(ButtonGroup.prototype, AddMethods, RemoveMethods, ButtonsTypeMethods, ButtonMethods, methods);
