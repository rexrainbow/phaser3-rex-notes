(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexfixwidthbuttons = factory(global.Phaser));
    ...
    var Add$2 = function (gameObject, config) {
    ...
    var SetupSyncFlags = function (state, config) {
        ...
        if (typeof (config) === 'boolean') {
            ...
            state.syncCameraFilter = GetValue$I(config, 'syncCameraFilter', true);
            state.syncDisplayList = GetValue$I(config, 'syncDisplayList', true);
        }
    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$G(config, 'fillAlpha');
            padding = GetValue$G(config, 'padding');
            includeParent = GetValue$G(config, 'includeParent');
        }
    ...
    var DrawBounds = function (graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            color = GetValue$E(config, 'color');
            lineWidth = GetValue$E(config, 'lineWidth');
    ...
    class Anchor extends ComponentBase {
        ...
        resetFromJSON(o) {
            ...
            var onResizeCallback = GetValue$A(o, 'onResizeCallback', DefaultResizeCallback);
            var onResizeCallbackScope = GetValue$A(o, 'onResizeCallbackScope');
            this.setResizeCallback(onResizeCallback, onResizeCallbackScope);

            var onUpdateViewportCallback = GetValue$A(o, 'onUpdateViewportCallback');
            var onUpdateViewportCallbackScope = GetValue$A(o, 'onUpdateViewportCallbackScope');
    ...
    class TickTask extends ComponentBase {
        constructor(parent, config) {
            ...
            this.setTickingMode(GetValue$z(config, 'tickingMode', 1));
            // boot() later
        }
    ...
    class SceneUpdateTickTask extends TickTask {
        constructor(parent, config) {
            ...
            this.tickEventName = GetValue$y(config, 'tickEventName', defaultEventName);
    ...
    var GetValue$q = function (source, key, defaultValue, altSource) {
    ...
    */
    ...
    class OpenCloseTransition extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.setTransitInCallback(GetValue$p(config, 'transitIn'));
            this.setTransitOutCallback(GetValue$p(config, 'transitOut'));

            this.oneShotMode = GetValue$p(config, 'destroy', false);
    ...
    let Modal$1 = class Modal extends OpenCloseTransition {
        constructor(gameObject, config) {
            ...
            if (this.cover) {
                this.setCoverTransitInCallback(GetValue$m(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
                this.setCoverTransitOutCallback(GetValue$m(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
            }
    ...
    class InTouching extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.parent.setInteractive(GetValue$j(config, 'inputConfig', undefined));
            this.resetFromJSON(config);
            this.boot();
        }
    ...
    class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var origin = GetValue$4(config, 'origin', 0.5);
            var originX = GetValue$4(config, 'originX', origin);
            var originY = GetValue$4(config, 'originY', origin);
            this.setOrigin(originX, originY);

            this.setMinSize(minWidth, minHeight);
            this.setName(GetValue$4(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$4(config, 'space', 0));

            var draggable = GetValue$4(config, 'draggable', false);
            if (draggable) {
                this.setDraggable(draggable);
            }

            this.setSizerEventsEnable(GetValue$4(config, 'sizerEvents', false));
            this.setDirty(true);
    ...
    class FixWidthSizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, config) {
            if (IsPlainObject(x)) {
                config = x;
            ...
            this.setOrientation(GetValue$2(config, 'orientation', 0));
            this.setItemSpacing(GetValue$2(config, 'space.item', 0));
            this.setLineSpacing(GetValue$2(config, 'space.line', 0));
            this.setIntentLeft(
                GetValue$2(config, 'space.indentLeftOdd', 0),
                GetValue$2(config, 'space.indentLeftEven', 0)
            );
            this.setIntentTop(
                GetValue$2(config, 'space.indentTopOdd', 0),
                GetValue$2(config, 'space.indentTopEven', 0)
            );
            this.setAlign(GetValue$2(config, 'align', 0));
            this.setJustifyPercentage(GetValue$2(config, 'justifyPercentage', 0.25));
            this.setRTL(GetValue$2(config, 'rtl', false));
