(function (global, factory) {
  ...
  */
  ...
  var GetItems = function GetItems(data, store) {
    if (store === undefined) {
      store = localforage;
    }
  ...
  var SetItems = function SetItems(data, store) {
    if (store === undefined) {
      store = localforage;
    }
    var promises = [];
  ...
  var Save = function Save(fileID, header, content, updateMode) {
    ...
    return new Promise(function (resolve, reject) {
      if (updateMode) {
        GetItems([headerKey, contentKey]).then(function (data) {
  ...
  var Load = function Load(fileID) {
    ...
    var contentKey = GetContentKey(fileID);
    var self = this;
    return GetItems([headerKey, contentKey], this.store).then(function (data) {
  ...
  var LoadHeaders = function LoadHeaders() {
    var self = this;
    return this.store.keys().then(function (keys) {
  ...
  var RemoveItems = function RemoveItems(data, store) {
    if (store === undefined) {
      store = localforage;
    }
    var keys;
  ...
  var Delete = function Delete(fileID) {
    var headerKey = GetHeaderKey(fileID);
    var contentKey = GetContentKey(fileID);
  ...
  var DataProcessMethods = {
    toSaveData: function toSaveData(data) {
      if (this.zipMode) {
  ...
  Object.assign(Files.prototype, methods, DataProcessMethods);
  ...
  var FilesPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    ...
    function FilesPlugin(pluginManager) {
      ...
      return _callSuper(this, FilesPlugin, [pluginManager]);
    }
