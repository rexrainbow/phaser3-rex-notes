import { Events, Scene, Game, Utils, GameObjects, Math, Plugins } from 'phaser';
...
const WrapAngle = Math.Angle.Wrap;
...
class DragRotatePlugin extends Plugins.BasePlugin {
...
export { DragRotatePlugin as default };
