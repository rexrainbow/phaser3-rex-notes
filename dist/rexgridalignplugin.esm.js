import { GameObjects, Utils, Display, Plugins } from 'phaser';
...
const GetFastValue$1 = Utils.Objects.GetFastValue;
...
var GridAlign$1 = function (items, options) {
    ...
    var position = GetFastValue$1(options, 'position', Display.Align.CENTER);
...
var GridAlign = function (items, options) {
    ...
    var position = GetFastValue(options, 'position', Display.Align.CENTER);
...
class GridAlignPlugin extends Plugins.BasePlugin {
...
export { GridAlignPlugin as default };
