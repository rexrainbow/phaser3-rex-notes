(function (global, factory) {
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$3(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$2(config, 'tickEventName', defaultEventName);
  ...
  var Flash = /*#__PURE__*/function (_TickTask) {
    _inherits(Flash, _TickTask);
    function Flash(gameObject, config) {
      var _this;
      _classCallCheck(this, Flash);
      _this = _callSuper(this, Flash, [gameObject, config]);
    ...
    _createClass(Flash, [{
      ...
      value: function start(duration, repeat) {
        ...
        this.timer.setDuration(this.duration).setRepeat(this.repeat);
        if (this.isRunning) {
          // pend task
          this.timer.repeatCounter = -1;
        } else {
          _get(_getPrototypeOf(Flash.prototype), "start", this).call(this);
        }
        return this;
      }
    }, {
      key: "flash",
      value: function flash(duration, repeat) {
      ...
      value: function stop() {
        ...
        _get(_getPrototypeOf(Flash.prototype), "stop", this).call(this);
        return this;
      }
    }, {
      key: "update",
  ...
  var FlashPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    _inherits(FlashPlugin, _Phaser$Plugins$BaseP);
    function FlashPlugin(pluginManager) {
      _classCallCheck(this, FlashPlugin);
      return _callSuper(this, FlashPlugin, [pluginManager]);
    }
    _createClass(FlashPlugin, [{
      key: "start",
      value: function start() {
