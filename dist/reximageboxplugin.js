(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.reximageboxplugin = factory(global.Phaser));
    ...
    */
    ...
    var DrawBounds$1 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$3(config, 'fillAlpha');
            padding = GetValue$3(config, 'padding');
            includeParent = GetValue$3(config, 'includeParent');
        }
