import { Display, VERSION, GameObjects, Class, Utils, Math as Math$1, Geom, TintModes as TintModes$2, CANVAS, DOM, Renderer, Plugins } from 'phaser';
...
const CanvasPool$3 = Display.Canvas.CanvasPool;
...
const CanvasPool$2 = Display.Canvas.CanvasPool;
...
var DrawFrameToCanvas = function (frame, canvasOrContext, x, y, width, height, color, autoRound, tintMode) {
    ...
    if (color === undefined || color === null || typeof tintMode !== 'number') {
        ...
        // Get tempCanvas
        var tempCanvas = CanvasPool$1.create(null, width, height, CANVAS, true);
...
const DefaultImageNodes = Renderer.WebGL.RenderNodes.Defaults.DefaultImageNodes;
...
class Text extends TextBase {
    constructor(scene, x, y, text, style, type, parser) {
        ...
        this.setUrlTagCursor(GetValue$1(style, 'urlTagCursorStyle', 'pointer'));
...
class TagTextPlugin extends Plugins.BasePlugin {
...
export { TagTextPlugin as default };
