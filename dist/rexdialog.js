(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexdialog = factory(global.Phaser));
    ...
    */
    ...
    var Add$5 = function (gameObject, childKey, align, padding, expand, minWidth, minHeight, offsetX, offsetY, aspectRatio) {
        ...
        if (IsPlainObject$5(expand)) {
            config.expandWidth = NormalizeExpand(GetValue$b(expand, 'width', false));
            config.expandHeight = NormalizeExpand(GetValue$b(expand, 'height', false));
        } else {
