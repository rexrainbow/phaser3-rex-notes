(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexmenu = factory(global.Phaser));
    ...
    var SetupSyncFlags = function (state, config) {
        ...
        if (typeof (config) === 'boolean') {
            ...
            state.syncDisplayList = GetValue$J(config, 'syncDisplayList', true);
        }
    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$H(config, 'fillAlpha');
            padding = GetValue$H(config, 'padding');
            includeParent = GetValue$H(config, 'includeParent');
        }
    ...
    class Anchor extends ComponentBase {
        ...
        resetFromJSON(o) {
            ...
            var onResizeCallback = GetValue$B(o, 'onResizeCallback', DefaultResizeCallback);
            var onResizeCallbackScope = GetValue$B(o, 'onResizeCallbackScope');
            this.setResizeCallback(onResizeCallback, onResizeCallbackScope);

            var onUpdateViewportCallback = GetValue$B(o, 'onUpdateViewportCallback');
            var onUpdateViewportCallbackScope = GetValue$B(o, 'onUpdateViewportCallbackScope');
    ...
    class SceneUpdateTickTask extends TickTask {
        constructor(parent, config) {
            ...
            this.tickEventName = GetValue$z(config, 'tickEventName', defaultEventName);
    ...
    var GetValue$r = function (source, key, defaultValue, altSource) {
    ...
    */
    ...
    class OpenCloseTransition extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.setTransitInCallback(GetValue$q(config, 'transitIn'));
            this.setTransitOutCallback(GetValue$q(config, 'transitOut'));

            this.oneShotMode = GetValue$q(config, 'destroy', false);
    ...
    let Modal$1 = class Modal extends OpenCloseTransition {
        constructor(gameObject, config) {
            ...
            if (this.cover) {
                this.setCoverTransitInCallback(GetValue$n(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
                this.setCoverTransitOutCallback(GetValue$n(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
            }
    ...
    class InTouching extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.parent.setInteractive(GetValue$k(config, 'inputConfig', undefined));
            this.resetFromJSON(config);
            this.boot();
        }
    ...
    var SetChildrenInteractive = function (gameObject, config) {
        ...
        gameObject._childrenInteractive = {
            ...
            targetMode: GetValue$6(config, 'targetMode', 'parent'),
    ...
    class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var origin = GetValue$5(config, 'origin', 0.5);
            var originX = GetValue$5(config, 'originX', origin);
            var originY = GetValue$5(config, 'originY', origin);
            this.setOrigin(originX, originY);

            this.setMinSize(minWidth, minHeight);
            this.setName(GetValue$5(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$5(config, 'space', 0));

            var draggable = GetValue$5(config, 'draggable', false);
            if (draggable) {
                this.setDraggable(draggable);
            }

            this.setSizerEventsEnable(GetValue$5(config, 'sizerEvents', false));
            this.setDirty(true);
