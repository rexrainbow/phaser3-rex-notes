(function (global, factory) {
  ...
  */
  ...
  var methods$4 = {};
  Object.assign(methods$4, DelayCallMethods$1, ConfigurationMethods, OpenMethods, CloseMethods);
  ...
  Object.assign(methods$2, PaddingMethods, AddChildMethods$2, RemoveChildMethods$2, GetParentSizerMethods, methods$7, methods$6, methods$5, ShakeMethods, EaseDataMethods, DelayCallMethods$2, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  var Menu = /*#__PURE__*/function (_Buttons) {
    ...
    function Menu(scene, config) {
      ...
      if (_this.isRoot) {
        ...
        _this.toggleOrientation = GetValue(config, 'toggleOrientation', false);
        // Expand mode
        _this.expandEventName = GetValue(config, 'expandEvent', 'button.click');
        // Transition
        ...
        _this.setTransitOutCallback(GetValue(config, 'transitOut'));
        // Callbacks
        ...
        // Children key
        _this.childrenKey = GetValue(config, 'childrenKey', 'children');
        // Event flag
