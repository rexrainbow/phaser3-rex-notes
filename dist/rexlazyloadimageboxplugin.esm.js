import { VERSION, BlendModes, Structs, Utils as Utils$2, GameObjects, Scenes, Math as Math$1, Class, Geom, Renderer as Renderer$1, Events, Scene, Game, Tweens, Plugins } from 'phaser';
...
const StableSort = Utils$2.Array.StableSort;
...
const RemoveItem$1 = Utils$2.Array.Remove;
...
const GetValue$f = Utils$2.Objects.GetValue;
...
const ArrayUtils = Utils$2.Array;
...
var GetValue$e = Utils$2.Objects.GetValue;
...
const GetValue$d = Utils$2.Objects.GetValue;
...
var DrawBounds$1 = function (gameObjects, graphics, config) {
    ...
    if (typeof (config) === 'number') {
        ...
        fillAlpha = GetValue$d(config, 'fillAlpha');
        padding = GetValue$d(config, 'padding');
        includeParent = GetValue$d(config, 'includeParent');
    }
...
const GetValue$c = Utils$2.Objects.GetValue;
...
const GetValue$b = Utils$2.Objects.GetValue;
...
const IsPlainObject = Utils$2.Objects.IsPlainObject;
...
const GetValue$a = Utils$2.Objects.GetValue;
...
const GetValue$9 = Utils$2.Objects.GetValue;
...
class LazyLoadImageBoxPlugin extends Plugins.BasePlugin {
...
export { LazyLoadImageBoxPlugin as default };
