import { Utils, Loader, Plugins } from 'phaser';
...
const FILE_PROCESSING = Loader.FILE_PROCESSING;

class YAMLFile extends Loader.File {
...
class YAMLLoaderPlugin extends Plugins.BasePlugin {
...
export { YAMLLoaderPlugin as default };
