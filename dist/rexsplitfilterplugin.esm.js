...
class SplitFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class SplitController extends Filters.Controller {
    static FilterName = FilterName;
...
export { SplitFilterPlugin as default };
