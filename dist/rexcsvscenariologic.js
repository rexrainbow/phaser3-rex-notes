  ...
  */
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      ...
      key: "start",
      value: function start(time, timeoutCallback) {
        this.time = time;
  ...
  var CSVScenarioLogic = /*#__PURE__*/function () {
    function CSVScenarioLogic(parent, config) {
      _classCallCheck(this, CSVScenarioLogic);
      if (parent === undefined) {
        parent = {};
      }
      this.parent = parent;
    ...
    // Override
    _createClass(CSVScenarioLogic, [{
      key: "boot",
      value: function boot(parent, config) {
        return this;
      }
      ...
      value: function wait(eventName) {
        ...
        if (typeof eventName === 'number') {
          ...
          var self = this;
          this.timer.start(delay, function () {
            self["continue"](eventName);
          });
        } else {
  ...
  Object.assign(CSVScenarioLogic.prototype, EventEmitterMethods);
  var TIMEUNITMODE = {
    ms: 0,
    s: 1,
    sec: 1
