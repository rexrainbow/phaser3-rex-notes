import { Events, Scene, Game, Utils, Input, Plugins } from 'phaser';
...
const KeyCodes$1 = Input.Keyboard.KeyCodes;
...
class KeysHubPlugin extends Plugins.BasePlugin {
...
export { KeysHubPlugin as default };
