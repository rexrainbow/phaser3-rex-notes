import { Game, Scene, Renderer, Utils, Filters, GameObjects, Plugins } from 'phaser';
...
class ToonifyFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class HorrifiController extends Filters.Controller {
    static FilterName = FilterName;
...
export { HorrifiFilterPlugin as default };
