(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexcolorcomponents = factory());
  ...
  */
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      fillAlpha = GetValue$1p(config, 'fillAlpha', 1);
      padding = GetValue$1p(config, 'padding', 0);
    }
  ...
  Object.assign(methods$b, Parent, AddChild$3, RemoveChild$2, ChildState, Transform, Position, Rotation, Scale$1, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$1i(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$1h(config, 'tickEventName', defaultEventName);
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.setTransitInTime(GetValue$18(config, 'duration.in', 200));
      _this.setTransitOutTime(GetValue$18(config, 'duration.out', 200));
      _this.setTransitInCallback(GetValue$18(config, 'transitIn'));
      _this.setTransitOutCallback(GetValue$18(config, 'transitOut'));
      _this.oneShotMode = GetValue$18(config, 'destroy', false);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$15(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$15(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$12(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
  ...
  var Base$1 = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setName(GetValue$P(config, 'name', ''));
      _this.rexSizer = {};
      _this.space = {};
      ...
      _this.setInnerPadding(GetValue$P(config, 'space', 0));
      var draggable = GetValue$P(config, 'draggable', false);
      if (draggable) {
        _this.setDraggable(draggable);
      }
      _this.setSizerEventsEnable(GetValue$P(config, 'sizerEvents', false));
      _this.setDirty(true);
  ...
  var Add$2 = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    if (proportion === null) {
      ...
      align = GetValue$O(config, 'align', ALIGN_CENTER$1);
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      _this.setItemSpacing(GetValue$N(config, 'space.item', 0));
      _this.setStartChildIndex(GetValue$N(config, 'startChildIndex', 0));
      _this.setRTL(GetValue$N(config, 'rtl', false));
  ...
  Object.assign(LabelBase.prototype, methods$6);
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      var action = GetValue$M(config, 'action', undefined);
      var actionMask = GetValue$M(config, 'actionMask', undefined);
      // Align
      var align = GetValue$M(config, 'align', undefined); // undefined/left/top: no space
      ...
      if (icon) {
        ...
        if (_this.orientation === 0) {
          if (text || action) {
            padding = {
              right: GetValue$M(config, 'space.icon', 0),
              top: GetValue$M(config, 'space.iconTop', 0),
              bottom: GetValue$M(config, 'space.iconBottom', 0),
              left: GetValue$M(config, 'space.iconLeft', 0)
            };
          }
        } else {
          if (text || action) {
            padding = {
              bottom: GetValue$M(config, 'space.icon', 0),
              left: GetValue$M(config, 'space.iconLeft', 0),
              right: GetValue$M(config, 'space.iconRight', 0),
              top: GetValue$M(config, 'space.iconTop', 0)
            };
          }
        }
        var fitRatio = GetValue$M(config, 'squareFitIcon', false) ? 1 : 0;
        _this.add(icon, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var iconSize = GetValue$M(config, 'iconSize', undefined);
          _this.setIconSize(GetValue$M(config, 'iconWidth', iconSize), GetValue$M(config, 'iconHeight', iconSize));
        }
      }
      if (text) {
        var textSpace = GetValue$M(config, 'space.text', 0);
        var expandTextWidth = GetValue$M(config, 'expandTextWidth', false);
        var expandTextHeight = GetValue$M(config, 'expandTextHeight', false);
      ...
      if (action) {
        ...
        if (_this.orientation === 0) {
          padding = {
            top: GetValue$M(config, 'space.actionTop', 0),
            bottom: GetValue$M(config, 'space.actionBottom', 0),
            right: GetValue$M(config, 'space.actionRight', 0)
          };
        } else {
          padding = {
            left: GetValue$M(config, 'space.actionLeft', 0),
            right: GetValue$M(config, 'space.actionRight', 0),
            bottom: GetValue$M(config, 'space.actionBottom', 0)
          };
        }
        var fitRatio = GetValue$M(config, 'squareFitAction', false) ? 1 : 0;
        _this.add(action, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var actionSize = GetValue$M(config, 'actionSize');
          _this.setActionSize(GetValue$M(config, 'actionWidth', actionSize), GetValue$M(config, 'actionHeight', actionSize));
        }
      }
   ...
   */
  var IsPlainObject$b = function IsPlainObject(obj) {
    // Not plain objects:
  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$J(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$J(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$J(config, 'onModifyStyle');
      return _this;
    }
  ...
  var StatesNineSlice = /*#__PURE__*/function (_PhaserNineSlice) {
    ...
    function StatesNineSlice(scene, config) {
      ...
      var x = GetValue$I(config, 'x', 0);
      var y = GetValue$I(config, 'y', 0);
      var key = GetValue$I(config, 'key', null);
      var frame = GetValue$I(config, 'frame', null);
      var width = GetValue$I(config, 'width', 0);
      var height = GetValue$I(config, 'height', 0);
      var leftWidth = GetValue$I(config, 'leftWidth', 0);
      var rightWidth = GetValue$I(config, 'rightWidth', 0);
      var topHeight = GetValue$I(config, 'topHeight', 0);
      var bottomHeight = GetValue$I(config, 'bottomHeight', 0);
      ...
      var effectConfig = GetValue$I(config, 'effects', true);
      if (effectConfig) {
  ...
  var StatesImage = /*#__PURE__*/function (_PhaserImage) {
    ...
    function StatesImage(scene, config) {
      ...
      var key = GetValue$H(config, 'key', '');
      var frame = GetValue$H(config, 'frame', undefined);
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$9(mode)) {
      this.stretchMode.edge = parseMode(GetValue$G(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$G(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$8(x)) {
          ...
          width = GetValue$F(config, 'width', 1);
          height = GetValue$F(config, 'height', 1);
          key = GetValue$F(config, 'key', undefined);
          baseFrame = GetValue$F(config, 'baseFrame', undefined);
          columns = GetValue$F(config, 'columns', undefined);
          rows = GetValue$F(config, 'rows', undefined);
          ...
          columns = GetValue$F(config, 'columns', undefined);
          rows = GetValue$F(config, 'rows', undefined);
        } else if (IsPlainObject$8(key)) {
          config = key;
          key = GetValue$F(config, 'key', undefined);
          baseFrame = GetValue$F(config, 'baseFrame', undefined);
          columns = GetValue$F(config, 'columns', undefined);
          rows = GetValue$F(config, 'rows', undefined);
        } else if (IsPlainObject$8(baseFrame)) {
          config = baseFrame;
          baseFrame = GetValue$F(config, 'baseFrame', undefined);
          columns = GetValue$F(config, 'columns', undefined);
          rows = GetValue$F(config, 'rows', undefined);
          ...
          columns = baseFrame;
          baseFrame = GetValue$F(config, 'baseFrame', undefined);
        } else if (IsPlainObject$8(columns)) {
          config = columns;
          columns = GetValue$F(config, 'columns', undefined);
          rows = GetValue$F(config, 'rows', undefined);
        }
        if (baseFrame === undefined) {
          baseFrame = GetValue$F(config, 'frame', undefined);
        }
        if (columns === undefined) {
          var leftWidth = GetValue$F(config, 'leftWidth', undefined);
          var rightWidth = GetValue$F(config, 'rightWidth', undefined);
          if (leftWidth !== undefined && rightWidth !== undefined) {
            columns = [leftWidth, undefined, rightWidth];
          }
        }
        if (rows === undefined) {
          var topHeight = GetValue$F(config, 'topHeight', undefined);
          var bottomHeight = GetValue$F(config, 'bottomHeight', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$F(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$F(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$F(config, 'preserveRatio', true));
        var maxFixedPartScale = GetValue$F(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$F(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$F(config, 'maxFixedPartScaleY', undefined);
  ...
  var StatesNinePatch = /*#__PURE__*/function (_NinePatch) {
    ...
    function StatesNinePatch(scene, config) {
      ...
      var effectConfig = GetValue$E(config, 'effects', true);
      if (effectConfig) {
        AddEffectProperties(_assertThisInitialized(_this), effectConfig);
      }
  ...
  var StatesText = /*#__PURE__*/function (_PhaserText) {
    ...
    function StatesText(scene, config) {
      ...
      var x = GetValue$D(config, 'x', 0);
      var y = GetValue$D(config, 'y', 0);
      var text = GetValue$D(config, 'text', '');
    ...
    _createClass(TextStyle, [{
      ...
      value: function setStyle(style, updateText, setDefaults) {
        ...
        for (var key in propertyMap) {
          ...
          if (key === 'wrapCallback' || key === 'wrapCallbackScope') {
            ...
            this[key] = GetValue$C(style, objKey, defaultValue);
          } else {
        ...
        var font = GetValue$C(style, 'font', null);
        if (font === null) {
        ...
        var fill = GetValue$C(style, 'fill', null);
        if (fill !== null) {
          this.color = GetStyle(fill);
        }
        var metrics = GetValue$C(style, 'metrics', false);

        //  Provide optional TextMetrics in the style object to avoid the canvas look-up / scanning
        //  Doing this is reset if you then change the font of this TextStyle after creation
        if (metrics) {
          this.metrics = {
            ascent: GetValue$C(metrics, 'ascent', 0),
            descent: GetValue$C(metrics, 'descent', 0),
            fontSize: GetValue$C(metrics, 'fontSize', 0)
          };
      ...
      value: function setFont(font) {
        if (typeof font === 'string') {
          ...
          this.fontFamily = GetValue$C(font, 'fontFamily', 'Courier');
          this.fontSize = GetValue$C(font, 'fontSize', '16px');
          this.fontStyle = GetValue$C(font, 'fontStyle', '');
        }
      ...
      value: function setTextMetrics(metrics, font) {
        ...
        if (font) {
          if (typeof font === 'string') {
            ...
            this.fontFamily = GetValue$C(font, 'fontFamily', this.fontFamily);
            this.fontSize = GetValue$C(font, 'fontSize', this.fontSize);
            this.fontStyle = GetValue$C(font, 'fontStyle', this.fontStyle);
          }
        }
  ...
  var Pen = /*#__PURE__*/function () {
    ...
    _createClass(Pen, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.text = GetValue$B(o, 'text', '');
        this.x = GetValue$B(o, 'x', 0);
        this.y = GetValue$B(o, 'y', 0);
        this.width = GetValue$B(o, 'width', 0);
        var prop = GetValue$B(o, 'prop', null);
        if (prop === null) {
          prop = {};
        }
        this.prop = prop;
        this.newLineMode = GetValue$B(o, 'newLineMode', 0);
        this.startIndex = GetValue$B(o, 'startIndex', 0);
      }
    }, {
      key: "plainText",
      get: function get() {
  ...
  var CanvasText = /*#__PURE__*/function () {
    function CanvasText(config) {
      ...
      this.context = GetValue$A(config, 'context', null);
      this.canvas = this.context.canvas;
      this.parser = GetValue$A(config, 'parser', null);
      this.defaultStyle = GetValue$A(config, 'style', null);
      this.autoRound = true;
      this.pensPool = config.pensPool; // Required
      this.linesPool = config.linesPool; // Required
  ...
  Object.assign(CanvasText.prototype, DrawMethods, methods$5);
  ...
  var AddImage = function AddImage(key, config) {
    ...
    this.images[key] = {
      ...
      left: GetValue$z(config, 'left', 0),
      right: GetValue$z(config, 'right', 0),
      originX: GetValue$z(config, 'originX', 0),
      originY: GetValue$z(config, 'originY', 0),
      tintFill: GetValue$z(config, 'tintFill', false)
    };
  };
  ...
  Object.assign(ImageManager.prototype, methods$4);
  ...
  var Text = /*#__PURE__*/function (_TextBase) {
    ...
    function Text(scene, x, y, text, style, type, parser) {
      ...
      if (IsPlainObject$6(x)) {
        ...
        text = GetValue$y(config, 'text', '');
        style = GetValue$y(config, 'style');
      }
      if (x === undefined) {
        x = 0;
      }
      ...
      var imageData = GetValue$y(style, 'images', undefined);
      if (imageData) {
      ...
      var sharedPoolMode = GetValue$y(style, 'sharedPool', true);
      ...
      _this.setText(text);
      _this.setUrlTagCursorStyle(GetValue$y(style, 'urlTagCursorStyle', 'pointer'));
      if (GetValue$y(style, 'interactive', false)) {
    ...
    _createClass(Text, [{
      ...
      value: function setPadding(left, top, right, bottom) {
        if (_typeof(left) === 'object') {
          ...
          var x = GetValue$y(config, 'x', null);
          if (x !== null) {
            left = x;
            right = x;
          } else {
            left = GetValue$y(config, 'left', 0);
            right = GetValue$y(config, 'right', left);
          }
          var y = GetValue$y(config, 'y', null);
          if (y !== null) {
            top = y;
            bottom = y;
          } else {
            top = GetValue$y(config, 'top', 0);
            bottom = GetValue$y(config, 'bottom', top);
          }
        } else {
          if (left === undefined) {
            left = 0;
  ...
  Object.assign(Text.prototype, methods$3);
  ...
  var Parser = /*#__PURE__*/function () {
    function Parser(style) {
      ...
      var delimiters = GetValue$x(style, 'delimiters', '[]');
  ...
  var StatesBitmapText = /*#__PURE__*/function (_PhaserBitmapText) {
    ...
    function StatesBitmapText(scene, config) {
      ...
      var font = GetValue$w(config, 'font', '');
      var size = GetValue$w(config, 'fontSize', false);
      var align = GetValue$w(config, 'align', 0);
      var tint = GetValue$w(config, 'tint');
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    AddChild$2.call(this, gameObject);
    if (IsPlainObject$5(columnIndex)) {
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject$4(x)) {
        ...
        columnProportions = GetValue$t(config, 'columnProportions', 0);
        rowProportions = GetValue$t(config, 'rowProportions', 0);
      } else if (IsPlainObject$4(columnProportions)) {
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$t(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$t(config, 'space.indentLeftOdd', 0), GetValue$t(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$t(config, 'space.indentTopOdd', 0), GetValue$t(config, 'space.indentTopEven', 0));
  ...
  var AddChild$1 = function AddChild(topPatent, childParent, config) {
    ...
    if (child) {
      ...
      childParent.add(child, {
        ...
        expand: {
          width: GetValue$s(childConfig, 'expandWidth', true),
          // Private
    ...
    var ProgressBase = /*#__PURE__*/function (_BaseClass) {
      ...
      _createClass(ProgressBase, [{
        ...
        value: function bootProgressBase(config) {
          this.eventEmitter = GetValue$r(config, 'eventEmitter', this);
          ...
          this.setEaseValuePropName('value').setEaseValueDuration(GetValue$r(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$r(config, 'easeValue.ease', 'Linear'));
          return this;
        }
      }, {
        key: "value",
  ...
  var Slider = /*#__PURE__*/function (_ProgressBase) {
    ...
    function Slider(scene, config) {
      ...
      _this.reverseAxis = GetValue$q(config, 'reverseAxis', false);

      // Add elements
      var background = GetValue$q(config, 'background', undefined);
      var track = GetValue$q(config, 'track', undefined);
      var indicator = GetValue$q(config, 'indicator', undefined);
      var thumb = GetValue$q(config, 'thumb', undefined);
      if (background) {
      ...
      // Input
      var inputMode = GetValue$q(config, 'input', 0);
      ...
      _this.setEnable(GetValue$q(config, 'enable', undefined));
      _this.setGap(GetValue$q(config, 'gap', undefined));
      _this.setValue(GetValue$q(config, 'value', 0), GetValue$q(config, 'min', undefined), GetValue$q(config, 'max', undefined));
      return _this;
    }
    _createClass(Slider, [{
      key: "setEnable",
  ...
  var ScrollBar = /*#__PURE__*/function (_Sizer) {
    ...
    function ScrollBar(scene, config) {
      ...
      var buttonsConfig = GetValue$p(config, 'buttons', undefined);
      var button0 = GetValue$p(buttonsConfig, 'top', GetValue$p(buttonsConfig, 'left', undefined));
      var button1 = GetValue$p(buttonsConfig, 'bottom', GetValue$p(buttonsConfig, 'right', undefined));
      var slider,
        sliderConfig = GetValue$p(config, 'slider', undefined);
      if (background) {
        _this.addBackground(background);
      }
      if (button0) {
      ...
      _this.setScrollStep(GetValue$p(buttonsConfig, 'step', 0.01));
      return _this;
    }
  ...
  var DragSpeed = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(DragSpeed, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.holdThreshold = GetValue$o(o, 'holdThreshold', 50); // ms
        this.pointerOutReleaseEnable = GetValue$o(o, 'pointerOutRelease', true);
        return this;
      }
    }, {
      key: "boot",
  ...
  var Movement = /*#__PURE__*/function () {
    ...
    _createClass(Movement, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setValue(GetValue$n(o, 'value', 0));
        this.setSpeed(GetValue$n(o, 'speed', 0));
        this.setAcceleration(GetValue$n(o, 'acceleration', 0));
        return this;
      }
    }, {
      key: "reset",
  ...
  var Scroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Scroller(gameObject, config) {
      ...
      var enable = GetValue$m(config, 'enable', true);
      _this._state = new State(_assertThisInitialized(_this), {
        enable: enable,
        eventEmitter: false
      });
      var drapSpeedConfig = {
        inputConfig: GetValue$m(config, 'inputConfig', undefined),
        enable: enable,
        pointerOutRelease: GetValue$m(config, 'pointerOutRelease', true),
        eventEmitter: false
      };
      ...
      callback = GetValue$m(config, 'overmaxCallback', null);
      if (callback !== null) {
        var scope = GetValue$m(config, 'overmaxCallbackScope', undefined);
        _this.on('overmax', callback, scope);
      }
      callback = GetValue$m(config, 'overminCallback', null);
      if (callback !== null) {
        var scope = GetValue$m(config, 'overminCallbackScope', undefined);
    ...
    _createClass(Scroller, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setOrientationMode(GetValue$m(o, 'orientation', 0));
        this.setDragThreshold(GetValue$m(o, 'threshold', 10));
        this.setSlidingDeceleration(GetValue$m(o, 'slidingDeceleration', 5000));
        this.setBackDeceleration(GetValue$m(o, 'backDeceleration', 2000));
        var dragRate = GetValue$m(o, 'dragRate', 1);
        dragRate = dragRate * (GetValue$m(o, 'dragReverse', false) ? -1 : 1);
        this.setDragRate(dragRate);
        var bounds = GetValue$m(o, 'bounds', undefined);
        if (bounds) {
          this.setBounds(bounds);
        } else {
          this.setBounds(GetValue$m(o, 'max', 0), GetValue$m(o, 'min', 0));
        }
        this.setValue(GetValue$m(o, 'value', this.maxValue || 0));
  ...
  var MouseWheelScroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    function MouseWheelScroller(gameObject, config) {
      ...
      if (_this.parent !== _this.scene) {
        _this.focusMode = GetValue$l(config, 'focus', true);
      } else {
        _this.focusMode = false;
      }
      _this.setSpeed(GetValue$l(config, 'speed', 0.1));
      _this.setEnable(GetValue$l(config, 'enable', true));
      if (!_this.focusMode) {
        // Register on scene
        _this.scene.input.on('wheel', _this.onSceneScroll, _assertThisInitialized(_this));
      } else {
        var gameObject = _this.parent;
        gameObject.setInteractive(GetValue$l(config, "inputConfig", undefined)).on('wheel', function (pointer, dx, dy, dz, event) {
          if (!this.enable) {
            return;
          }
          this.scroll(dy);
  ...
  var AddSlider = function AddSlider(topPatent, sliderParent, axis, config) {
    ...
    if (isScrollXYMode) {
      sliderConfig = GetValue$k(config, sliderConfigKey, undefined);
    } else {
      if (config.hasOwnProperty(sliderConfigKey)) {
        sliderConfig = GetValue$k(config, sliderConfigKey, undefined);
      } else {
        sliderConfig = GetValue$k(config, 'slider', undefined);
      }
    }
    if (sliderConfig) {
      ...
      var sliderPosition = GetValue$k(sliderConfig, 'position', 0);
      ...
      3. space.child
      */
      var sliderPadding = GetValue$k(config, "space.slider".concat(axis), undefined);
      var childPadding; // Legacy
      if (sliderPadding === undefined) {
        sliderPadding = GetValue$k(config, 'space.slider', undefined);
        if (sliderPadding === undefined) {
          if (isScrollXYMode) {
            sliderPadding = 0;
          } else {
            childPadding = GetValue$k(config, 'space.child', 0);
          }
        }
      }
      ...
      if (isAxisY) {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              left: GetValue$k(childPadding, 'right', childPadding)
            };
          }
        } else {
          // left
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              right: GetValue$k(childPadding, 'left', childPadding)
            };
          }
        }
      } else {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              top: GetValue$k(childPadding, 'bottom', childPadding)
            };
          }
        } else {
          // top
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              bottom: GetValue$k(childPadding, 'top', childPadding)
            };
          }
        }
      }
      ...
      topPatent["hideUnscrollableSlider".concat(axis)] = GetValue$k(sliderConfig, 'hideUnscrollableSlider', false);
      topPatent["adaptThumb".concat(axis, "SizeMode")] = GetValue$k(sliderConfig, 'adaptThumbSize', false);
      topPatent["minThumb".concat(axis, "Size")] = GetValue$k(sliderConfig, 'minThumbSize', undefined);
    } else {
    ...
    if (isScrollXYMode) {
      scrollerConfig = GetValue$k(config, scrollerConfigKey, true);
    } else {
      if (config.hasOwnProperty(scrollerConfigKey)) {
        scrollerConfig = GetValue$k(config, scrollerConfigKey, true);
      } else {
        scrollerConfig = GetValue$k(config, 'scroller', true);
      }
    }
    ...
    var mouseWheelScrollerConfig = GetValue$k(config, isScrollXYMode ? "mouseWheelScroller".concat(axis) : 'mouseWheelScroller', false),
      mouseWheelScroller;
  ...
  var CreateScrollableSizer = function CreateScrollableSizer(parent, config) {
    ...
    var parentMinWidth = GetValue$j(config, 'width');
    var parentMinHeight = GetValue$j(config, 'height');
    if (!parentMinWidth) {
      var expandChildWidth = GetValue$j(config, 'child.expandWidth', true);
      if (!expandChildWidth) {
        columnProportions[1] = 0; // Calculate parent's width by child's width
      }
    }
    if (!parentMinHeight) {
      var expandChildHeight = GetValue$j(config, 'child.expandHeight', true);
  ...
  var Scrollable = /*#__PURE__*/function (_Sizer) {
    ...
    function Scrollable(scene, config) {
      ...
      _this.type = GetValue$i(config, 'type', 'rexScrollable');
  ...
  var SetText$2 = function SetText(text) {
    if (text !== undefined) {
      this.text = text;
    }
  ...
  var TextBlock = /*#__PURE__*/function (_BaseSizer) {
    ...
    function TextBlock(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.alwaysScrollable = GetValue$h(config, 'alwaysScrollable', false);
  ...
  var CreateTextArea = function CreateTextArea(scene, config, creators) {
    ...
    var createTrack = GetValue$f(creators, 'track', CreateBackground);
    var createThumb = GetValue$f(creators, 'thumb', CreateBackground);
    if (createBackground) {
  ...
  var Background = /*#__PURE__*/function (_RenderBase) {
    ...
    function Background(parent, config) {
      ...
      _this.setColor(GetValue$d(config, 'color', null), GetValue$d(config, 'color2', null), GetValue$d(config, 'horizontalGradient', true));
      _this.setStroke(GetValue$d(config, 'stroke', null), GetValue$d(config, 'strokeThickness', 2));
      _this.setCornerRadius(GetValue$d(config, 'cornerRadius', 0), GetValue$d(config, 'cornerIteration', null));
      return _this;
    }
  ...
  var InnerBounds = /*#__PURE__*/function (_RenderBase) {
    ...
    _createClass(InnerBounds, [{
      ...
      value: function modifyPorperties(o) {
        ...
        if (o.hasOwnProperty('color')) {
          this.setColor(o.color, GetValue$c(o, 'color2', null), GetValue$c(o, 'horizontalGradient', true));
        }
        if (o.hasOwnProperty('stroke')) {
          this.setStroke(o.stroke, GetValue$c(o, 'strokeThickness', 2));
        }
      }
    }, {
      key: "renderContent",
  ...
  var TextStyle = /*#__PURE__*/function () {
    ...
    _createClass(TextStyle, [{
      ...
      value: function set(o) {
        this.setBold(GetValue$b(o, 'bold', false));
        this.setItalic(GetValue$b(o, 'italic', false));
        this.setFontSize(GetValue$b(o, 'fontSize', '16px'));
        this.setFontFamily(GetValue$b(o, 'fontFamily', 'Courier'));
        this.setColor(GetValue$b(o, 'color', '#fff'));
        this.setStrokeStyle(GetValue$b(o, 'stroke', null), GetValue$b(o, 'strokeThickness', 0));
        this.setShadow(GetValue$b(o, 'shadowColor', null), GetValue$b(o, 'shadowOffsetX', 0), GetValue$b(o, 'shadowOffsetY', 0), GetValue$b(o, 'shadowBlur', 0));
        this.setOffset(GetValue$b(o, 'offsetX', 0), GetValue$b(o, 'offsetY', 0));
        this.setSpace(GetValue$b(o, 'leftSpace', 0), GetValue$b(o, 'rightSpace', 0));
        this.setAlign(GetValue$b(o, 'align', undefined));
        this.setBackgroundColor(GetValue$b(o, 'backgroundColor', null));
        this.setBackgroundHeight(GetValue$b(o, 'backgroundHeight', undefined));
        this.setBackgroundBottomY(GetValue$b(o, 'backgroundBottomY', undefined));
        return this;
      }
    }, {
      key: "modify",
  ...
  var RunWordWrap$1 = function RunWordWrap(config) {
    // Parse parameters
    var startIndex = GetValue$a(config, 'start', 0);
    SetPadding$1(this.wrapPadding, GetValue$a(config, 'padding', 0));
    ...
    var lineHeight = GetValue$a(config, 'lineHeight');
    var ascent = GetValue$a(config, 'ascent', lineHeight);
    var maxLines;
    if (lineHeight === undefined) {
      // Calculate lineHeight
      var useDefaultTextHeight = GetValue$a(config, 'useDefaultTextHeight', false);
      maxLines = GetValue$a(config, 'maxLines', 0);
      ...
      if (this.fixedHeight > 0) {
        ...
        maxLines = GetValue$a(config, 'maxLines');
        if (maxLines === undefined) {
          var innerHeight = this.fixedHeight - paddingVertical;
          maxLines = Math.floor(innerHeight / lineHeight);
        }
      } else {
        maxLines = GetValue$a(config, 'maxLines', 0); // Default is show all lines
      }
    }
    ...
    // Get wrapWidth
    var wrapWidth = GetValue$a(config, 'wrapWidth', undefined);
    ...
    var letterSpacing = GetValue$a(config, 'letterSpacing', 0);
    var hAlign = GetValue$a(config, 'hAlign', 0);
    var vAlign = GetValue$a(config, 'vAlign', 0);
    var charWrap = GetValue$a(config, 'charWrap', false);
  ...
  var RunVerticalWrap$1 = function RunVerticalWrap(config) {
    ...
    var paddingVertical = this.padding.top + this.padding.bottom + this.wrapPadding.top + this.wrapPadding.bottom;
    var paddingHorizontal = this.padding.left + this.padding.right + this.wrapPadding.left + this.wrapPadding.right;
    var lineWidth = GetValue$9(config, 'lineWidth', undefined);
    var maxLines;
    if (lineWidth === undefined) {
      ...
      if (this.fixedWidth > 0) {
        ...
        maxLines = GetValue$9(config, 'maxLines', undefined);
        if (maxLines === undefined) {
          var innerWidth = this.fixedWidth - paddingHorizontal;
    ...
    var fixedCharacterHeight = GetValue$9(config, 'fixedCharacterHeight', undefined);
    if (fixedCharacterHeight === undefined) {
      var charPerLine = GetValue$9(config, 'charPerLine', undefined);
    ...
    // Get wrapHeight
    var wrapHeight = GetValue$9(config, 'wrapHeight', undefined);
    ...
    var rtl = GetValue$9(config, 'rtl', true);
    var hAlign = GetValue$9(config, 'hAlign', rtl ? 2 : 0);
  ...
  var RunWrap = function RunWrap(config) {
    var wrapCallback = GetValue$8(this.wrapConfig, 'callback');
    if (!wrapCallback) {
      wrapCallback = GetValue$8(config, 'callback', this.runWordWrap);
    }
  ...
  var DynamicText = /*#__PURE__*/function (_Canvas) {
    ...
    function DynamicText(scene, x, y, fixedWidth, fixedHeight, config) {
      ...
      if (IsPlainObject$1(x)) {
        ...
        fixedWidth = GetValue$7(config, 'width', 0);
        fixedHeight = GetValue$7(config, 'height', 0);
      ...
      var textStyleConfig = GetValue$7(config, 'style', undefined);
      _this.defaultTextStyle = new TextStyle(null, textStyleConfig);
      _this.textStyle = _this.defaultTextStyle.clone();
      _this.setTestString(GetValue$7(config, 'testString', '|MÉqgy'));
      _this._textOX = 0;
      _this._textOY = 0;
      _this.background = new Background(_assertThisInitialized(_this), GetValue$7(config, 'background', undefined));
      _this.innerBounds = new InnerBounds(_assertThisInitialized(_this), GetValue$7(config, 'innerBounds', undefined));
      _this.children = [];
      ...
      _this.setPadding(GetValue$7(config, 'padding', 0));
      _this.setWrapConfig(GetValue$7(config, 'wrap', undefined));
      _this.setChildrenInteractiveEnable(GetValue$7(config, 'childrenInteractive', false));
      var text = GetValue$7(config, 'text', undefined);
      if (text) {
        _this.setText(text);
      }
      return _this;
  ...
  var BuildLabelConfig = function BuildLabelConfig(scene, config, creators) {
    ...
    if (config.text !== null && createText) {
      var wrapText = GetValue$6(config, 'wrapText', false);
      if (wrapText) {
        if (wrapText === true) {
          wrapText = 'word';
        }
  ...
  var HiddenTextEditBase = /*#__PURE__*/function (_ComponentBase) {
    ...
    function HiddenTextEditBase(gameObject, config) {
      ...
      _this.setEnterCloseEnable(GetValue$3(config, 'enterClose', textType !== 'textarea'));
      ...
      _this.onUpdateCallback = GetValue$3(config, 'onUpdate', undefined);
  ...
  var HiddenTextEdit = /*#__PURE__*/function (_HiddenTextEditBase) {
    ...
    function HiddenTextEdit(gameObject, config) {
      ...
      _this.setSelectAllWhenFocusEnable(GetValue$2(config, 'selectAll', false));
