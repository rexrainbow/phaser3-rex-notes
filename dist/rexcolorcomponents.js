(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncScrollFactor = GetValue$1s(config, 'syncScrollFactor', true);
      state.syncCameraFilter = GetValue$1s(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$1s(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$1q(config, 'color');
      lineWidth = GetValue$1q(config, 'lineWidth');
      fillColor = GetValue$1q(config, 'fillColor');
      fillAlpha = GetValue$1q(config, 'fillAlpha', 1);
      padding = GetValue$1q(config, 'padding', 0);
    }
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    ...
    var gameObjects = GetValue$1p(config, 'children');
  ...
  Object.assign(methods$e, Parent, AddChild$3, RemoveChild$2, ChildState, Transform, Position, Rotation, Scale$2, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$1k(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$1k(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$1k(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$1k(o, 'onUpdateViewportCallbackScope');
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$1j(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$1i(config, 'tickEventName', defaultEventName);
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.state = GetValue$1h(o, 'state', IDLE$6);
        this.timeScale = GetValue$1h(o, 'timeScale', 1);
        this.delay = GetValue$1h(o, 'delay', 0);
        this.repeat = GetValue$1h(o, 'repeat', 0);
        this.repeatCounter = GetValue$1h(o, 'repeatCounter', 0);
        this.repeatDelay = GetValue$1h(o, 'repeatDelay', 0);
        this.duration = GetValue$1h(o, 'duration', 0);
        this.nowTime = GetValue$1h(o, 'nowTime', 0);
        this.justRestart = GetValue$1h(o, 'justRestart', false);
      }
    }, {
      key: "toJSON",
  ...
  var EaseValueTaskBase = /*#__PURE__*/function (_TimerTask) {
    ...
    _createClass(EaseValueTaskBase, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1g(o, 'timer'));
        this.setEnable(GetValue$1g(o, 'enable', true));
        this.setTarget(GetValue$1g(o, 'target', this.parent));
        this.setDelay(GetAdvancedValue$4(o, 'delay', 0));
        this.setDuration(GetAdvancedValue$4(o, 'duration', 1000));
        this.setEase(GetValue$1g(o, 'ease', 'Linear'));
        this.setRepeat(GetValue$1g(o, 'repeat', 0));
        return this;
      }
    }, {
      key: "setEnable",
  ...
  var methods$d = {};
  Object.assign(methods$d, ScaleMethods);
  methods$d.onInitScale = function () {
  ...
  var methods$c = {};
  Object.assign(methods$c, FadeMethods);
  methods$c.onInitFade = function () {
  ...
  var methods$b = {};
  Object.assign(methods$b, EaseMoveMethods);
  methods$b.onInitEaseMove = function () {
  ...
  var ShakePosition = /*#__PURE__*/function (_TickTask) {
    ...
    _createClass(ShakePosition, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setMode(GetValue$1c(o, 'mode', 1));
        this.isRunning = GetValue$1c(o, 'isRunning', false);
        this.setMagnitudeMode(GetValue$1c(o, 'magnitudeMode', 1));
        this.setAxisMode(GetValue$1c(o, "axis", 0));
        this.setDuration(GetValue$1c(o, 'duration', 500));
        this.setMagnitude(GetValue$1c(o, 'magnitude', 10));
        this.ox = GetValue$1c(o, 'ox', undefined);
        this.oy = GetValue$1c(o, 'oy', undefined);
        return this;
      }
    }, {
      key: "toJSON",
      ...
      value: function start(duration, magnitude) {
        if (typeof duration !== 'number') {
          var config = duration;
          magnitude = GetValue$1c(config, 'magnitude', undefined);
          duration = GetValue$1c(config, 'duration', undefined);
        }
  ...
  var EaseValueTask = /*#__PURE__*/function (_EaseValueTaskBase) {
    ...
    _createClass(EaseValueTask, [{
      ...
      value: function start(config) {
        ...
        var target = this.target;
        this.propertyKey = GetValue$1b(config, 'key', 'value');
        var currentValue = target[this.propertyKey];
        this.fromValue = GetValue$1b(config, 'from', currentValue);
        this.toValue = GetValue$1b(config, 'to', currentValue);
        this.setEase(GetValue$1b(config, 'ease', this.ease));
        this.setDuration(GetValue$1b(config, 'duration', this.duration));
        this.setRepeat(GetValue$1b(config, 'repeat', 0));
        this.setDelay(GetValue$1b(config, 'delay', 0));
        this.setRepeatDelay(GetValue$1b(config, 'repeatDelay', 0));
    ...
    _createClass(FSM, [{
      ...
      */
      ...
      value: function resetFromJSON(o) {
        ...
        this._scene = GetValue$1a(o, 'scene', undefined);
        return this;
      }
    }, {
      key: "stateProperties",
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.setTransitInTime(GetValue$19(config, 'duration.in', 200));
      _this.setTransitOutTime(GetValue$19(config, 'duration.out', 200));
      _this.setTransitInCallback(GetValue$19(config, 'transitIn'));
      _this.setTransitOutCallback(GetValue$19(config, 'transitOut'));
      _this.oneShotMode = GetValue$19(config, 'destroy', false);
      _this.delayCallTimer = undefined;
      _this._state = new State$1(_assertThisInitialized(_this), {
        eventEmitter: false,
        initState: GetValue$19(config, 'initState', 'IDLE')
      });
  ...
  var TouchEventStop = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TouchEventStop, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setHitAreaMode(GetValue$18(o, 'hitAreaMode', 0));
        this.setEnable(GetValue$18(o, 'enable', true));
        this.setStopMode(GetValue$18(o, 'stopAllLevels', true));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Cover = /*#__PURE__*/function (_FullWindowRectangle) {
    ...
    function Cover(scene, config) {
      ...
      var fillColor = GetValue$17(config, 'color', 0x0);
      var fillAlpha = GetValue$17(config, 'alpha', 0.8);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      config.destroy = GetValue$16(config, 'destroy', true);
      _this = _callSuper(this, Modal, [gameObject, config]);
      // this.parent = gameObject;
      // this.scene

      // Cover : key of modal, to block touch input        
      var coverConfig = GetValue$16(config, 'cover');
      _this.cover = coverConfig !== false ? CreateCover(gameObject, coverConfig) : undefined;
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$16(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$16(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }

      // Close conditions:
      var touchOutsideClose = GetValue$16(config, 'touchOutsideClose', false);
      var timeOutDuration = GetValue$16(config, 'duration.hold', -1);
      var timeOutClose = GetValue$16(config, 'timeOutClose', timeOutDuration >= 0);
      var anyTouchClose = GetValue$16(config, 'anyTouchClose', false);
      var manualClose = GetValue$16(config, 'manualClose', false);
      if (manualClose) {
      ...
      if (GetValue$16(config, 'openOnStart', true)) {
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Button(gameObject, config) {
      ...
      gameObject.setInteractive(GetValue$15(config, "inputConfig", undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
  ...
  var ClickOutside = /*#__PURE__*/function (_ComponentBase) {
    ...
    function ClickOutside(gameObject, config) {
      ...
      _this._enable = undefined;
      var inputConfig = GetValue$14(config, "inputConfig", undefined);
      if (inputConfig) {
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$13(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
    _createClass(InTouching, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setCooldown(GetValue$13(o, 'cooldown', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var DownChild = function DownChild(config) {
    var downConfig = GetValue$12(config, 'down', undefined);
    if (downConfig === false) {
      return;
  ...
  var UpChild = function UpChild(config) {
    var upConfig = GetValue$11(config, 'up', undefined);
    if (upConfig === false) {
      return;
  ...
  var OverChild = function OverChild(config) {
    var overConfig = GetValue$10(config, 'over', undefined);
    if (overConfig === false) {
      return;
  ...
  var OnePointerTracer = /*#__PURE__*/function (_TickTask) {
    ...
    function OnePointerTracer(gameObject, config) {
      ...
      if (gameObject) {
        gameObject.setInteractive(GetValue$_(config, 'inputConfig', undefined));
      }
      _this._enable = undefined;
      _this.resetFromJSON(config);
      _this.boot();
    ...
    _createClass(OnePointerTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        if (this.gameObject === undefined) {
          this.setDetectBounds(GetValue$_(o, 'bounds', undefined));
        } else {
          this.setDetectBounds();
        }
  ...
  Object.assign(methods$8, PaddingMethods, AddChildMethods$2, RemoveChildMethods$2, GetParentSizerMethods, methods$d, methods$c, methods$b, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  var Base$1 = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      var origin = GetValue$Q(config, 'origin', 0.5);
      var originX = GetValue$Q(config, 'originX', origin);
      var originY = GetValue$Q(config, 'originY', origin);
  ...
  Object.assign(methods$7, AddChildMethods$1, RemoveChildMethods$1, AlignMethods, ProportionMethods, ExpandMethods, SortChildrenMethods);
  ...
  Object.assign(Methods$7, RenderMethods);
  ...
  Object.assign(RenderBase.prototype, Methods$7);
  ...
  var InnerBounds = /*#__PURE__*/function (_RenderBase) {
    ...
    _createClass(InnerBounds, [{
      ...
      value: function modifyPorperties(o) {
        ...
        if (o.hasOwnProperty('color')) {
          this.setColor(o.color, GetValue$K(o, 'color2', null), GetValue$K(o, 'horizontalGradient', true));
        }
        if (o.hasOwnProperty('stroke')) {
          this.setStroke(o.stroke, GetValue$K(o, 'strokeThickness', 2));
        }
      }
    }, {
      key: "renderContent",
  ...
  var TextStyle$1 = /*#__PURE__*/function () {
    ...
    _createClass(TextStyle, [{
      ...
      value: function set(o) {
        ...
        this.setBackgroundColor(GetValue$J(o, 'backgroundColor', null));
        this.setBackgroundHeight(GetValue$J(o, 'backgroundHeight', undefined));
        this.setBackgroundBottomY(GetValue$J(o, 'backgroundBottomY', undefined));
        return this;
      }
    }, {
      key: "modify",
  ...
  var RunWordWrap$1 = function RunWordWrap(config) {
    ...
    var lineHeight = GetValue$I(config, 'lineHeight');
    var ascent = GetValue$I(config, 'ascent', lineHeight);
    var maxLines;
    if (lineHeight === undefined) {
      // Calculate lineHeight
      var useDefaultTextHeight = GetValue$I(config, 'useDefaultTextHeight', false);
      ...
      if (this.fixedHeight > 0) {
        ...
        maxLines = GetValue$I(config, 'maxLines');
    ...
    var wrapMode = GetValue$I(config, 'wrapMode');
    ...
    var justifyPercentage = GetValue$I(config, 'justifyPercentage', 0.25);
  ...
  var RunVerticalWrap$1 = function RunVerticalWrap(config) {
    ...
    var paddingVertical = this.padding.top + this.padding.bottom + this.wrapPadding.top + this.wrapPadding.bottom;
    var paddingHorizontal = this.padding.left + this.padding.right + this.wrapPadding.left + this.wrapPadding.right;
    var lineWidth = GetValue$H(config, 'lineWidth', undefined);
    var maxLines;
    if (lineWidth === undefined) {
      ...
      if (this.fixedWidth > 0) {
        ...
        maxLines = GetValue$H(config, 'maxLines', undefined);
        if (maxLines === undefined) {
          var innerWidth = this.fixedWidth - paddingHorizontal;
    ...
    var fixedCharacterHeight = GetValue$H(config, 'fixedCharacterHeight', undefined);
    if (fixedCharacterHeight === undefined) {
      var charPerLine = GetValue$H(config, 'charPerLine', undefined);
    ...
    // Get wrapHeight
    var wrapHeight = GetValue$H(config, 'wrapHeight', undefined);
    ...
    var rtl = GetValue$H(config, 'rtl', true);
    var hAlign = GetValue$H(config, 'hAlign', rtl ? 2 : 0);
  ...
  var RunWrap = function RunWrap(config) {
    var wrapCallback = GetValue$G(this.wrapConfig, 'callback');
    if (!wrapCallback) {
      wrapCallback = GetValue$G(config, 'callback', this.runWordWrap);
    }
  ...
  Object.assign(Methods$6, MoveChildMethods, BackgroundMethods, InnerBoundsMethods, SetAlignMethods, SetTextOXYMethods$1);
  ...
  var DynamicText = /*#__PURE__*/function (_Canvas) {
    ...
    function DynamicText(scene, x, y, fixedWidth, fixedHeight, config) {
      ...
      if (IsPlainObject$b(x)) {
        ...
        fixedWidth = GetValue$F(config, 'width', 0);
        fixedHeight = GetValue$F(config, 'height', 0);
      ...
      var textStyleConfig = GetValue$F(config, 'style', undefined);
      _this.defaultTextStyle = new TextStyle$1(null, textStyleConfig);
      _this.textStyle = _this.defaultTextStyle.clone();
      _this.setTestString(GetValue$F(config, 'testString', '|MÉqgy'));
      _this._textOX = 0;
      _this._textOY = 0;
      _this.background = new Background(_assertThisInitialized(_this), GetValue$F(config, 'background', undefined));
      _this.innerBounds = new InnerBounds(_assertThisInitialized(_this), GetValue$F(config, 'innerBounds', undefined));
      _this.children = [];
      ...
      _this.setPadding(GetValue$F(config, 'padding', 0));
      _this.setWrapConfig(GetValue$F(config, 'wrap', undefined));
      _this.setChildrenInteractiveEnable(GetValue$F(config, 'childrenInteractive', false));
  ...
  Object.assign(DynamicText.prototype, Methods$6);
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      var icon = GetValue$E(config, 'icon', undefined);
      var iconMask = GetValue$E(config, 'iconMask', undefined);
      var text = GetValue$E(config, 'text', undefined);
      var action = GetValue$E(config, 'action', undefined);
      var actionMask = GetValue$E(config, 'actionMask', undefined);
      // Align
      var align = GetValue$E(config, 'align', undefined); // undefined/left/top: no space
      ...
      if (icon) {
        ...
        var fitRatio = GetValue$E(config, 'squareFitIcon', false) ? 1 : 0;
        _this.add(icon, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
      ...
      if (text) {
        var wrapText = GetValue$E(config, 'wrapText', false);
        if (wrapText) {
          if (wrapText === true) {
            wrapText = 'word';
          }
        ...
        var textSpace = GetValue$E(config, 'space.text', 0);
        var expandTextWidth = GetValue$E(config, 'expandTextWidth', false);
        var expandTextHeight = GetValue$E(config, 'expandTextHeight', false);
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_PolygnBase) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$D(radiusConfig, 'radius', radiusConfig);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$C(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$C(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$C(config, 'onModifyStyle');
      return _this;
    }
  ...
  Object.assign(BaseShapes.prototype, Render$1);
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      _this.setTrackColor(GetValue$A(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$A(config, 'trackStrokeThickness', 2), GetValue$A(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$A(config, 'skewX', 0));
  ...
  Object.assign(LineProgress.prototype, Methods$5);
  ...
  var StatesNineSlice = /*#__PURE__*/function (_PhaserNineSlice) {
    ...
    function StatesNineSlice(scene, config) {
      ...
      var key = GetValue$z(config, 'key', null);
      var frame = GetValue$z(config, 'frame', null);
      var width = GetValue$z(config, 'width', 0);
      var height = GetValue$z(config, 'height', 0);
      var leftWidth = GetValue$z(config, 'leftWidth', 0);
      var rightWidth = GetValue$z(config, 'rightWidth', 0);
      var topHeight = GetValue$z(config, 'topHeight', 0);
      var bottomHeight = GetValue$z(config, 'bottomHeight', 0);
  ...
  var StatesImage = /*#__PURE__*/function (_PhaserImage) {
    ...
    function StatesImage(scene, config) {
      ...
      var x = GetValue$y(config, 'x', 0);
      var y = GetValue$y(config, 'y', 0);
      var key = GetValue$y(config, 'key', '');
      var frame = GetValue$y(config, 'frame', undefined);
      _this = _callSuper(this, StatesImage, [scene, x, y, key, frame]);
      _this.type = 'rexStatesImage';
      var effectConfig = GetValue$y(config, 'effects', true);
      if (effectConfig) {
        AddEffectProperties(_assertThisInitialized(_this), effectConfig);
      }
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$8(mode)) {
      this.stretchMode.edge = parseMode(GetValue$x(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$x(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$7(x)) {
          ...
          width = GetValue$w(config, 'width', 1);
          height = GetValue$w(config, 'height', 1);
          key = GetValue$w(config, 'key', undefined);
          baseFrame = GetValue$w(config, 'baseFrame', undefined);
          columns = GetValue$w(config, 'columns', undefined);
          rows = GetValue$w(config, 'rows', undefined);
        ...
        if (baseFrame === undefined) {
          baseFrame = GetValue$w(config, 'frame', undefined);
        }
        if (columns === undefined) {
          var leftWidth = GetValue$w(config, 'leftWidth', undefined);
          var rightWidth = GetValue$w(config, 'rightWidth', undefined);
          if (leftWidth !== undefined && rightWidth !== undefined) {
            columns = [leftWidth, undefined, rightWidth];
          }
        }
        if (rows === undefined) {
          var topHeight = GetValue$w(config, 'topHeight', undefined);
          var bottomHeight = GetValue$w(config, 'bottomHeight', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$w(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$w(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$w(config, 'preserveRatio', true));
        var maxFixedPartScale = GetValue$w(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$w(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$w(config, 'maxFixedPartScaleY', undefined);
  ...
  var StatesNinePatch = /*#__PURE__*/function (_NinePatch) {
    ...
    function StatesNinePatch(scene, config) {
      ...
      var effectConfig = GetValue$v(config, 'effects', true);
      if (effectConfig) {
        AddEffectProperties(_assertThisInitialized(_this), effectConfig);
      }
  ...
  var StatesText = /*#__PURE__*/function (_PhaserText) {
    ...
    function StatesText(scene, config) {
      ...
      var x = GetValue$u(config, 'x', 0);
      var y = GetValue$u(config, 'y', 0);
      var text = GetValue$u(config, 'text', '');
  ...
  var AddImage = function AddImage(key, config) {
    ...
    this.images[key] = {
      ...
      tintFill: GetValue$q(config, 'tintFill', false)
    };
  };
  ...
  var Parser = /*#__PURE__*/function () {
    function Parser(style) {
      ...
      var delimiters = GetValue$o(style, 'delimiters', '[]');
  ...
  var StatesBitmapText = /*#__PURE__*/function (_PhaserBitmapText) {
    ...
    function StatesBitmapText(scene, config) {
      ...
      var font = GetValue$n(config, 'font', '');
      var size = GetValue$n(config, 'fontSize', false);
      var align = GetValue$n(config, 'align', 0);
      var tint = GetValue$n(config, 'tint');
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    ...
    if (IsPlainObject$4(columnIndex)) {
      ...
      columnIndex = GetValue$m(config, 'column', undefined);
      rowIndex = GetValue$m(config, 'row', undefined);
      align = GetValue$m(config, 'align', ALIGN_CENTER);
    ...
    if (IsPlainObject$4(expand)) {
      config.expandWidth = GetValue$m(expand, 'width', false);
      config.expandHeight = GetValue$m(expand, 'height', false);
    } else {
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    // space
    this.setColumnSpace(GetValue$l(space, 'column', 0));
    this.setRowSpace(GetValue$l(space, 'row', 0));
    var scene = this.scene;
  ...
  Object.assign(methods$1, AddChildMethods, RemoveChildMethods, SetSpaceMethods, SortChildrenMethods);
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject$3(x)) {
        ...
        columnCount = GetValue$k(config, 'column', config.col || 0);
        rowCount = GetValue$k(config, 'row', 0);
        columnProportions = GetValue$k(config, 'columnProportions', 0);
        rowProportions = GetValue$k(config, 'rowProportions', 0);
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$k(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$k(config, 'space.indentLeftOdd', 0), GetValue$k(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$k(config, 'space.indentTopOdd', 0), GetValue$k(config, 'space.indentTopEven', 0));
      _this.resetGrid(columnCount, rowCount, columnProportions, rowProportions, GetValue$k(config, 'space', undefined));
      return _this;
    }
  ...
  var AddChild = function AddChild(topPatent, childParent, config) {
    var childConfig = GetValue$j(config, 'child');
    var child = GetValue$j(childConfig, 'gameObject', undefined);
    if (child) {
      ...
      if (typeof childSpace === 'number') {
        ...
        switch (topPatent.scrollMode) {
          ...
          default:
            ...
            childMargin.top = GetValue$j(childSpace, 'top', 0);
            childMargin.bottom = GetValue$j(childSpace, 'bottom', 0);
            childMargin.left = GetValue$j(childSpace, 'left', 0);
            childMargin.right = GetValue$j(childSpace, 'right', 0);
            break;
        }
      }
      childParent.add(child, {
        ...
        expand: {
          ...
          // Private
          height: GetValue$j(childConfig, 'expandHeight', true) // Private
        }
      });
    }
  ...
  var HiddenTextEditBase = /*#__PURE__*/function (_ComponentBase) {
    ...
    function HiddenTextEditBase(gameObject, config) {
      ...
      _this.clickOutSideTarget = GetValue$3(config, 'clickOutSideTarget', undefined);
