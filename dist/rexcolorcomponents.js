(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncPosition = GetValue$18(config, 'syncPosition', true);
      state.syncRotation = GetValue$18(config, 'syncRotation', true);
      state.syncScale = GetValue$18(config, 'syncScale', true);
      state.syncAlpha = GetValue$18(config, 'syncAlpha', true);
      state.syncScrollFactor = GetValue$18(config, 'syncScrollFactor', true);
    }
  };
  var AddChild$2 = {
  ...
  */
  ...
  var Snapshot = function Snapshot(config) {
    ...
    var x = GetValue$17(config, 'x', undefined);
    var y = GetValue$17(config, 'y', undefined);
    var width = GetValue$17(config, 'width', undefined);
    var height = GetValue$17(config, 'height', undefined);
    var originX = GetValue$17(config, 'originX', 0);
    var originY = GetValue$17(config, 'originY', 0);
    var padding = GetValue$17(config, 'padding', 0);
    var scrollX, scrollY;
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$16(config, 'color');
      lineWidth = GetValue$16(config, 'lineWidth');
      fillColor = GetValue$16(config, 'fillColor');
      fillAlpha = GetValue$16(config, 'fillAlpha', 1);
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    var drawContainer = GetValue$15(config, 'drawContainer', true);
    var gameObjects = GetValue$15(config, 'children');
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$14(config, 'color');
      lineWidth = GetValue$14(config, 'lineWidth');
      var nameTextConfig = GetValue$14(config, 'name', false);
      if (nameTextConfig) {
        createTextCallback = GetValue$14(nameTextConfig, 'createTextCallback', DefaultCreateTextCallback);
        createTextCallbackScope = GetValue$14(nameTextConfig, 'createTextCallbackScope', undefined);
        textAlign = GetValue$14(nameTextConfig, 'align', 'left-top');
  ...
  var GetBoundsConfig = function GetBoundsConfig(config, out) {
    ...
    if (typeof config === 'number') {
      ...
      out.left = GetValue$13(config, 'left', 0);
      out.right = GetValue$13(config, 'right', 0);
      out.top = GetValue$13(config, 'top', 0);
      out.bottom = GetValue$13(config, 'bottom', 0);
    }
    return out;
  };
  ...
  var SetPadding$1 = function SetPadding(padding, key, value) {
    ...
    if (keyType === 'string') {
      ...
      padding.left = GetValue$12(key, 'left', 0);
      padding.right = GetValue$12(key, 'right', 0);
      padding.top = GetValue$12(key, 'top', 0);
      padding.bottom = GetValue$12(key, 'bottom', 0);
    }
    return padding;
  };
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$11(config, 'eventEmitter', true));
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$10(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$$(config, 'tickEventName', defaultEventName);
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.state = GetValue$_(o, 'state', IDLE$6);
        ...
        this.repeatDelay = GetValue$_(o, 'repeatDelay', 0);
  ...
  */
  ...
  var SwipeChild = function SwipeChild(config) {
    var swipeConfig = GetValue$z(config, 'swipe', undefined);
  ...
  var SetChildrenInteractive$1 = function SetChildrenInteractive(gameObject, config) {
    ...
    gameObject._childrenInteractive = {
      targetSizers: GetValue$y(config, 'targets', [gameObject]),
      eventEmitter: GetValue$y(config, 'eventEmitter', gameObject),
      eventNamePrefix: GetValue$y(config, 'inputEventPrefix', 'child.')
    };
  ...
  var Base$1 = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.setName(GetValue$x(config, 'name', ''));
      _this.rexSizer = {};
      _this.space = {};
      ...
      var anchorConfig = GetValue$x(config, 'anchor', undefined);
      if (anchorConfig) {
        _this.setAnchor(anchorConfig);
      }
      _this.setInnerPadding(GetValue$x(config, 'space', 0));
      var draggable = GetValue$x(config, 'draggable', false);
      if (draggable) {
        _this.setDraggable(draggable);
      }
      _this.setSizerEventsEnable(GetValue$x(config, 'sizerEvents', false));
      _this.setDirty(true);
  ...
  var Add = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$w(config, 'proportion', undefined);
      align = GetValue$w(config, 'align', ALIGN_CENTER);
      paddingConfig = GetValue$w(config, 'padding', 0);
      expand = GetValue$w(config, 'expand', false);
      childKey = GetValue$w(config, 'key', undefined);
      index = GetValue$w(config, 'index', undefined);
      if (!gameObject.isRexSizer) {
        minWidth = GetValue$w(config, 'minWidth', undefined);
        minHeight = GetValue$w(config, 'minHeight', undefined);
      }
      fitRatio = GetValue$w(config, 'fitRatio', 0); // width/height
    }
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      if (IsPlainObject$8(x)) {
        ...
        orientation = GetValue$v(config, 'orientation', 0);
      ...
      _this.setItemSpacing(GetValue$v(config, 'space.item', 0));
      _this.setStartChildIndex(GetValue$v(config, 'startChildIndex', 0));
      _this.setRTL(GetValue$v(config, 'rtl', false));
    ...
    function Label(scene, config) {
      ...
      if (icon) {
        ...
        if (_this.orientation === 0) {
          if (text || action) {
            padding = {
              right: GetValue$u(config, 'space.icon', 0),
              top: GetValue$u(config, 'space.iconTop', 0),
              bottom: GetValue$u(config, 'space.iconBottom', 0)
            };
          }
        } else {
          if (text || action) {
            padding = {
              bottom: GetValue$u(config, 'space.icon', 0),
              left: GetValue$u(config, 'space.iconLeft', 0),
              right: GetValue$u(config, 'space.iconRight', 0)
            };
          }
        }
      ...
      if (action) {
        ...
        if (_this.orientation === 0) {
          padding = {
            top: GetValue$u(config, 'space.actionTop', 0),
            bottom: GetValue$u(config, 'space.actionBottom', 0)
          };
        } else {
          padding = {
            left: GetValue$u(config, 'space.actionLeft', 0),
            right: GetValue$u(config, 'space.actionRight', 0)
          };
        }
    ...
    _createClass(RoundRectangle, [{
      ...
      set: function set(value) {
        ...
        if (typeof value === 'number') {
          ...
          defaultRadiusX = GetValue$t(value, 'x', 0);
          defaultRadiusY = GetValue$t(value, 'y', 0);
        }
        var radius = this.cornerRadius;
        radius.tl = GetRadius(GetValue$t(value, 'tl', undefined), defaultRadiusX, defaultRadiusY);
        radius.tr = GetRadius(GetValue$t(value, 'tr', undefined), defaultRadiusX, defaultRadiusY);
        radius.bl = GetRadius(GetValue$t(value, 'bl', undefined), defaultRadiusX, defaultRadiusY);
        radius.br = GetRadius(GetValue$t(value, 'br', undefined), defaultRadiusX, defaultRadiusY);
      }
    }, {
      key: "radiusTL",
      get: function get() {
  ...
  var SetRadius = function SetRadius(radius, value) {
    if (typeof value === 'number') {
      ...
      radius.x = GetValue$t(value, 'x', 0);
      radius.y = GetValue$t(value, 'y', 0);
    }
    SetConvex(radius);
  };
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$s(radiusConfig, 'radius', radiusConfig);
      ...
      var iteration = GetValue$s(radiusConfig, 'iteration', undefined);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$r(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$r(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$r(config, 'onModifyStyle');
      return _this;
    }
  ...
  var StatesNineSlice = /*#__PURE__*/function (_PhaserNineSlice) {
    ...
    function StatesNineSlice(scene, config) {
      ...
      var key = GetValue$q(config, 'key', null);
      var frame = GetValue$q(config, 'frame', null);
      var width = GetValue$q(config, 'width', 0);
      var height = GetValue$q(config, 'height', 0);
      var leftWidth = GetValue$q(config, 'leftWidth', 0);
      var rightWidth = GetValue$q(config, 'rightWidth', 0);
      var topHeight = GetValue$q(config, 'topHeight', 0);
      var bottomHeight = GetValue$q(config, 'bottomHeight', 0);
  ...
  var StatesImage = /*#__PURE__*/function (_PhaserImage) {
    ...
    function StatesImage(scene, config) {
      ...
      var x = GetValue$p(config, 'x', 0);
      var y = GetValue$p(config, 'y', 0);
      var key = GetValue$p(config, 'key', '');
      var frame = GetValue$p(config, 'frame', undefined);
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$5(mode)) {
      this.stretchMode.edge = parseMode(GetValue$o(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$o(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$4(x)) {
          ...
          width = GetValue$n(config, 'width', 1);
          height = GetValue$n(config, 'height', 1);
          key = GetValue$n(config, 'key', undefined);
          baseFrame = GetValue$n(config, 'baseFrame', undefined);
          columns = GetValue$n(config, 'columns', undefined);
          rows = GetValue$n(config, 'rows', undefined);
        ...
        if (columns === undefined) {
          var leftWidth = GetValue$n(config, 'leftWidth', undefined);
          var rightWidth = GetValue$n(config, 'rightWidth', undefined);
          if (leftWidth !== undefined && rightWidth !== undefined) {
            columns = [leftWidth, undefined, rightWidth];
          }
        }
        if (rows === undefined) {
          var topHeight = GetValue$n(config, 'topHeight', undefined);
          var bottomHeight = GetValue$n(config, 'bottomHeight', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$n(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$n(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$n(config, 'preserveRatio', true));
        var maxFixedPartScale = GetValue$n(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$n(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$n(config, 'maxFixedPartScaleY', undefined);
  ...
  var StatesText = /*#__PURE__*/function (_PhaserText) {
    ...
    function StatesText(scene, config) {
      ...
      var x = GetValue$m(config, 'x', 0);
      var y = GetValue$m(config, 'y', 0);
      var text = GetValue$m(config, 'text', '');
  ...
  var DataMethods = {
    ...
    getData: function getData(key, defaultValue) {
      this.enableData();
      return key === undefined ? this.data : GetValue$T(this.data, key, defaultValue);
    },
