(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncPosition = GetValue$1a(config, 'syncPosition', true);
      state.syncRotation = GetValue$1a(config, 'syncRotation', true);
      state.syncScale = GetValue$1a(config, 'syncScale', true);
      state.syncAlpha = GetValue$1a(config, 'syncAlpha', true);
      state.syncScrollFactor = GetValue$1a(config, 'syncScrollFactor', true);
      state.syncCameraFilter = GetValue$1a(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$1a(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  var Snapshot = function Snapshot(config) {
    ...
    var x = GetValue$19(config, 'x', undefined);
    var y = GetValue$19(config, 'y', undefined);
    var width = GetValue$19(config, 'width', undefined);
    var height = GetValue$19(config, 'height', undefined);
    var originX = GetValue$19(config, 'originX', 0);
    var originY = GetValue$19(config, 'originY', 0);
    var padding = GetValue$19(config, 'padding', 0);
    var scrollX, scrollY;
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$18(config, 'color');
      lineWidth = GetValue$18(config, 'lineWidth');
      fillColor = GetValue$18(config, 'fillColor');
      fillAlpha = GetValue$18(config, 'fillAlpha', 1);
      padding = GetValue$18(config, 'padding', 0);
    }
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    var drawContainer = GetValue$17(config, 'drawContainer', true);
    var gameObjects = GetValue$17(config, 'children');
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$16(config, 'color');
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$13(config, 'eventEmitter', true));
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$12(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$12(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$12(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$12(o, 'onUpdateViewportCallbackScope');
  ...
  */
  ...
  var Add = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    if (proportion === null) {
      ...
      align = GetValue$x(config, 'align', ALIGN_CENTER);
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      var icon = GetValue$v(config, 'icon', undefined);
      var iconMask = GetValue$v(config, 'iconMask', undefined);
      var text = GetValue$v(config, 'text', undefined);
      var action = GetValue$v(config, 'action', undefined);
      ...
      if (icon) {
        ...
        if (_this.orientation === 0) {
          if (text || action) {
            padding = {
              right: GetValue$v(config, 'space.icon', 0),
              top: GetValue$v(config, 'space.iconTop', 0),
              bottom: GetValue$v(config, 'space.iconBottom', 0),
              left: GetValue$v(config, 'space.iconLeft', 0)
            };
          }
        } else {
          if (text || action) {
            padding = {
              bottom: GetValue$v(config, 'space.icon', 0),
              left: GetValue$v(config, 'space.iconLeft', 0),
              right: GetValue$v(config, 'space.iconRight', 0),
              top: GetValue$v(config, 'space.iconTop', 0)
            };
          }
        }
      ...
      if (action) {
        ...
        if (_this.orientation === 0) {
          padding = {
            top: GetValue$v(config, 'space.actionTop', 0),
            bottom: GetValue$v(config, 'space.actionBottom', 0),
            right: GetValue$v(config, 'space.actionRight', 0)
          };
        } else {
          padding = {
            left: GetValue$v(config, 'space.actionLeft', 0),
            right: GetValue$v(config, 'space.actionRight', 0),
            bottom: GetValue$v(config, 'space.actionBottom', 0)
          };
        }
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$t(radiusConfig, 'radius', radiusConfig);
      ...
      var iteration = GetValue$t(radiusConfig, 'iteration', undefined);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$s(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$s(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$s(config, 'onModifyStyle');
      return _this;
    }
  ...
  var StatesBitmapText = /*#__PURE__*/function (_PhaserBitmapText) {
    ...
    function StatesBitmapText(scene, config) {
      ...
      var font = GetValue$f(config, 'font', '');
      var size = GetValue$f(config, 'fontSize', false);
      var align = GetValue$f(config, 'align', 0);
      var tint = GetValue$f(config, 'tint');
