...
class HslAdjustFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class HslAdjustController extends Filters.Controller {
    static FilterName = FilterName;
...
export { HslAdjustFilterPlugin as default };
