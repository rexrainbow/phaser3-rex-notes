(function (global, factory) {
  ...
  */
  	  ...
  	  return (function () {
  	    ...
  	    function Loki(filename, options) {
  	      ...
  	      var getENV = function () {
  	        ...
  	        if (typeof commonjsGlobal !== 'undefined' && commonjsGlobal.window && typeof process !== 'undefined') {
  ...
  var CreateCharacterDB = function CreateCharacterDB(db) {
    if (db === undefined) {
  ...
  var CreateBitmapTextClass = function CreateBitmapTextClass(BaseClass) {
    var BitmapTextClass = /*#__PURE__*/function (_BaseClass) {
      ...
      function BitmapTextClass(scene, x, y, key, text, size, align) {
        ...
        _this = _callSuper(this, BitmapTextClass, [scene, x, y, key, '', size, align]);
  ...
  var CharacterCachePlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    ...
    function CharacterCachePlugin(pluginManager) {
      ...
      return _callSuper(this, CharacterCachePlugin, [pluginManager]);
    }
