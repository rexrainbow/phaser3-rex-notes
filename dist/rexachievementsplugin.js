(function (global, factory) {
  ...
  */
  ...
  var Achievement = /*#__PURE__*/function () {
    function Achievement(keys, items) {
    ...
    _createClass(Achievement, [{
      key: "createTestCallback",
      value: function createTestCallback(keys, items) {
        // items[0]: level name
  ...
  var Achievements = /*#__PURE__*/function () {
    ...
    _createClass(Achievements, [{
      ...
      value: function loadCSV(csvString, config) {
        ...
        var table = papaparse_min.parse(csvString, {
          delimiter: delimiter
        }).data;
        var keys = table[0];
        keys.splice(0, 2);
      ...
      key: "runTest",
      value: function runTest(levelName, values) {
      ...
      key: "getTestResults",
      value: function getTestResults(levelName, values) {
