  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$e(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$e(config, 'propertiesMap');
      ...
      _this.onModifyStyleCallback = GetValue$e(config, 'onModifyStyle');
      return _this;
    }
