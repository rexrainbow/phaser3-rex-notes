    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$16(config, 'fillAlpha');
            padding = GetValue$16(config, 'padding');
            includeParent = GetValue$16(config, 'includeParent');
        }
    ...
    class SceneUpdateTickTask extends TickTask {
        constructor(parent, config) {
            ...
            this.tickEventName = GetValue$_(config, 'tickEventName', defaultEventName);
    ...
    */
    ...
    class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            this.setName(GetValue$w(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$w(config, 'space', 0));
            ...
            this.setSizerEventsEnable(GetValue$w(config, 'sizerEvents', false));
            this.setDirty(true);
    ...
    class Sizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, orientation, config) {
            ...
            this.setStartChildIndex(GetValue$u(config, 'startChildIndex', 0));
...
`;
    ...
    class GradientController extends phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setAlpha(GetValue$j(o, 'alpha', 0.2));
            this.setFromPosition(GetValue$j(o, 'fromX', 0), GetValue$j(o, 'fromY', 0));
            this.setToPosition(GetValue$j(o, 'toX', 0), GetValue$j(o, 'toY', 1));
            this.setColor1(GetValue$j(o, 'color1', 0xff0000));
            this.setColor2(GetValue$j(o, 'color2', 0x00ff00));
            this.setSize(GetValue$j(o, 'size', 0));
