    ...
    */
    ...
    class RoundRectangle extends PolygnBase {
        constructor(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
            ...
            this.setIteration(GetValue$s(radiusConfig, 'iteration', undefined));
            this.setPosition(x, y);
    ...
    class StyleManager extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.style = GetValue$r(config, 'style', this);
            ...
            this.onModifyStyle = GetValue$r(config, 'onModifyStyle');
        }
    ...
    function ProgressBase (BaseClass) {
        class ProgressBase extends BaseClass {
            bootProgressBase(config) {
                this.eventEmitter = GetValue$q(config, 'eventEmitter', this);

                var callback = GetValue$q(config, 'valuechangeCallback', null);
                if (callback !== null) {
                    var scope = GetValue$q(config, 'valuechangeCallbackScope', undefined);
                    this.eventEmitter.on('valuechange', callback, scope);
                }

                this
                    .setEaseValuePropName('value')
                    .setEaseValueDuration(GetValue$q(config, 'easeValue.duration', 0))
                    .setEaseValueFunction(GetValue$q(config, 'easeValue.ease', 'Linear'));
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            ...
            this.setTrackColor(GetValue$p(config, 'trackColor', undefined));
            this.setBarColor(barColor);
            this.setTrackStroke(GetValue$p(config, 'trackStrokeThickness', 2), GetValue$p(config, 'trackStrokeColor', undefined));

            this.setSkewX(GetValue$p(config, 'skewX', 0));
...
`;
    ...
    class BloomStepController extends Phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setOffset(GetValue$o(o, 'offsetX', 1), GetValue$o(o, 'offsetY', 1));
            this.setStrength(GetValue$o(o, 'strength', 1));
            this.setColor(GetValue$o(o, 'color', 0xFFFFFF));
    ...
    let BloomController$1 = class BloomController extends Phaser.Filters.ParallelFilters {
        ...
        resetFromJSON(o) {
            ...
            this.setBlurStrength(GetValue$n(o, 'blurStrength', 1));
            this.setColor(GetValue$n(o, 'color', 0xFFFFFF));
            this.setStrength(GetValue$n(o, 'strength', 1));
            this.setSteps(GetValue$n(o, 'steps', 4));
...
`;
    ...
    class GradientController extends Phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setAlpha(GetValue$l(o, 'alpha', 0.2));
            this.setFromPosition(GetValue$l(o, 'fromX', 0), GetValue$l(o, 'fromY', 0));
            this.setToPosition(GetValue$l(o, 'toX', 0), GetValue$l(o, 'toY', 1));
            this.setColor1(GetValue$l(o, 'color1', 0xff0000));
            this.setColor2(GetValue$l(o, 'color2', 0x00ff00));
            this.setSize(GetValue$l(o, 'size', 0));
...
`;
    ...
    class WipeController extends Phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setProgress(GetValue$k(o, 'progress', 0));
            this.setWipeWidth(GetValue$k(o, 'wipeWidth', 0.1));
            this.setDirection(GetValue$k(o, 'direction', 0));
            this.setAxis(GetValue$k(o, 'axis', 0));

            var reveal = GetValue$k(o, 'reveal', undefined);
            if (reveal === undefined) {
                reveal = !GetValue$k(o, 'wipe', true);
            }
            if (reveal) {
...
`;
    ...
    class ShineController extends Phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setSpeed(GetValue$j(o, 'speed', 0.5));
            this.setLineWidth(GetValue$j(o, 'lineWidth', 0.5));
            this.setGradient(GetValue$j(o, 'gradient', 3));
            this.setReveal(GetValue$j(o, 'reveal', false));
...
`;
    ...
    class VignetteController extends Phaser.Filters.Controller {
        ...
        resetFromJSON(o) {
            this.setPosition(GetValue$i(o, 'x', 0.5), GetValue$i(o, 'y', 0.5));
            this.setRadius(GetValue$i(o, 'radius', 0.5));
            this.setStrength(GetValue$i(o, 'strength', 0.5));
