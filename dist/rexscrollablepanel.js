  ...
  */
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      _this.setTrackColor(GetValue$h(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$h(config, 'trackStrokeThickness', 2), GetValue$h(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$h(config, 'skewX', 0));
