import { Events, Scene, Game, Utils, Math as Math$1, Plugins } from 'phaser';
...
const MathWrap = Math$1.Wrap;
const WrapAngle = Math$1.Angle.Wrap;
...
class RotateToPlugin extends Plugins.BasePlugin {
...
export { RotateToPlugin as default };
