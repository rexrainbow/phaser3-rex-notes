import { GameObjects, Geom, Math, Utils, Plugins } from 'phaser';
...
const GetLineToLine = Geom.Intersects.GetLineToLine;
const PointToLine = Geom.Intersects.PointToLine;
...
var globResult$1 = {};
var startPoint = new Math.Vector2();
var segment = new Geom.Line();
var tempIntersect = new Math.Vector3();
...
const GetAABB = Geom.Polygon.GetAABB;
const LineToRectangle = Geom.Intersects.LineToRectangle;
...
var globResult = {};
var AABBRect = new Geom.Rectangle();

const GetValue = Utils.Objects.GetValue;
const Line = Geom.Line;
const SetToAngle = Geom.Line.SetToAngle;
const ReflectAngle = Geom.Line.ReflectAngle;
...
class RaycasterPlugin extends Plugins.BasePlugin {
...
export { RaycasterPlugin as default };
