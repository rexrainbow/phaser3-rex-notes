import { Events, Scene, Game, Utils, Geom, Math as Math$1, GameObjects, Input, Cameras, Tweens, Plugins } from 'phaser';
...
class PinchZoom extends ComponentBase {
    constructor(scene, config) {
        ...
        this
            ...
            .setFocusEnable(GetValue$7(config, 'focusEnable', true));
...
class BoundsScroll extends ComponentBase {
    constructor(scene, config) {
        ...
        this.cameraController = new Cameras.Controls.SmoothedKeyControl({
...
class CameraControllerPlugin extends Plugins.BasePlugin {
...
export { CameraControllerPlugin as default };
