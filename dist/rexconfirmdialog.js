(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncPosition = GetValue$1w(config, 'syncPosition', true);
      state.syncRotation = GetValue$1w(config, 'syncRotation', true);
      state.syncScale = GetValue$1w(config, 'syncScale', true);
      state.syncAlpha = GetValue$1w(config, 'syncAlpha', true);
      state.syncScrollFactor = GetValue$1w(config, 'syncScrollFactor', true);
      state.syncCameraFilter = GetValue$1w(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$1w(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  var Snapshot = function Snapshot(config) {
    ...
    var x = GetValue$1v(config, 'x', undefined);
    var y = GetValue$1v(config, 'y', undefined);
    var width = GetValue$1v(config, 'width', undefined);
    var height = GetValue$1v(config, 'height', undefined);
    var originX = GetValue$1v(config, 'originX', 0);
    var originY = GetValue$1v(config, 'originY', 0);
    var padding = GetValue$1v(config, 'padding', 0);
    var scrollX, scrollY;
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$1u(config, 'color');
      lineWidth = GetValue$1u(config, 'lineWidth');
      fillColor = GetValue$1u(config, 'fillColor');
      fillAlpha = GetValue$1u(config, 'fillAlpha', 1);
      padding = GetValue$1u(config, 'padding', 0);
    }
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$1s(config, 'color');
  ...
  var SetPadding$1 = function SetPadding(padding, key, value) {
    ...
    if (keyType === 'string') {
      ...
      padding.left = GetValue$1q(key, 'left', 0);
      padding.right = GetValue$1q(key, 'right', 0);
      padding.top = GetValue$1q(key, 'top', 0);
      padding.bottom = GetValue$1q(key, 'bottom', 0);
    }
    return padding;
  };
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$1p(config, 'eventEmitter', true));
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$1o(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$1o(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$1o(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$1o(o, 'onUpdateViewportCallbackScope');
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$1n(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$1m(config, 'tickEventName', defaultEventName);
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.state = GetValue$1l(o, 'state', IDLE$6);
        this.timeScale = GetValue$1l(o, 'timeScale', 1);
        this.delay = GetValue$1l(o, 'delay', 0);
        this.repeat = GetValue$1l(o, 'repeat', 0);
        this.repeatCounter = GetValue$1l(o, 'repeatCounter', 0);
        this.repeatDelay = GetValue$1l(o, 'repeatDelay', 0);
        this.duration = GetValue$1l(o, 'duration', 0);
        this.nowTime = GetValue$1l(o, 'nowTime', 0);
        this.justRestart = GetValue$1l(o, 'justRestart', false);
      }
    }, {
      key: "toJSON",
  ...
  var EaseValueTaskBase = /*#__PURE__*/function (_TimerTask) {
    ...
    _createClass(EaseValueTaskBase, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1k(o, 'timer'));
        this.setEnable(GetValue$1k(o, 'enable', true));
        this.setTarget(GetValue$1k(o, 'target', this.parent));
        this.setDelay(GetAdvancedValue$4(o, 'delay', 0));
        this.setDuration(GetAdvancedValue$4(o, 'duration', 1000));
        this.setEase(GetValue$1k(o, 'ease', 'Linear'));
        this.setRepeat(GetValue$1k(o, 'repeat', 0));
        return this;
      }
    }, {
      key: "setEnable",
  ...
  var ShakePosition = /*#__PURE__*/function (_TickTask) {
    ...
    _createClass(ShakePosition, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.isRunning = GetValue$1g(o, 'isRunning', false);
        this.setMagnitudeMode(GetValue$1g(o, 'magnitudeMode', 1));
        this.setAxisMode(GetValue$1g(o, "axis", 0));
        this.setDuration(GetValue$1g(o, 'duration', 500));
        this.setMagnitude(GetValue$1g(o, 'magnitude', 10));
        this.ox = GetValue$1g(o, 'ox', undefined);
        this.oy = GetValue$1g(o, 'oy', undefined);
        return this;
      }
    }, {
      key: "toJSON",
      ...
      value: function start(duration, magnitude) {
        if (typeof duration !== 'number') {
          var config = duration;
          magnitude = GetValue$1g(config, 'magnitude', undefined);
          duration = GetValue$1g(config, 'duration', undefined);
        }
  ...
  var EaseValueTask = /*#__PURE__*/function (_EaseValueTaskBase) {
    ...
    _createClass(EaseValueTask, [{
      ...
      value: function start(config) {
        ...
        var target = this.target;
        this.propertyKey = GetValue$1f(config, 'key', 'value');
        var currentValue = target[this.propertyKey];
        this.fromValue = GetValue$1f(config, 'from', currentValue);
        this.toValue = GetValue$1f(config, 'to', currentValue);
        this.setEase(GetValue$1f(config, 'ease', this.ease));
        this.setDuration(GetValue$1f(config, 'duration', this.duration));
        this.setRepeat(GetValue$1f(config, 'repeat', 0));
        this.setDelay(GetValue$1f(config, 'delay', 0));
        this.setRepeatDelay(GetValue$1f(config, 'repeatDelay', 0));
  ...
  */
  ...
  var TouchEventStop = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TouchEventStop, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setHitAreaMode(GetValue$1c(o, 'hitAreaMode', 0));
        this.setEnable(GetValue$1c(o, 'enable', true));
        this.setStopMode(GetValue$1c(o, 'stopAllLevels', true));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Cover = /*#__PURE__*/function (_FullWindowRectangle) {
    ...
    function Cover(scene, config) {
      ...
      var fillColor = GetValue$1b(config, 'color', 0x0);
      var fillAlpha = GetValue$1b(config, 'alpha', 0.8);
  ...
  var Modal$2 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      config.destroy = GetValue$1a(config, 'destroy', true);
      _this = _callSuper(this, Modal, [gameObject, config]);
      // this.parent = gameObject;
      // this.scene

      // Cover : key of modal, to block touch input        
      var coverConfig = GetValue$1a(config, 'cover');
      _this.cover = coverConfig !== false ? CreateCover(gameObject, coverConfig) : undefined;
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$1a(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$1a(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }

      // Close conditions:
      var touchOutsideClose = GetValue$1a(config, 'touchOutsideClose', false);
      var timeOutDuration = GetValue$1a(config, 'duration.hold', -1);
      var timeOutClose = GetValue$1a(config, 'timeOutClose', timeOutDuration >= 0);
      var anyTouchClose = GetValue$1a(config, 'anyTouchClose', false);
      var manualClose = GetValue$1a(config, 'manualClose', false);
      if (manualClose) {
      ...
      if (GetValue$1a(config, 'openOnStart', true)) {
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Button(gameObject, config) {
      ...
      gameObject.setInteractive(GetValue$19(config, "inputConfig", undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
    _createClass(Button, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setClickInterval(GetValue$19(o, "clickInterval", 100));
        this.setDragThreshold(GetValue$19(o, 'threshold', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var ClickOutside = /*#__PURE__*/function (_ComponentBase) {
    ...
    function ClickOutside(gameObject, config) {
      ...
      _this._enable = undefined;
      var inputConfig = GetValue$18(config, "inputConfig", undefined);
      if (inputConfig) {
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$17(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
    _createClass(InTouching, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setCooldown(GetValue$17(o, 'cooldown', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var DownChild = function DownChild(config) {
    var downConfig = GetValue$16(config, 'down', undefined);
    if (downConfig === false) {
      return;
  ...
  var UpChild = function UpChild(config) {
    var upConfig = GetValue$15(config, 'up', undefined);
    if (upConfig === false) {
      return;
  ...
  var OverChild = function OverChild(config) {
    var overConfig = GetValue$14(config, 'over', undefined);
    if (overConfig === false) {
      return;
    ...
    _createClass(OnePointerTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        if (this.gameObject === undefined) {
          this.setDetectBounds(GetValue$12(o, 'bounds', undefined));
        } else {
          this.setDetectBounds();
        }
  ...
  var Tap = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Tap, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setHoldTime(GetValue$11(o, 'time', 250)); // min-hold-time of Press is 251
        this.setTapInterval(GetValue$11(o, 'tapInterval', 200));
        this.setDragThreshold(GetValue$11(o, 'threshold', 9));
        this.setTapOffset(GetValue$11(o, 'tapOffset', 10));
        var taps = GetValue$11(o, 'taps', undefined);
        if (taps !== undefined) {
          this.setTaps(taps);
        } else {
          this.setMaxTaps(GetValue$11(o, 'maxTaps', undefined));
          this.setMinTaps(GetValue$11(o, 'minTaps', undefined));
        }
        return this;
      }
    }, {
  ...
  var Press = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Press, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setHoldTime(GetValue$10(o, 'time', 251));
        return this;
      }
    }, {
      key: "onDragStart",
  ...
  var TwoPointersTracer = /*#__PURE__*/function () {
    function TwoPointersTracer(gameObject, config) {
      ...
      // Event emitter
      this.setEventEmitter(GetValue$_(config, 'eventEmitter', undefined));
    ...
    _createClass(TwoPointersTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.bounds = GetValue$_(o, 'bounds', undefined);
  ...
  Object.assign(methods$b, PaddingMethods, AddChildMethods$7, RemoveChildMethods$7, GetParentSizerMethods, ScaleMethods, FadeMethods, method, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods$1, GetShownChildrenMethods);
  ...
  var Add$6 = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    } else if (IsPlainObject$f(proportion)) {
  ...
  Object.assign(methods$a, AddChildMethods$6, RemoveChildMethods$6, AlignMethods, ProportionMethods, ExpandMethods, SortChildrenMethods);
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      if (IsPlainObject$e(x)) {
        ...
        minHeight = GetValue$S(config, 'height', undefined);
        orientation = GetValue$S(config, 'orientation', 0);
      } else if (IsPlainObject$e(orientation)) {
        config = orientation;
        orientation = GetValue$S(config, 'orientation', 0);
      }
  ...
  var Add$5 = function Add(gameObject, childKey, align, padding, expand, minWidth, minHeight, offsetX, offsetY, aspectRatio) {
    AddChild$2.call(this, gameObject);
    if (IsPlainObject$d(childKey)) {
      var config = childKey;
      childKey = GetValue$R(config, 'key', undefined);
      align = GetValue$R(config, 'align', ALIGN_CENTER$2);
      padding = GetValue$R(config, 'padding', 0);
      expand = GetValue$R(config, 'expand', true);
      if (!gameObject.isRexSizer) {
        // Get minWidth,minHeight from config
        minWidth = GetValue$R(config, 'minWidth', gameObject._minWidth);
        minHeight = GetValue$R(config, 'minHeight', gameObject._minHeighted);
      }
      offsetX = GetValue$R(config, 'offsetX', 0);
      offsetY = GetValue$R(config, 'offsetY', 0);
      aspectRatio = GetValue$R(config, 'aspectRatio', 0);
    }
  ...
  Object.assign(methods$7, AddChildMethods$3, RemoveChildMethods$3, SortChildrenMethods);
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    ...
    if (IsPlainObject$9(columnIndex)) {
      ...
      columnIndex = GetValue$K(config, 'column', undefined);
      rowIndex = GetValue$K(config, 'row', undefined);
    ...
    config.align = align;
    config.padding = GetBoundsConfig(paddingConfig);
    if (IsPlainObject$9(expand)) {
      config.expandWidth = GetValue$K(expand, 'width', false);
      config.expandHeight = GetValue$K(expand, 'height', false);
    } else {
      config.expandWidth = expand;
      config.expandHeight = expand;
    }
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    // space
    this.setColumnSpace(GetValue$J(space, 'column', 0));
    this.setRowSpace(GetValue$J(space, 'row', 0));
    var scene = this.scene;
  ...
  Object.assign(methods$6, AddChildMethods$1, RemoveChildMethods$1, SetSpaceMethods, SortChildrenMethods);
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject$8(x)) {
        ...
        columnCount = GetValue$I(config, 'column', config.col || 0);
        rowCount = GetValue$I(config, 'row', 0);
        columnProportions = GetValue$I(config, 'columnProportions', 0);
        rowProportions = GetValue$I(config, 'rowProportions', 0);
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$I(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$I(config, 'space.indentLeftOdd', 0), GetValue$I(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$I(config, 'space.indentTopOdd', 0), GetValue$I(config, 'space.indentTopEven', 0));
      _this.resetGrid(columnCount, rowCount, columnProportions, rowProportions, GetValue$I(config, 'space', undefined));
      return _this;
    }
  ...
  var GridButtons = /*#__PURE__*/function (_GridSizer) {
    ...
    function GridButtons(scene, config) {
      ...
      var rowCount = GetValue$H(config, 'row', 0);
      var columnCount = GetValue$H(config, 'column', config.col || 0);
  ...
  var Dialog = /*#__PURE__*/function (_Sizer) {
    ...
    function Dialog(scene, config) {
      ...
      _this.eventEmitter = GetValue$G(config, 'eventEmitter', _assertThisInitialized(_this));

      // Add elements
      var background = GetValue$G(config, 'background', undefined);
      var title = GetValue$G(config, 'title', undefined);
      var toolbar = GetValue$G(config, 'toolbar', undefined);
      var toolbarBackground = GetValue$G(config, 'toolbarBackground', undefined);
      var leftToolbar = GetValue$G(config, 'leftToolbar', undefined);
      var leftToolbarBackground = GetValue$G(config, 'leftToolbarBackground', undefined);
      var content = GetValue$G(config, 'content', undefined);
      var description = GetValue$G(config, 'description', undefined);
      var choicesSizer;
      var choices = GetValue$G(config, 'choices', undefined);
      var choicesBackground = GetValue$G(config, 'choicesBackground', undefined);
      var actionsSizer;
      var actions = GetValue$G(config, 'actions', undefined);
      var actionsBackground = GetValue$G(config, 'actionsBackground', undefined);
      ...
      if (toolbar) {
        toolbarSizer = new Buttons$1(scene, {
          ...
          // Left-right
          space: {
            item: GetValue$G(config, 'space.toolbarItem', 0)
          },
          click: clickConfig,
      ...
      if (leftToolbar) {
        leftToolbarSizer = new Buttons$1(scene, {
          ...
          // Left-right
          space: {
            item: GetValue$G(config, 'space.leftToolbarItem', 0)
          },
          click: clickConfig,
          eventEmitter: _this.eventEmitter
        });
      ...
      if (title || toolbar || leftToolbar) {
        var titleExpandWidth = !!title && GetValue$G(config, 'expand.title', true);
        var titleAlign = GetValue$G(config, 'align.title', 'center');
        var useOverlapSizer =
        ...
        if (title) {
          ...
          var padding = {
            left: GetValue$G(config, 'space.titleLeft', 0),
            right: GetValue$G(config, 'space.titleRight', 0)
          };
        ...
        if (content || description || choices || actions) {
          padding = {
            bottom: GetValue$G(config, 'space.title', 0),
            top: GetValue$G(config, 'space.titleTop', 0)
          };
        }
        var proportion = GetValue$G(config, 'proportion.title', 0);
      ...
      if (content) {
        var align = GetValue$G(config, 'align.content', 'center');
        var contentSpace = GetValue$G(config, 'space.content', 0);
        var padding = {
          left: GetValue$G(config, 'space.contentLeft', 0),
          right: GetValue$G(config, 'space.contentRight', 0),
          bottom: description || choices || actions ? contentSpace : 0
        };
        var proportion = GetValue$G(config, 'proportion.content', 0);
        var expand = GetValue$G(config, 'expand.content', true);
        _this.add(content, {
          align: align,
          padding: padding,
          proportion: proportion,
      ...
      if (description) {
        var align = GetValue$G(config, 'align.description', 'center');
        var descriptionSpace = GetValue$G(config, 'space.description', 0);
        var padding = {
          left: GetValue$G(config, 'space.descriptionLeft', 0),
          right: GetValue$G(config, 'space.descriptionRight', 0),
          bottom: choices || actions ? descriptionSpace : 0
        };
        var proportion = GetValue$G(config, 'proportion.description', 0);
        var expand = GetValue$G(config, 'expand.description', true);
      ...
      if (choices) {
        var choicesType = GetValue$G(config, 'choicesType', '').split('-');
        ...
        var space = {
          left: GetValue$G(config, 'space.choicesBackgroundLeft', 0),
          right: GetValue$G(config, 'space.choicesBackgroundRight', 0),
          top: GetValue$G(config, 'space.choicesBackgroundTop', 0),
          bottom: GetValue$G(config, 'space.choicesBackgroundBottom', 0)
        };
        var itemSpace = GetValue$G(config, 'space.choice', 0);
        if (ButtonsClass === Buttons$1) {
          space.item = itemSpace;
        } else if (ButtonsClass === Buttons) {
          space.item = itemSpace;
          space.line = GetValue$G(config, 'space.choiceLine', itemSpace);
        } else {
          // GridButtons
          space.column = GetValue$G(config, 'space.choiceColumn', itemSpace);
          space.row = GetValue$G(config, 'space.choiceRow', itemSpace);
        }
        var choicesConfig = {
          width: GetValue$G(config, 'choicesWidth', undefined),
          height: GetValue$G(config, 'choicesHeight', undefined),
          groupName: 'choices',
          ...
          click: clickConfig,
          eventEmitter: _this.eventEmitter,
          setValueCallback: GetValue$G(config, 'choicesSetValueCallback', undefined),
          setValueCallbackScope: GetValue$G(config, 'choicesSetValueCallbackScope', undefined)
        };
        if (ButtonsClass === Buttons$1) {
        ...
        var choicesSpace = GetValue$G(config, 'space.choices', 0);
        var padding = {
          left: GetValue$G(config, 'space.choicesLeft', 0),
          right: GetValue$G(config, 'space.choicesRight', 0),
          bottom: actions ? choicesSpace : 0
        };
        var align = GetValue$G(config, 'align.choices', 'center');
        var proportion = GetValue$G(config, 'proportion.choices', 0);
        var expand = GetValue$G(config, 'expand.choices', true);
      ...
      if (actions) {
        actionsSizer = new Buttons$1(scene, {
          ...
          // Left-right
          space: {
            item: GetValue$G(config, 'space.action', 0)
          },
          expand: GetValue$G(config, 'expand.actions', false),
          align: GetValue$G(config, 'align.actions', 'center'),
          click: clickConfig,
          eventEmitter: _this.eventEmitter
        });
        scene.add.existing(actionsSizer);
        var padding = {
          left: GetValue$G(config, 'space.actionsLeft', 0),
          right: GetValue$G(config, 'space.actionsRight', 0),
          bottom: GetValue$G(config, 'space.actionsBottom', 0)
        };
        var proportion = GetValue$G(config, 'proportion.action', 0);
  ...
  var RunVerticalWrap$1 = function RunVerticalWrap(config) {
    // Parse parameters
    var startIndex = GetValue$z(config, 'start', 0);
    SetPadding$1(this.wrapPadding, GetValue$z(config, 'padding', 0));
    var paddingVertical = this.padding.top + this.padding.bottom + this.wrapPadding.top + this.wrapPadding.bottom;
    var paddingHorizontal = this.padding.left + this.padding.right + this.wrapPadding.left + this.wrapPadding.right;
    var lineWidth = GetValue$z(config, 'lineWidth', undefined);
    var maxLines;
    if (lineWidth === undefined) {
      // Calculate lineWidth via maxLines, in fixedWidth mode
      maxLines = GetValue$z(config, 'maxLines', 0);
      if (this.fixedWidth > 0) {
      ...
      if (this.fixedWidth > 0) {
        ...
        maxLines = GetValue$z(config, 'maxLines', undefined);
        if (maxLines === undefined) {
          var innerWidth = this.fixedWidth - paddingHorizontal;
          maxLines = Math.floor(innerWidth / lineWidth) + 1;
        }
      } else {
        maxLines = GetValue$z(config, 'maxLines', 0); // Default is show all lines
      }
    }
    var showAllLines = maxLines === 0;

    // Get fixedCharacterHeight
    var fixedCharacterHeight = GetValue$z(config, 'fixedCharacterHeight', undefined);
    if (fixedCharacterHeight === undefined) {
      var charPerLine = GetValue$z(config, 'charPerLine', undefined);
    ...
    // Get wrapHeight
    var wrapHeight = GetValue$z(config, 'wrapHeight', undefined);
    ...
    var letterSpacing = GetValue$z(config, 'letterSpacing', 0);
    var rtl = GetValue$z(config, 'rtl', true);
    var hAlign = GetValue$z(config, 'hAlign', rtl ? 2 : 0);
    var vAlign = GetValue$z(config, 'vAlign', 0);
    var result = CreateWrapResultData({
      // Override properties
  ...
  var RunWrap = function RunWrap(config) {
    var wrapCallback = GetValue$y(this.wrapConfig, 'callback');
    if (!wrapCallback) {
      wrapCallback = GetValue$y(config, 'callback', this.runWordWrap);
    }
  ...
  var DynamicText = /*#__PURE__*/function (_Canvas) {
    ...
    function DynamicText(scene, x, y, fixedWidth, fixedHeight, config) {
      ...
      if (IsPlainObject$7(x)) {
        ...
        fixedWidth = GetValue$x(config, 'width', 0);
        fixedHeight = GetValue$x(config, 'height', 0);
      ...
      var textStyleConfig = GetValue$x(config, 'style', undefined);
      _this.defaultTextStyle = new TextStyle$1(null, textStyleConfig);
      _this.textStyle = _this.defaultTextStyle.clone();
      _this.setTestString(GetValue$x(config, 'testString', '|MÉqgy'));
      _this._textOX = 0;
      _this._textOY = 0;
      _this.background = new Background(_assertThisInitialized(_this), GetValue$x(config, 'background', undefined));
      _this.innerBounds = new InnerBounds(_assertThisInitialized(_this), GetValue$x(config, 'innerBounds', undefined));
      _this.children = [];
      ...
      _this.setPadding(GetValue$x(config, 'padding', 0));
      _this.setWrapConfig(GetValue$x(config, 'wrap', undefined));
      _this.setChildrenInteractiveEnable(GetValue$x(config, 'childrenInteractive', false));
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      if (text) {
        var wrapText = GetValue$w(config, 'wrapText', false);
        if (wrapText) {
          if (wrapText === true) {
            wrapText = 'word';
          }
  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$u(config, 'style', _assertThisInitialized(_this));
      ...
      _this.onModifyStyle = GetValue$u(config, 'onModifyStyle');
      return _this;
    }
  ...
  var AddChild = function AddChild(topPatent, childParent, config) {
    var childConfig = GetValue$g(config, 'child');
    var child = GetValue$g(childConfig, 'gameObject', undefined);
    if (child) {
      var childSpace = GetValue$g(config, 'space.child', 0);
      ...
      if (typeof childSpace === 'number') {
        ...
        switch (topPatent.scrollMode) {
          case 0:
            childMargin.top = GetValue$g(childSpace, 'top', 0);
            childMargin.bottom = GetValue$g(childSpace, 'bottom', 0);
            childPadding.left = GetValue$g(childSpace, 'left', 0);
            childPadding.right = GetValue$g(childSpace, 'right', 0);
            break;
          case 1:
            childMargin.top = GetValue$g(childSpace, 'left', 0);
            childMargin.bottom = GetValue$g(childSpace, 'right', 0);
            childPadding.top = GetValue$g(childSpace, 'top', 0);
            childPadding.bottom = GetValue$g(childSpace, 'bottom', 0);
            break;
          default:
            // 2
            childMargin.top = GetValue$g(childSpace, 'top', 0);
            childMargin.bottom = GetValue$g(childSpace, 'bottom', 0);
            childMargin.left = GetValue$g(childSpace, 'left', 0);
            childMargin.right = GetValue$g(childSpace, 'right', 0);
            break;
        }
      }
      childParent.add(child, {
        column: 1,
        row: 1,
        align: GetValue$g(childConfig, 'align', 'center'),
        padding: childPadding,
        expand: {
          width: GetValue$g(childConfig, 'expandWidth', true),
          // Private
          height: GetValue$g(childConfig, 'expandHeight', true) // Private
        }
      });
    }
    ...
    var ProgressBase = /*#__PURE__*/function (_BaseClass) {
      ...
      _createClass(ProgressBase, [{
        ...
        value: function bootProgressBase(config) {
          ...
          this.setEaseValuePropName('value').setEaseValueDuration(GetValue$f(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$f(config, 'easeValue.ease', 'Linear'));
          return this;
        }
      }, {
        key: "value",
  ...
  var Slider = /*#__PURE__*/function (_ProgressBase) {
    ...
    function Slider(scene, config) {
      ...
      _this.reverseAxis = GetValue$e(config, 'reverseAxis', false);

      // Add elements
      var background = GetValue$e(config, 'background', undefined);
      var track = GetValue$e(config, 'track', undefined);
      var indicator = GetValue$e(config, 'indicator', undefined);
      var thumb = GetValue$e(config, 'thumb', undefined);
      if (background) {
      ...
      if (thumb) {
        ...
        var thumbOffsetX = GetValue$e(config, 'thumbOffsetX', 0);
        var thumbOffsetY = GetValue$e(config, 'thumbOffsetY', 0);
        _this.setThumbOffset(thumbOffsetX, thumbOffsetY);
      }

      // Input
      var inputMode = GetValue$e(config, 'input', 0);
      ...
      _this.setGap(GetValue$e(config, 'gap', undefined));
      _this.setValue(GetValue$e(config, 'value', 0), GetValue$e(config, 'min', undefined), GetValue$e(config, 'max', undefined));
      return _this;
    }
    _createClass(Slider, [{
      key: "setEnable",
  ...
  var DragSpeed = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(DragSpeed, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.holdThreshold = GetValue$c(o, 'holdThreshold', 50); // ms
        this.pointerOutReleaseEnable = GetValue$c(o, 'pointerOutRelease', true);
        return this;
      }
    }, {
      key: "boot",
  ...
  var Movement = /*#__PURE__*/function () {
    ...
    _createClass(Movement, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setValue(GetValue$b(o, 'value', 0));
        this.setSpeed(GetValue$b(o, 'speed', 0));
        this.setAcceleration(GetValue$b(o, 'acceleration', 0));
        return this;
      }
    }, {
      key: "reset",
  ...
  var Scroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Scroller(gameObject, config) {
      ...
      var enable = GetValue$a(config, 'enable', true);
      ...
      callback = GetValue$a(config, 'overmaxCallback', null);
      if (callback !== null) {
        var scope = GetValue$a(config, 'overmaxCallbackScope', undefined);
        _this.on('overmax', callback, scope);
      }
      callback = GetValue$a(config, 'overminCallback', null);
      if (callback !== null) {
        var scope = GetValue$a(config, 'overminCallbackScope', undefined);
    ...
    _createClass(Scroller, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setOrientationMode(GetValue$a(o, 'orientation', 0));
        this.setDragThreshold(GetValue$a(o, 'threshold', 10));
        this.setSlidingDeceleration(GetValue$a(o, 'slidingDeceleration', 5000));
        this.setBackDeceleration(GetValue$a(o, 'backDeceleration', 2000));
        var dragRate = GetValue$a(o, 'dragRate', 1);
        dragRate = dragRate * (GetValue$a(o, 'dragReverse', false) ? -1 : 1);
        this.setDragRate(dragRate);
        var bounds = GetValue$a(o, 'bounds', undefined);
        if (bounds) {
          this.setBounds(bounds);
        } else {
          this.setBounds(GetValue$a(o, 'max', 0), GetValue$a(o, 'min', 0));
        }
        this.setValue(GetValue$a(o, 'value', this.maxValue || 0));
  ...
  var MouseWheelScroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    function MouseWheelScroller(gameObject, config) {
      ...
      if (_this.parent !== _this.scene) {
        _this.focusMode = GetValue$9(config, 'focus', true);
      } else {
        _this.focusMode = false;
      }
      _this.setSpeed(GetValue$9(config, 'speed', 0.1));
      _this.setEnable(GetValue$9(config, 'enable', true));
      if (!_this.focusMode) {
        // Register on scene
        _this.scene.input.on('wheel', _this.onSceneScroll, _assertThisInitialized(_this));
      } else {
        var gameObject = _this.parent;
        gameObject.setInteractive(GetValue$9(config, "inputConfig", undefined)).on('wheel', function (pointer, dx, dy, dz, event) {
          if (!this.enable) {
            return;
          }
          this.scroll(dy);
  ...
  var AddSlider = function AddSlider(topPatent, sliderParent, axis, config) {
    ...
    if (isScrollXYMode) {
      sliderConfig = GetValue$8(config, sliderConfigKey, undefined);
    } else {
    ...
    if (sliderConfig) {
      ...
      3. space.child
      */
      var sliderPadding = GetValue$8(config, "space.slider".concat(axis), undefined);
      var childPadding; // Legacy
      if (sliderPadding === undefined) {
        sliderPadding = GetValue$8(config, 'space.slider', undefined);
        if (sliderPadding === undefined) {
          if (isScrollXYMode) {
            sliderPadding = 0;
          } else {
            childPadding = GetValue$8(config, 'space.child', 0);
          }
        }
      }
      ...
      if (isAxisY) {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              left: GetValue$8(childPadding, 'right', childPadding)
            };
          }
        } else {
          // left
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              right: GetValue$8(childPadding, 'left', childPadding)
            };
          }
        }
      } else {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              top: GetValue$8(childPadding, 'bottom', childPadding)
            };
          }
        } else {
          // top
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              bottom: GetValue$8(childPadding, 'top', childPadding)
            };
          }
        }
      }
      ...
      topPatent["hideUnscrollableSlider".concat(axis)] = GetValue$8(sliderConfig, 'hideUnscrollableSlider', false);
      topPatent["adaptThumb".concat(axis, "SizeMode")] = GetValue$8(sliderConfig, 'adaptThumbSize', false);
      topPatent["minThumb".concat(axis, "Size")] = GetValue$8(sliderConfig, 'minThumbSize', undefined);
    } else {
    ...
    if (isScrollXYMode) {
      scrollerConfig = GetValue$8(config, scrollerConfigKey, true);
    } else {
      if (config.hasOwnProperty(scrollerConfigKey)) {
        scrollerConfig = GetValue$8(config, scrollerConfigKey, true);
      } else {
        scrollerConfig = GetValue$8(config, 'scroller', true);
      }
    }
    ...
    var mouseWheelScrollerConfig = GetValue$8(config, isScrollXYMode ? "mouseWheelScroller".concat(axis) : 'mouseWheelScroller', false),
      mouseWheelScroller;
  ...
  var CreateScrollableSizer = function CreateScrollableSizer(parent, config) {
    ...
    var parentMinWidth = GetValue$7(config, 'width');
    var parentMinHeight = GetValue$7(config, 'height');
    if (!parentMinWidth) {
      var expandChildWidth = GetValue$7(config, 'child.expandWidth', true);
      if (!expandChildWidth) {
        columnProportions[1] = 0; // Calculate parent's width by child's width
      }
    }
    if (!parentMinHeight) {
      var expandChildHeight = GetValue$7(config, 'child.expandHeight', true);
  ...
  var Scrollable = /*#__PURE__*/function (_Sizer) {
    ...
    function Scrollable(scene, config) {
      ...
      _this.type = GetValue$6(config, 'type', 'rexScrollable');
      ...
      var header = GetValue$6(config, 'header', undefined);
      if (header) {
        var align = GetValue$6(config, 'align.header', 'center');
        var headerSpace = GetValue$6(config, 'space.header', 0);
        var padding;
        if (!isRevererXY) {
          padding = {
            bottom: headerSpace
        ...
        _this.add(header, {
          ...
          align: align,
          padding: padding,
          expand: GetValue$6(config, 'expand.header', true)
        });
      }
      ...
      var footer = GetValue$6(config, 'footer', undefined);
      if (footer) {
        var align = GetValue$6(config, 'align.footer', 'center');
        var footerSpace = GetValue$6(config, 'space.footer', 0);
        var padding;
        if (!isRevererXY) {
          padding = {
            top: footerSpace
        ...
        _this.add(footer, {
          ...
          align: align,
          padding: padding,
          expand: GetValue$6(config, 'expand.footer', true)
        });
      }
      _this.addChildrenMap('background', background);
  ...
  var TextBlock = /*#__PURE__*/function (_BaseSizer) {
    ...
    function TextBlock(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.text = GetValue$5(config, 'content', '');
      _this._textOY = 0;
      _this.execeedTopState = false;
      _this.execeedBottomState = false;
      _this.setClampMode(GetValue$5(config, 'clamplTextOY', true));
      _this.alwaysScrollable = GetValue$5(config, 'alwaysScrollable', false);

      // Add elements
      var background = GetValue$5(config, 'background', undefined);
      var textObject = GetValue$5(config, 'text', undefined);
      if (textObject === undefined) {
        textObject = CreateDefaultTextObject(scene);
      }
      _this.textCropEnable = GetValue$5(config, 'textCrop', !!textObject.setCrop);
      var textMaskEnable = GetValue$5(config, 'textMask', !_this.textCropEnable);
      if (background) {
        _this.addBackground(background);
      }
  ...
  var TextArea = /*#__PURE__*/function (_Scrollable) {
    ...
    function TextArea(scene, config) {
      ...
      var textWidth = GetValue$4(config, 'textWidth', undefined);
      var textHeight = GetValue$4(config, 'textHeight', undefined);
      var textCrop = GetValue$4(config, 'textCrop', !!textObject.setCrop);
      var textMask = GetValue$4(config, 'textMask', !textCrop);
      var content = GetValue$4(config, 'content', '');
      ...
      if (spaceConfig) {
        spaceConfig.child = GetValue$4(spaceConfig, 'text', 0);
      }
  ...
  var CreateTextArea = function CreateTextArea(scene, config, creators) {
    ...
    var createBackground = GetValue$3(creators, 'background', CreateBackground);
    var createText = GetValue$3(creators, 'text', CreateText);
    var createTrack = GetValue$3(creators, 'track', CreateBackground);
    var createThumb = GetValue$3(creators, 'thumb', CreateBackground);
    if (createBackground) {
