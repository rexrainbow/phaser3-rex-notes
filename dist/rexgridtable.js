(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncCameraFilter = GetValue$18(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$18(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  Object.assign(methods$b, Parent, AddChild$2, RemoveChild$1, ChildState, Transform, Position, Rotation, Scale$1, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$10(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$10(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$10(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$10(o, 'onUpdateViewportCallbackScope');
  ...
  */
  ...
  Object.assign(methods$5, PaddingMethods, AddChildMethods$2, RemoveChildMethods$2, GetParentSizerMethods, methods$a, methods$9, methods$8, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  var Base = /*#__PURE__*/function (_Container) {
    ...
    function Base(scene, x, y, minWidth, minHeight, config) {
      ...
      var origin = GetValue$w(config, 'origin', 0.5);
      var originX = GetValue$w(config, 'originX', origin);
      var originY = GetValue$w(config, 'originY', origin);
  ...
  Object.assign(methods$4, AddChildMethods$1, RemoveChildMethods$1, AlignMethods, ProportionMethods, ExpandMethods, SortChildrenMethods);
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$r(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$r(config, 'space.indentLeftOdd', 0), GetValue$r(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$r(config, 'space.indentTopOdd', 0), GetValue$r(config, 'space.indentTopEven', 0));
  ...
  var AddChild = function AddChild(topPatent, childParent, config) {
    ...
    if (child) {
      ...
      childParent.add(child, {
        ...
        expand: {
          width: GetValue$q(childConfig, 'expandWidth', true),
          // Private
  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$n(config, 'style', _assertThisInitialized(_this));
      ...
      _this.onModifyStyle = GetValue$n(config, 'onModifyStyle');
      return _this;
    }
  ...
  var NinePatchBase = function NinePatchBase(GOClass, type) {
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        _this.setGetFrameNameCallback(GetValue$j(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$j(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$j(config, 'preserveRatio', true));
