(function (global, factory) {
  ...
  */
  ...
  Object.assign(methods$b, Parent, AddChild$2, RemoveChild$1, ChildState, Transform, Position, Rotation, Scale$2, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  */
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$s(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$s(config, 'space.indentLeftOdd', 0), GetValue$s(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$s(config, 'space.indentTopOdd', 0), GetValue$s(config, 'space.indentTopEven', 0));
      _this.resetGrid(columnCount, rowCount, columnProportions, rowProportions, GetValue$s(config, 'space', undefined));
      return _this;
    }
  ...
  var AddChild = function AddChild(topPatent, childParent, config) {
    ...
    if (child) {
      ...
      childParent.add(child, {
        ...
        expand: {
          width: GetValue$r(childConfig, 'expandWidth', true),
          // Private
  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.onModifyStyle = GetValue$o(config, 'onModifyStyle');
      return _this;
    }
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      _this.setTrackColor(GetValue$m(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$m(config, 'trackStrokeThickness', 2), GetValue$m(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$m(config, 'skewX', 0));
  ...
  Object.assign(LineProgress.prototype, Methods$3);
