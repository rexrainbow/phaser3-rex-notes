  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$9(config, 'style', _assertThisInitialized(_this));
      ...
      _this.onModifyStyle = GetValue$9(config, 'onModifyStyle');
      return _this;
    }
    ...
    var ProgressBase = /*#__PURE__*/function (_BaseClass) {
      ...
      _createClass(ProgressBase, [{
        ...
        value: function bootProgressBase(config) {
          ...
          this.setEaseValuePropName('value').setEaseValueDuration(GetValue$8(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$8(config, 'easeValue.ease', 'Linear'));
          return this;
        }
      }, {
        key: "value",
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      _this.setTrackColor(GetValue$7(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$7(config, 'trackStrokeThickness', 2), GetValue$7(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$7(config, 'skewX', 0));
