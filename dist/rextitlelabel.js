  ...
  */
  ...
  var TitleLabel = /*#__PURE__*/function (_Sizer) {
    ...
    function TitleLabel(scene, config) {
      ...
      var actionMask = GetValue(config, 'actionMask', undefined); // Space
      ...
      if (text || title || separator) {
        ...
        if (textOrientation === 1) {
          ...
          if (text) {
            var textAlign = GetValue(config, 'align.text', 'right'); // Special case : title aligns to left, text aligns to right, wo separator
