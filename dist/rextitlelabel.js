  ...
  var LayoutMode0 = function LayoutMode0(config) {
    ...
    if (icon) {
      ...
      if (!fitRatio) {
        ...
        this.setIconSize(GetValue$b(config, 'iconWidth', iconSize), GetValue$b(config, 'iconHeight', iconSize));
      }
    }
    ...
    if (action) {
      ...
      if (!fitRatio) {
        ...
        this.setActionSize(GetValue$b(config, 'actionWidth', actionSize), GetValue$b(config, 'actionHeight', actionSize));
      }
    }
  ...
  var LayoutMode1 = function LayoutMode1(config) {
    ...
    if (icon) {
      ...
      if (!fitRatio) {
        ...
        this.setIconSize(GetValue$a(config, 'iconWidth', iconSize), GetValue$a(config, 'iconHeight', iconSize));
      }
    }
    if (text) {
    ...
    if (action) {
      ...
      if (!fitRatio) {
        ...
        this.setActionSize(GetValue$a(config, 'actionWidth', actionSize), GetValue$a(config, 'actionHeight', actionSize));
      }
    }
    this.addChildrenMap('title', title);
    this.addChildrenMap('separator', separator);
