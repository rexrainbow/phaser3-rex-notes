    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$P(config, 'fillAlpha');
            padding = GetValue$P(config, 'padding');
            includeParent = GetValue$P(config, 'includeParent');
        }
    ...
    var GetValue$z = function (source, key, defaultValue, altSource) {
