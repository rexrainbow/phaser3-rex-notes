  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$5(radiusConfig, 'radius', radiusConfig);
      ...
      var iteration = GetValue$5(radiusConfig, 'iteration', undefined);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$4(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$4(config, 'propertiesMap');
      ...
      _this.onModifyStyleCallback = GetValue$4(config, 'onModifyStyle');
      return _this;
    }
