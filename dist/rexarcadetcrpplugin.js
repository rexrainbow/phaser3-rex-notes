(function (global, factory) {
  ...
  var ArcadeStepClock = /*#__PURE__*/function (_BaseClock) {
    ...
    _createClass(ArcadeStepClock, [{
      key: "startTicking",
      value: function startTicking() {
        _get(_getPrototypeOf(ArcadeStepClock.prototype), "startTicking", this).call(this);

        this.scene.physics.world.on('worldstep', this.update, this); //  'worldstep' event is emitted *after* the bodies and colliders have been updated.
      }
    }, {
      key: "stopTicking",
      value: function stopTicking() {
        _get(_getPrototypeOf(ArcadeStepClock.prototype), "stopTicking", this).call(this);
  ...
  var Player$1 = /*#__PURE__*/function (_BasePlayer) {
    ...
    _createClass(Player, [{
      ...
      value: function load(commands, scope, config) {
        // No config argument
        _get(_getPrototypeOf(Player.prototype), "load", this).call(this, commands, scope);
  ...
  var StepRunner$1 = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(StepRunner, [{
      ...
      value: function shutdown(fromScene) {
        ...
        _get(_getPrototypeOf(StepRunner.prototype), "shutdown", this).call(this, fromScene);
      }
    }, {
      key: "add",
      value: function add(commands, scope) {
        this.commands.push([commands, scope]);
        return this;
      }
    }, {
      key: "update",
  ...
  var ArcadeTCRPPlugin = /*#__PURE__*/function (_Phaser$Plugins$BaseP) {
    ...
    _createClass(ArcadeTCRPPlugin, [{
      ...
      key: "addStepRunner",
      value: function addStepRunner(parent) {
  ...
  Object.assign(ArcadeTCRPPlugin.prototype, methods);
