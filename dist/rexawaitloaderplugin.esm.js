import { Loader, Utils, Plugins } from 'phaser';

const FILE_POPULATED = Loader.FILE_POPULATED;
const UUID = Utils.String.UUID;

class AwaitFile extends Loader.File {
...
class AwaitLoaderPlugin extends Plugins.BasePlugin {
...
export { AwaitLoaderPlugin as default };
