import { Display, VERSION, GameObjects, Utils, Renderer, Class, Math as Math$1, Events, Scene, Game, Tweens, Plugins } from 'phaser';
...
class CustomProgressPlugin extends Plugins.BasePlugin {
...
export { CustomProgressPlugin as default };
