...
class CrossStitchingFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class CrossStitchingController extends Filters.Controller {
    static FilterName = FilterName;
...
export { CrossStitchingFilterPlugin as default };
