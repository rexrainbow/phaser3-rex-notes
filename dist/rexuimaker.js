  ...
  */
    ...
    _createClass(TextStyle, [{
      ...
      value: function setStyle(style, updateText, setDefaults) {
        ...
        for (var key in propertyMap) {
          ...
          if (key === 'wrapCallback' || key === 'wrapCallbackScope') {
            ...
            this[key] = GetValue$1n(style, objKey, defaultValue);
          } else {
        ...
        var font = GetValue$1n(style, 'font', null);
        ...
        var fill = GetValue$1n(style, 'fill', null);

        if (fill !== null) {
          this.color = GetStyle(fill);
        }

        var metrics = GetValue$1n(style, 'metrics', false); //  Provide optional TextMetrics in the style object to avoid the canvas look-up / scanning
        //  Doing this is reset if you then change the font of this TextStyle after creation

        if (metrics) {
          this.metrics = {
            ascent: GetValue$1n(metrics, 'ascent', 0),
            descent: GetValue$1n(metrics, 'descent', 0),
            fontSize: GetValue$1n(metrics, 'fontSize', 0)
          };
      ...
      value: function setFont(font) {
        if (typeof font === 'string') {
          ...
          this.fontFamily = GetValue$1n(font, 'fontFamily', 'Courier');
          this.fontSize = GetValue$1n(font, 'fontSize', '16px');
          this.fontStyle = GetValue$1n(font, 'fontStyle', '');
        }
      ...
      value: function setTextMetrics(metrics, font) {
        ...
        if (font) {
          if (typeof font === 'string') {
            ...
            this.fontFamily = GetValue$1n(font, 'fontFamily', this.fontFamily);
            this.fontSize = GetValue$1n(font, 'fontSize', this.fontSize);
            this.fontStyle = GetValue$1n(font, 'fontStyle', this.fontStyle);
          }
        }
    ...
    _createClass(RoundRectangle, [{
      ...
      set: function set(value) {
        ...
        if (typeof value === 'number') {
          ...
          defaultRadiusX = GetValue$1m(value, 'x', 0);
          defaultRadiusY = GetValue$1m(value, 'y', 0);
        }

        var radius = this.cornerRadius;
        radius.tl = GetRadius(GetValue$1m(value, 'tl', undefined), defaultRadiusX, defaultRadiusY);
        radius.tr = GetRadius(GetValue$1m(value, 'tr', undefined), defaultRadiusX, defaultRadiusY);
        radius.bl = GetRadius(GetValue$1m(value, 'bl', undefined), defaultRadiusX, defaultRadiusY);
        radius.br = GetRadius(GetValue$1m(value, 'br', undefined), defaultRadiusX, defaultRadiusY);
      }
    }, {
      key: "radiusTL",
      get: function get() {
  ...
  var SetRadius = function SetRadius(radius, value) {
    if (typeof value === 'number') {
      ...
      radius.x = GetValue$1m(value, 'x', 0);
      radius.y = GetValue$1m(value, 'y', 0);
    }
  };
  ...
  var Pen = /*#__PURE__*/function () {
    ...
    _createClass(Pen, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.text = GetValue$1l(o, 'text', '');
        this.x = GetValue$1l(o, 'x', 0);
        this.y = GetValue$1l(o, 'y', 0);
        this.width = GetValue$1l(o, 'width', 0);
        var prop = GetValue$1l(o, 'prop', null);
        ...
        this.prop = prop;
        this.newLineMode = GetValue$1l(o, 'newLineMode', 0);
        this.startIndex = GetValue$1l(o, 'startIndex', 0);
      }
    }, {
      key: "plainText",
      get: function get() {
  ...
  var CanvasText = /*#__PURE__*/function () {
    function CanvasText(config) {
      ...
      this.context = GetValue$1k(config, 'context', null);
      this.canvas = this.context.canvas;
      this.parser = GetValue$1k(config, 'parser', null);
      this.defaultStyle = GetValue$1k(config, 'style', null);
      this.autoRound = true;
      this.pensPool = config.pensPool; // Required
  ...
  var AddImage$1 = function AddImage(key, config) {
    ...
    this.images[key] = {
      ...
      left: GetValue$1j(config, 'left', 0),
      right: GetValue$1j(config, 'right', 0)
    };
  };
  ...
  var Text = /*#__PURE__*/function (_TextBase) {
    ...
    function Text(scene, x, y, text, style, type, parser) {
      ...
      if (IsPlainObject$m(x)) {
        ...
        text = GetValue$1i(config, 'text', '');
        style = GetValue$1i(config, 'style', '');
      }
      ...
      var imageData = GetValue$1i(style, 'images', undefined);
    ...
    _createClass(Text, [{
      ...
      value: function setPadding(left, top, right, bottom) {
        if (_typeof(left) === 'object') {
          ...
          var x = GetValue$1i(config, 'x', null);

          if (x !== null) {
            left = x;
            right = x;
          } else {
            left = GetValue$1i(config, 'left', 0);
            right = GetValue$1i(config, 'right', left);
          }

          var y = GetValue$1i(config, 'y', null);

          if (y !== null) {
            top = y;
            bottom = y;
          } else {
            top = GetValue$1i(config, 'top', 0);
            bottom = GetValue$1i(config, 'bottom', top);
          }
        } else {
          if (left === undefined) {
            left = 0;
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      var radius = GetValue$1h(radiusConfig, 'radius', radiusConfig);
      geom.setTo(0, 0, width, height, radius);
      var iteration = GetValue$1h(radiusConfig, 'iteration', undefined);
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$k(mode)) {
      this.stretchMode.edge = parseMode(GetValue$1g(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$1g(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$j(x)) {
          ...
          width = GetValue$1f(config, 'width', 1);
          height = GetValue$1f(config, 'height', 1);
          key = GetValue$1f(config, 'key', undefined);
          baseFrame = GetValue$1f(config, 'baseFrame', undefined);
          columns = GetValue$1f(config, 'columns', undefined);
          rows = GetValue$1f(config, 'rows', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$1f(config, 'getFrameNameCallback', undefined));

        _this.setStretchMode(GetValue$1f(config, 'stretchMode', 0));

        _this.setPreserveRatio(GetValue$1f(config, 'preserveRatio', true));

        var maxFixedPartScale = GetValue$1f(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$1f(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$1f(config, 'maxFixedPartScaleY', undefined);
  ...
  var PoolManager = /*#__PURE__*/function () {
    function PoolManager(config) {
      ...
      this.pools = GetValue$1e(config, 'pools', Pools);
    }
  ...
  var Blitter = /*#__PURE__*/function (_GameObject) {
    ...
    function Blitter(scene, x, y, texture, frame, config) {
      ...
      if (IsPlainObject$i(x)) {
        ...
        texture = GetValue$1d(config, 'texture');
        frame = GetValue$1d(config, 'frame');
      }
      ...
      var reuseBob = GetValue$1d(config, 'reuseBob', true);
   ...
   */
  var GetValue$1c = function GetValue(source, key, defaultValue) {
  ...
  var DataMethods = {
    ...
    getData: function getData(key, defaultValue) {
      this.enableData();
      return key === undefined ? this.data : GetValue$1c(this.data, key, defaultValue);
    },
  ...
  var RenderBase = /*#__PURE__*/function (_Base) {
    ...
    _createClass(RenderBase, [{
      ...
      value: function modifyPorperties(o) {
        ...
        var width = GetValue$1b(o, 'width', undefined);
        var height = GetValue$1b(o, 'height', undefined);
        var scale = GetValue$1b(o, 'scale', undefined);
        var scaleX = GetValue$1b(o, 'scaleX', scale);
        var scaleY = GetValue$1b(o, 'scaleY', scale);
        ...
        var origin = GetValue$1b(o, 'origin', undefined);
  ...
  var CircleMaskImage = /*#__PURE__*/function (_Canvas) {
    ...
    _createClass(CircleMaskImage, [{
      ...
      value: function setTexture(key, frame, config) {
        ...
        var maskType = GetValue$1a(config, 'maskType', 0);
        var backgroundColor = GetValue$1a(config, 'backgroundColor', undefined);
        ...
        switch (maskType) {
          case 2:
            var radiusConfig = GetValue$1a(config, 'radius', 0);
            var iteration = GetValue$1a(config, 'iteration', undefined);
  ...
  */
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      drawContainer = GetValue$17(config, 'drawContainer');
    }
  ...
  Object.assign(methods$a, Parent, AddChild$1, RemoveChild$1, ChildState, Transform, Position, Rotation, Scale$1, Visible, Alpha, Active, ScrollFactor, Mask, Depth, Children, Tween, AddToContainer, Layer, RenderTexture);
  ...
  var FSM = /*#__PURE__*/function () {
    ...
    */
    function FSM(config) {
      ...
      var states = GetValue$1c(config, 'states', undefined);
      ...
      var extend = GetValue$1c(config, 'extend', undefined);
      ...
      var eventEmitter = GetValue$1c(config, 'eventEmitter', undefined);
      var EventEmitterClass = GetValue$1c(config, 'EventEmitterClass', undefined);
    ...
    _createClass(FSM, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.start(GetValue$1c(o, 'start', undefined));
        var init = GetValue$1c(o, 'init', undefined);
  ...
  var Dialog = /*#__PURE__*/function (_Sizer) {
    ...
    function Dialog(scene, config) {
      ...
      if (title || toolbar || leftToolbar) {
        var titleExpandWidth = !!title && GetValue$o(config, 'expand.title', true);
        var titleAlign = GetValue$o(config, 'align.title', 'center');
  ...
  var PositionToPercent = function PositionToPercent(startPoint, endPoint, currentPoint) {
    ...
    if (startPoint.y === endPoint.y) {
      value = Percent$4(currentPoint.x, startPoint.x, endPoint.x);
    } else if (startPoint.x === endPoint.x) {
      value = Percent$4(currentPoint.y, startPoint.y, endPoint.y);
    }
  ...
  var Slider$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Slider(scene, config) {
      ...
      _this.eventEmitter = GetValue$k(config, 'eventEmitter', _assertThisInitialized(_this));
