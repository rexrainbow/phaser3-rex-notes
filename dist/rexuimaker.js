  ...
  */
    ...
    _createClass(TextStyle, [{
      ...
      value: function setStyle(style, updateText, setDefaults) {
        ...
        for (var key in propertyMap) {
          ...
          if (key === 'wrapCallback' || key === 'wrapCallbackScope') {
            ...
            this[key] = GetValue$1o(style, objKey, defaultValue);
          } else {
        ...
        var font = GetValue$1o(style, 'font', null);
        ...
        var fill = GetValue$1o(style, 'fill', null);

        if (fill !== null) {
          this.color = GetStyle(fill);
        }

        var metrics = GetValue$1o(style, 'metrics', false); //  Provide optional TextMetrics in the style object to avoid the canvas look-up / scanning
        //  Doing this is reset if you then change the font of this TextStyle after creation

        if (metrics) {
          this.metrics = {
            ascent: GetValue$1o(metrics, 'ascent', 0),
            descent: GetValue$1o(metrics, 'descent', 0),
            fontSize: GetValue$1o(metrics, 'fontSize', 0)
          };
      ...
      value: function setFont(font) {
        if (typeof font === 'string') {
          ...
          this.fontFamily = GetValue$1o(font, 'fontFamily', 'Courier');
          this.fontSize = GetValue$1o(font, 'fontSize', '16px');
          this.fontStyle = GetValue$1o(font, 'fontStyle', '');
        }
      ...
      value: function setTextMetrics(metrics, font) {
        ...
        if (font) {
          if (typeof font === 'string') {
            ...
            this.fontFamily = GetValue$1o(font, 'fontFamily', this.fontFamily);
            this.fontSize = GetValue$1o(font, 'fontSize', this.fontSize);
            this.fontStyle = GetValue$1o(font, 'fontStyle', this.fontStyle);
          }
        }
    ...
    _createClass(RoundRectangle, [{
      ...
      set: function set(value) {
        ...
        if (typeof value === 'number') {
          ...
          defaultRadiusX = GetValue$1n(value, 'x', 0);
          defaultRadiusY = GetValue$1n(value, 'y', 0);
        }

        var radius = this.cornerRadius;
        radius.tl = GetRadius(GetValue$1n(value, 'tl', undefined), defaultRadiusX, defaultRadiusY);
        radius.tr = GetRadius(GetValue$1n(value, 'tr', undefined), defaultRadiusX, defaultRadiusY);
        radius.bl = GetRadius(GetValue$1n(value, 'bl', undefined), defaultRadiusX, defaultRadiusY);
        radius.br = GetRadius(GetValue$1n(value, 'br', undefined), defaultRadiusX, defaultRadiusY);
      }
    }, {
      key: "radiusTL",
      get: function get() {
  ...
  var SetRadius = function SetRadius(radius, value) {
    if (typeof value === 'number') {
      ...
      radius.x = GetValue$1n(value, 'x', 0);
      radius.y = GetValue$1n(value, 'y', 0);
    }
  };
  ...
  var Pen = /*#__PURE__*/function () {
    ...
    _createClass(Pen, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.text = GetValue$1m(o, 'text', '');
        this.x = GetValue$1m(o, 'x', 0);
        this.y = GetValue$1m(o, 'y', 0);
        this.width = GetValue$1m(o, 'width', 0);
        var prop = GetValue$1m(o, 'prop', null);
        ...
        this.prop = prop;
        this.newLineMode = GetValue$1m(o, 'newLineMode', 0);
        this.startIndex = GetValue$1m(o, 'startIndex', 0);
      }
    }, {
      key: "plainText",
      get: function get() {
  ...
  var CanvasText = /*#__PURE__*/function () {
    function CanvasText(config) {
      ...
      this.context = GetValue$1l(config, 'context', null);
      this.canvas = this.context.canvas;
      this.parser = GetValue$1l(config, 'parser', null);
      this.defaultStyle = GetValue$1l(config, 'style', null);
      this.autoRound = true;
      this.pensPool = config.pensPool; // Required
  ...
  var AddImage$1 = function AddImage(key, config) {
    ...
    this.images[key] = {
      ...
      right: GetValue$1k(config, 'right', 0)
    };
  };
  ...
  var Text = /*#__PURE__*/function (_TextBase) {
    ...
    function Text(scene, x, y, text, style, type, parser) {
      ...
      if (IsPlainObject$m(x)) {
        ...
        text = GetValue$1j(config, 'text', '');
        style = GetValue$1j(config, 'style', '');
      }
      ...
      var imageData = GetValue$1j(style, 'images', undefined);
    ...
    _createClass(Text, [{
      ...
      value: function setPadding(left, top, right, bottom) {
        if (_typeof(left) === 'object') {
          ...
          var x = GetValue$1j(config, 'x', null);
          ...
          if (x !== null) {
            ...
            right = GetValue$1j(config, 'right', left);
          }

          var y = GetValue$1j(config, 'y', null);

          if (y !== null) {
            top = y;
            bottom = y;
          } else {
            top = GetValue$1j(config, 'top', 0);
            bottom = GetValue$1j(config, 'bottom', top);
          }
        } else {
          if (left === undefined) {
            left = 0;
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      var radius = GetValue$1i(radiusConfig, 'radius', radiusConfig);
      geom.setTo(0, 0, width, height, radius);
      var iteration = GetValue$1i(radiusConfig, 'iteration', undefined);
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$k(mode)) {
      this.stretchMode.edge = parseMode(GetValue$1h(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$1h(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$j(x)) {
          ...
          width = GetValue$1g(config, 'width', 1);
          height = GetValue$1g(config, 'height', 1);
          key = GetValue$1g(config, 'key', undefined);
          baseFrame = GetValue$1g(config, 'baseFrame', undefined);
          columns = GetValue$1g(config, 'columns', undefined);
          rows = GetValue$1g(config, 'rows', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$1g(config, 'getFrameNameCallback', undefined));

        _this.setStretchMode(GetValue$1g(config, 'stretchMode', 0));

        _this.setPreserveRatio(GetValue$1g(config, 'preserveRatio', true));

        var maxFixedPartScale = GetValue$1g(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$1g(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$1g(config, 'maxFixedPartScaleY', undefined);
  ...
  var PoolManager = /*#__PURE__*/function () {
    function PoolManager(config) {
      ...
      this.pools = GetValue$1f(config, 'pools', Pools);
    }
  ...
  var Blitter = /*#__PURE__*/function (_GameObject) {
    ...
    function Blitter(scene, x, y, texture, frame, config) {
      ...
      if (IsPlainObject$i(x)) {
        ...
        texture = GetValue$1e(config, 'texture');
        frame = GetValue$1e(config, 'frame');
      }
      ...
      var reuseBob = GetValue$1e(config, 'reuseBob', true);
   ...
   */
  var GetValue$1d = function GetValue(source, key, defaultValue) {
  ...
  var RenderBase = /*#__PURE__*/function (_Base) {
    ...
    _createClass(RenderBase, [{
      ...
      value: function modifyPorperties(o) {
        ...
        var width = GetValue$1c(o, 'width', undefined);
        var height = GetValue$1c(o, 'height', undefined);
        var scale = GetValue$1c(o, 'scale', undefined);
        var scaleX = GetValue$1c(o, 'scaleX', scale);
        var scaleY = GetValue$1c(o, 'scaleY', scale);
        ...
        var origin = GetValue$1c(o, 'origin', undefined);
  ...
  var CircleMaskImage = /*#__PURE__*/function (_Canvas) {
    ...
    _createClass(CircleMaskImage, [{
      ...
      value: function setTexture(key, frame, config) {
        ...
        var maskType = GetValue$1b(config, 'maskType', 0);
        var backgroundColor = GetValue$1b(config, 'backgroundColor', undefined);
        ...
        switch (maskType) {
          case 2:
            var radiusConfig = GetValue$1b(config, 'radius', 0);
            var iteration = GetValue$1b(config, 'iteration', undefined);
