import { Input, Utils, Math as Math$1, Events, Geom, Plugins } from 'phaser';
...
const GetDist = Math$1.Distance.Between;
const GetAngle = Math$1.Angle.Between;
...
const CircleClass = Geom.Circle;
const CircleContains = Geom.Circle.Contains;
...
class VirtualJoyStickPlugin extends Plugins.BasePlugin {
...
export { VirtualJoyStickPlugin as default };
