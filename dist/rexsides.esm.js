...
var GetValue$G = Utils.Objects.GetValue;
...
var DrawBounds$2 = function (gameObjects, graphics, config) {
    ...
    if (typeof (config) === 'number') {
        ...
        fillAlpha = GetValue$F(config, 'fillAlpha');
        padding = GetValue$F(config, 'padding');
        includeParent = GetValue$F(config, 'includeParent');
    }
...
const RemoveItem$2 = Utils.Array.Remove;
...
const GetValue$u = Utils.Objects.GetValue;
...
let Fade$1 = class Fade extends EaseValueTaskBase {
    constructor(gameObject, config) {
        super(gameObject, config);
        // this.parent = gameObject;
        // this.timer
...
var RemoveItem = Utils.Array.Remove;
...
var GetValue$p = function (source, key, defaultValue, altSource) {
...
var Add = function (gameObject, childKey, align, padding, expand, minWidth, minHeight, offsetX, offsetY, aspectRatio) {
    ...
    if (IsPlainObject$1(expand)) {
        config.expandWidth = NormalizeExpand(GetValue$2(expand, 'width', false));
        config.expandHeight = NormalizeExpand(GetValue$2(expand, 'height', false));
    } else {
