(function (global, factory) {
  ...
  */
  ...
  Object.assign(methods$9, Parent, AddChild$3, RemoveChild$2, ChildState, Transform, Position, Rotation, Scale$2, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  */
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$y(config, 'createCellContainerCallback'));
  ...
  var AddChild$1 = function AddChild(topPatent, childParent, config) {
    ...
    if (child) {
      ...
      childParent.add(child, {
        ...
        expand: {
          width: GetValue$x(childConfig, 'expandWidth', true),
          // Private
  ...
  */
    ...
    var ProgressBase = /*#__PURE__*/function (_BaseClass) {
      ...
      _createClass(ProgressBase, [{
        ...
        value: function bootProgressBase(config) {
          ...
          this.setEaseValuePropName('value').setEaseValueDuration(GetValue$t(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$t(config, 'easeValue.ease', 'Linear'));
          return this;
        }
      }, {
        key: "value",
  ...
  var RotateAround$2 = function RotateAround(centerX, centerY, angle, pathData) {
    var point = {
      x: 0,
      y: 0
    };
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      _this.setTrackColor(GetValue$s(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$s(config, 'trackStrokeThickness', 2), GetValue$s(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$s(config, 'skewX', 0));
