(function (global, factory) {
  ...
  var SoundManager = /*#__PURE__*/function () {
    function SoundManager(game, config) {
      ...
      this.setBackgroundMusicLoopValue(GetValue$7(config, 'bgm.loop', true));
      ...
      this.setBackgroundMusic2LoopValue(GetValue$7(config, 'bgm2.loop', true));
  ...
  var WaitEventManager = /*#__PURE__*/function () {
    function WaitEventManager(parent, config) {
      ...
      this.parent = parent;
      this.waitCompleteEventName = GetValue$4(config, 'completeEventName', WaitCompleteEvent);
