import { Utils, Math as Math$1, Plugins } from 'phaser';
...
class PerlinGrivatyWell {
    constructor(config) {
        ...
        this.velocity = new Math$1.Vector2();
    }
...
class PerlinGrivatyWellPlugin extends Plugins.BasePlugin {
...
export { PerlinGrivatyWellPlugin as default };
