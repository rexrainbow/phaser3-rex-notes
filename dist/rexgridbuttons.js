  ...
  */
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    ...
    if (IsPlainObject$1(columnIndex)) {
      ...
      columnIndex = GetValue$5(config, 'column', undefined);
      rowIndex = GetValue$5(config, 'row', undefined);
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    var columnSpace = GetValue$4(space, 'column', 0);
    ...
    var rowSpace = GetValue$4(space, 'row', 0);
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject(x)) {
        ...
        columnCount = GetValue$3(config, 'column', 0);
        rowCount = GetValue$3(config, 'row', 0);
        columnProportions = GetValue$3(config, 'columnProportions', 0);
        rowProportions = GetValue$3(config, 'rowProportions', 0);
      ...
      _this.resetGrid(columnCount, rowCount, columnProportions, rowProportions, GetValue$3(config, 'space', undefined));

      _this.addChildrenMap('items', _this.sizerChildren);

      var createCellContainerCallback = GetValue$3(config, 'createCellContainerCallback');
