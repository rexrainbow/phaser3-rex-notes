(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncCameraFilter = GetValue$1u(config, 'syncCameraFilter', true);
      state.syncDisplayList = GetValue$1u(config, 'syncDisplayList', true);
    }
  };
  ...
  */
  ...
  Object.assign(methods$h, Parent, AddChild$3, RemoveChild$2, ChildState, Transform, Position, Rotation, Scale$2, Visible, Alpha, Active, ScrollFactor, CameraFilter, Mask, Depth, Children, Tween, P3Container, RenderLayer, RenderTexture$1);
  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$1m(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$1m(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$1m(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$1m(o, 'onUpdateViewportCallbackScope');
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$1l(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$1k(config, 'tickEventName', defaultEventName);
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.state = GetValue$1j(o, 'state', IDLE$6);
        this.timeScale = GetValue$1j(o, 'timeScale', 1);
        this.delay = GetValue$1j(o, 'delay', 0);
        this.repeat = GetValue$1j(o, 'repeat', 0);
        this.repeatCounter = GetValue$1j(o, 'repeatCounter', 0);
        this.repeatDelay = GetValue$1j(o, 'repeatDelay', 0);
        this.duration = GetValue$1j(o, 'duration', 0);
        this.nowTime = GetValue$1j(o, 'nowTime', 0);
        this.justRestart = GetValue$1j(o, 'justRestart', false);
      }
    }, {
      key: "toJSON",
  ...
  var EaseValueTaskBase = /*#__PURE__*/function (_TimerTask) {
    ...
    _createClass(EaseValueTaskBase, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1i(o, 'timer'));
        this.setEnable(GetValue$1i(o, 'enable', true));
        this.setTarget(GetValue$1i(o, 'target', this.parent));
        this.setDelay(GetAdvancedValue$4(o, 'delay', 0));
        this.setDuration(GetAdvancedValue$4(o, 'duration', 1000));
        this.setEase(GetValue$1i(o, 'ease', 'Linear'));
        this.setRepeat(GetValue$1i(o, 'repeat', 0));
        return this;
      }
    }, {
      key: "setEnable",
  ...
  var methods$g = {};
  Object.assign(methods$g, ScaleMethods);
  methods$g.onInitScale = function () {
  ...
  var methods$f = {};
  Object.assign(methods$f, FadeMethods);
  methods$f.onInitFade = function () {
  ...
  var methods$e = {};
  Object.assign(methods$e, EaseMoveMethods);
  methods$e.onInitEaseMove = function () {
  ...
  var ShakePosition = /*#__PURE__*/function (_TickTask) {
    ...
    _createClass(ShakePosition, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1e(o, 'timer'));
        this.setEnable(GetValue$1e(o, 'enable', true));
        this.setMode(GetValue$1e(o, 'mode', 1));
        this.isRunning = GetValue$1e(o, 'isRunning', false);
        this.setMagnitudeMode(GetValue$1e(o, 'magnitudeMode', 1));
        this.setAxisMode(GetValue$1e(o, "axis", 0));
        this.setDuration(GetValue$1e(o, 'duration', 500));
        this.setMagnitude(GetValue$1e(o, 'magnitude', 10));
        this.ox = GetValue$1e(o, 'ox', undefined);
        this.oy = GetValue$1e(o, 'oy', undefined);
        return this;
      }
    }, {
      key: "toJSON",
      ...
      value: function start(duration, magnitude) {
        if (typeof duration !== 'number') {
          var config = duration;
          magnitude = GetValue$1e(config, 'magnitude', undefined);
          duration = GetValue$1e(config, 'duration', undefined);
        }
  ...
  var EaseValueTask = /*#__PURE__*/function (_EaseValueTaskBase) {
    ...
    _createClass(EaseValueTask, [{
      ...
      value: function start(config) {
        ...
        var target = this.target;
        this.propertyKey = GetValue$1d(config, 'key', 'value');
        var currentValue = target[this.propertyKey];
        this.fromValue = GetValue$1d(config, 'from', currentValue);
        this.toValue = GetValue$1d(config, 'to', currentValue);
        this.setEase(GetValue$1d(config, 'ease', this.ease));
        this.setDuration(GetValue$1d(config, 'duration', this.duration));
        this.setRepeat(GetValue$1d(config, 'repeat', 0));
        this.setDelay(GetValue$1d(config, 'delay', 0));
        this.setRepeatDelay(GetValue$1d(config, 'repeatDelay', 0));
    ...
    _createClass(FSM, [{
      ...
      */
      ...
      value: function resetFromJSON(o) {
        ...
        this._scene = GetValue$1c(o, 'scene', undefined);
        return this;
      }
    }, {
      key: "stateProperties",
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.oneShotMode = GetValue$1b(config, 'destroy', false);
      _this.delayCallTimer = undefined;
      _this._state = new State$1(_assertThisInitialized(_this), {
        eventEmitter: false,
        initState: GetValue$1b(config, 'initState', 'IDLE')
      });
  ...
  var TouchEventStop = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TouchEventStop, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setHitAreaMode(GetValue$1a(o, 'hitAreaMode', 0));
        this.setEnable(GetValue$1a(o, 'enable', true));
        this.setStopMode(GetValue$1a(o, 'stopAllLevels', true));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Cover = /*#__PURE__*/function (_FullWindowRectangle) {
    ...
    function Cover(scene, config) {
      ...
      var fillColor = GetValue$19(config, 'color', 0x0);
      var fillAlpha = GetValue$19(config, 'alpha', 0.8);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      config.destroy = GetValue$18(config, 'destroy', true);
      _this = _callSuper(this, Modal, [gameObject, config]);
      // this.parent = gameObject;
      // this.scene

      // Cover : key of modal, to block touch input        
      var coverConfig = GetValue$18(config, 'cover');
      _this.cover = coverConfig !== false ? CreateCover(gameObject, coverConfig) : undefined;
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$18(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$18(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }

      // Close conditions:
      var touchOutsideClose = GetValue$18(config, 'touchOutsideClose', false);
      var timeOutDuration = GetValue$18(config, 'duration.hold', -1);
      var timeOutClose = GetValue$18(config, 'timeOutClose', timeOutDuration >= 0);
      var anyTouchClose = GetValue$18(config, 'anyTouchClose', false);
      var manualClose = GetValue$18(config, 'manualClose', false);
      if (manualClose) {
      ...
      if (GetValue$18(config, 'openOnStart', true)) {
  ...
  var Button = /*#__PURE__*/function (_ComponentBase) {
    ...
    function Button(gameObject, config) {
      ...
      gameObject.setInteractive(GetValue$17(config, "inputConfig", undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
  ...
  var ClickOutside = /*#__PURE__*/function (_ComponentBase) {
    ...
    function ClickOutside(gameObject, config) {
      ...
      _this._enable = undefined;
      var inputConfig = GetValue$16(config, "inputConfig", undefined);
      if (inputConfig) {
  ...
  var InTouching = /*#__PURE__*/function (_ComponentBase) {
    ...
    function InTouching(gameObject, config) {
      ...
      _this.parent.setInteractive(GetValue$15(config, 'inputConfig', undefined));
      _this.resetFromJSON(config);
      _this.boot();
      return _this;
    }
    _createClass(InTouching, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setCooldown(GetValue$15(o, 'cooldown', undefined));
        return this;
      }
    }, {
      key: "boot",
  ...
  var DownChild = function DownChild(config) {
    var downConfig = GetValue$14(config, 'down', undefined);
    if (downConfig === false) {
      return;
  ...
  var UpChild = function UpChild(config) {
    var upConfig = GetValue$13(config, 'up', undefined);
    if (upConfig === false) {
      return;
  ...
  var OverChild = function OverChild(config) {
    var overConfig = GetValue$12(config, 'over', undefined);
    if (overConfig === false) {
      return;
    ...
    _createClass(OnePointerTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        if (this.gameObject === undefined) {
          this.setDetectBounds(GetValue$10(o, 'bounds', undefined));
        } else {
          this.setDetectBounds();
        }
  ...
  var Press = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Press, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setHoldTime(GetValue$_(o, 'time', 251));
        return this;
      }
    }, {
      key: "onDragStart",
  ...
  Object.assign(methods$b, PaddingMethods, AddChildMethods$5, RemoveChildMethods$5, GetParentSizerMethods, methods$g, methods$f, methods$e, ShakeMethods, EaseDataMethods, DelayCallMethods$1, ClickMethods, ClickOutsideMethods, TouchingMethods, HoverMethods, HideMethods, ModalMethods, GetShownChildrenMethods);
  ...
  var Add$5 = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    if (proportion === null) {
      ...
      align = GetValue$R(config, 'align', ALIGN_CENTER$2);
  ...
  Object.assign(methods$a, AddChildMethods$4, RemoveChildMethods$4, AlignMethods, ProportionMethods, ExpandMethods, SortChildrenMethods);
  ...
  Object.assign(LabelBase.prototype, methods$9);
  ...
  Object.assign(Methods$6, MoveChildMethods, BackgroundMethods, InnerBoundsMethods, SetAlignMethods, SetTextOXYMethods);
  ...
  var DynamicText = /*#__PURE__*/function (_Canvas) {
    ...
    function DynamicText(scene, x, y, fixedWidth, fixedHeight, config) {
      ...
      } else if (IsPlainObject$c(fixedWidth)) {
        config = fixedWidth;
        fixedWidth = GetValue$H(config, 'width', 0);
        fixedHeight = GetValue$H(config, 'height', 0);
      }
    ...
    function Label(scene, config) {
      ...
      if (icon) {
        ...
        if (!fitRatio) {
          ...
          _this.setIconSize(GetValue$G(config, 'iconWidth', iconSize), GetValue$G(config, 'iconHeight', iconSize));
        }
      }
      if (text) {
      ...
      if (action) {
        ...
        if (!fitRatio) {
          ...
          _this.setActionSize(GetValue$G(config, 'actionWidth', actionSize), GetValue$G(config, 'actionHeight', actionSize));
        }
      }
  ...
  var ButtonsTypeMethods = {
    setButtonsType: function setButtonsType(config) {
      ...
      var buttonsType = GetValue$F(config, 'buttonsType', config.type);
      ...
      setValueCallback = GetValue$F(config, 'setValueCallback', undefined);
      setValueCallbackScope = GetValue$F(config, 'setValueCallbackScope', undefined);
      if (setValueCallback === undefined) {
        setValueCallback = GetValue$F(config, 'setButtonStateCallback', undefined);
        setValueCallbackScope = GetValue$F(config, 'setButtonStateCallbackScope', undefined);
      }
  ...
  Object.assign(ButtonGroup.prototype, AddMethods, RemoveMethods, ButtonsTypeMethods, ButtonMethods, methods$7);
  ...
  var Buttons$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Buttons(scene, config) {
      ...
      // Buttons properties
      _this.buttonsExpand = GetValue$E(config, 'expand', false);
      _this.buttonsAlign = GetValue$E(config, 'align', undefined); // undefined/left/top: no space                
  ...
  Object.assign(Buttons$1.prototype, AddChildMethods$3, RemoveChildMethods$3, ButtonMethods, ButtonStateMethods);
  ...
  Object.assign(methods$6, AddChildMethods$2, RemoveChildMethods$2, SortChildrenMethods);
  ...
  var Buttons = /*#__PURE__*/function (_FixWidthSizer) {
    ...
    function Buttons(scene, config) {
      ...
      _this.buttonGroup = new ButtonGroup({
        parent: _assertThisInitialized(_this),
        eventEmitter: GetValue$B(config, 'eventEmitter', _assertThisInitialized(_this)),
        groupName: GetValue$B(config, 'groupName', undefined),
        clickConfig: GetValue$B(config, 'click', undefined)
      }).setButtonsType(config);

      // Add elements
      var background = GetValue$B(config, 'background', undefined);
      var buttons = GetValue$B(config, 'buttons', undefined);

      // Buttons properties
      _this.buttonsAlign = GetValue$B(config, 'align', undefined);
      if (background) {
        _this.addBackground(background);
      }
      if (buttons) {
  ...
  Object.assign(Buttons.prototype, AddChildMethods$1, RemoveChildMethods$1, ButtonMethods, ButtonStateMethods);
  ...
  var GetValueFromAliasKeys = function GetValueFromAliasKeys(source, key0, key1, key2, defaultValue) {
    if (HasValue(source, key0)) {
      return GetValue$1c(source, key0);
    } else if (key1 && HasValue(source, key1)) {
      return GetValue$1c(source, key1);
    } else if (key2 && HasValue(source, key2)) {
      return GetValue$1c(source, key2);
    } else {
      return defaultValue;
    }
  };
  ...
  var SetPosition = function SetPosition(gameObject, config) {
    var expandDirection = GetValue$A(config, 'expandDirection', undefined);
    ...
    var alignTargetY = GetValue$A(config, 'alignTargetY', alignTargetX);
    var alignOffsetX = GetValue$A(config, 'alignOffsetX', 0);
    var alignOffsetY = GetValue$A(config, 'alignOffsetY', 0);
    var alignSide = GetValue$A(config, 'alignSide', '');
    var alignRight = alignSide.includes('right');
    var positionBounds = GetValue$A(config, 'bounds');
  ...
  Object.assign(Methods$5, methods$8, FocusButtonMethods);
  ...
  var DropDownList = /*#__PURE__*/function (_Label) {
    ...
    function DropDownList(scene, config) {
      ...
      _this.setOptions(GetValue$y(config, 'options'));
      var listConfig = GetValue$y(config, 'list');
      _this.setWrapEnable(GetValue$y(listConfig, 'wrap', false));
      _this.setCreateButtonCallback(GetValue$y(listConfig, 'createButtonCallback'));
      _this.setCreateListBackgroundCallback(GetValue$y(listConfig, 'createBackgroundCallback'));
      _this.setButtonClickCallback(GetValue$y(listConfig, 'onButtonClick'));
      _this.setButtonOverCallback(GetValue$y(listConfig, 'onButtonOver'));
      _this.setButtonOutCallback(GetValue$y(listConfig, 'onButtonOut'));
      _this.setListExpandDirection(GetValue$y(listConfig, 'expandDirection'));
      _this.setListEaseInDuration(GetValue$y(listConfig, 'easeIn', 500));
      _this.setListEaseOutDuration(GetValue$y(listConfig, 'easeOut', 100));
      _this.setListTransitInCallback(GetValue$y(listConfig, 'transitIn'));
      _this.settListTransitOutCallback(GetValue$y(listConfig, 'transitOut'));
      _this.setListSize(GetValue$y(listConfig, 'width'), GetValue$y(listConfig, 'height'));
      _this.setListAlignmentMode(GetValue$y(listConfig, 'alignParent', 'text'));
      _this.setListAlignmentSide(GetValue$y(listConfig, 'alignSide', ''));
      _this.setListBounds(GetValue$y(listConfig, 'bounds'));
      _this.setListSpace(GetValue$y(listConfig, 'space'));
      _this.setListDraggable(GetValue$y(listConfig, 'draggable', false));
      _this.setValueChangeCallback(GetValue$y(config, 'setValueCallback'), GetValue$y(config, 'setValueCallbackScope'));
      _this.setValue(GetValue$y(config, 'value'));
  ...
  Object.assign(DropDownList.prototype, Methods$5);
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_PolygnBase) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$x(radiusConfig, 'radius', radiusConfig);
      ...
      var iteration = GetValue$x(radiusConfig, 'iteration', undefined);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$w(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$w(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$w(config, 'onModifyStyle');
      return _this;
    }
    ...
    var ProgressBase = /*#__PURE__*/function (_BaseClass) {
      ...
      _createClass(ProgressBase, [{
        ...
        value: function bootProgressBase(config) {
          this.eventEmitter = GetValue$v(config, 'eventEmitter', this);
          ...
          this.setEaseValuePropName('value').setEaseValueDuration(GetValue$v(config, 'easeValue.duration', 0)).setEaseValueFunction(GetValue$v(config, 'easeValue.ease', 'Linear'));
          return this;
        }
      }, {
        key: "value",
  ...
  var LineProgress = /*#__PURE__*/function (_ProgressBase) {
    ...
    function LineProgress(scene, x, y, width, height, barColor, value, config) {
      ...
      if (IsPlainObject$8(x)) {
        ...
        width = GetValue$u(config, 'width', 2);
        height = GetValue$u(config, 'height', 2);
        barColor = GetValue$u(config, 'barColor', undefined);
        value = GetValue$u(config, 'value', 0);
      ...
      _this.setTrackColor(GetValue$u(config, 'trackColor', undefined));
      _this.setBarColor(barColor);
      _this.setTrackStroke(GetValue$u(config, 'trackStrokeThickness', 2), GetValue$u(config, 'trackStrokeColor', undefined));
      _this.setSkewX(GetValue$u(config, 'skewX', 0));
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$6(x)) {
          ...
          columns = GetValue$q(config, 'columns', undefined);
          rows = GetValue$q(config, 'rows', undefined);
        } else if (IsPlainObject$6(key)) {
          config = key;
          key = GetValue$q(config, 'key', undefined);
          baseFrame = GetValue$q(config, 'baseFrame', undefined);
          columns = GetValue$q(config, 'columns', undefined);
          rows = GetValue$q(config, 'rows', undefined);
        } else if (IsPlainObject$6(baseFrame)) {
          config = baseFrame;
          baseFrame = GetValue$q(config, 'baseFrame', undefined);
          columns = GetValue$q(config, 'columns', undefined);
          rows = GetValue$q(config, 'rows', undefined);
          ...
          columns = baseFrame;
          baseFrame = GetValue$q(config, 'baseFrame', undefined);
        } else if (IsPlainObject$6(columns)) {
          config = columns;
          columns = GetValue$q(config, 'columns', undefined);
          rows = GetValue$q(config, 'rows', undefined);
        }
        ...
        _this.setGetFrameNameCallback(GetValue$q(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$q(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$q(config, 'preserveRatio', true));
  ...
  var Text = /*#__PURE__*/function (_TextBase) {
    ...
    function Text(scene, x, y, text, style, type, parser) {
      ...
      _this.setText(text);
      _this.setUrlTagCursorStyle(GetValue$j(style, 'urlTagCursorStyle', 'pointer'));
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    // space
    this.setColumnSpace(GetValue$f(space, 'column', 0));
    this.setRowSpace(GetValue$f(space, 'row', 0));
    var scene = this.scene;
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$e(config, 'createCellContainerCallback'));
  ...
  var AddChild = function AddChild(topPatent, childParent, config) {
    var childConfig = GetValue$d(config, 'child');
    var child = GetValue$d(childConfig, 'gameObject', undefined);
    if (child) {
      ...
      if (typeof childSpace === 'number') {
        ...
        switch (topPatent.scrollMode) {
          case 0:
            childMargin.top = GetValue$d(childSpace, 'top', 0);
            childMargin.bottom = GetValue$d(childSpace, 'bottom', 0);
            childPadding.left = GetValue$d(childSpace, 'left', 0);
            childPadding.right = GetValue$d(childSpace, 'right', 0);
            break;
          case 1:
            childMargin.top = GetValue$d(childSpace, 'left', 0);
            childMargin.bottom = GetValue$d(childSpace, 'right', 0);
            childPadding.top = GetValue$d(childSpace, 'top', 0);
            childPadding.bottom = GetValue$d(childSpace, 'bottom', 0);
            break;
          default:
            // 2
            childMargin.top = GetValue$d(childSpace, 'top', 0);
            childMargin.bottom = GetValue$d(childSpace, 'bottom', 0);
            childMargin.left = GetValue$d(childSpace, 'left', 0);
            childMargin.right = GetValue$d(childSpace, 'right', 0);
            break;
        }
      }
      childParent.add(child, {
        column: 1,
        row: 1,
        align: GetValue$d(childConfig, 'align', 'center'),
        padding: childPadding,
        expand: {
          width: GetValue$d(childConfig, 'expandWidth', true),
          // Private
          height: GetValue$d(childConfig, 'expandHeight', true) // Private
        }
      });
    }
  ...
  var Slider = /*#__PURE__*/function (_ProgressBase) {
    ...
    function Slider(scene, config) {
      ...
      if (thumb) {
        ...
        var thumbOffsetX = GetValue$c(config, 'thumbOffsetX', 0);
        var thumbOffsetY = GetValue$c(config, 'thumbOffsetY', 0);
  ...
  var MouseWheelScroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    function MouseWheelScroller(gameObject, config) {
      ...
      if (_this.parent !== _this.scene) {
        _this.focusMode = GetValue$7(config, 'focus', true);
      } else {
  ...
  var AddSlider = function AddSlider(topPatent, sliderParent, axis, config) {
    ...
    if (isScrollXYMode) {
      sliderConfig = GetValue$6(config, sliderConfigKey, undefined);
    } else {
      if (config.hasOwnProperty(sliderConfigKey)) {
        sliderConfig = GetValue$6(config, sliderConfigKey, undefined);
      } else {
        sliderConfig = GetValue$6(config, 'slider', undefined);
      }
    }
    if (sliderConfig) {
      ...
      3. space.child
      */
      var sliderPadding = GetValue$6(config, "space.slider".concat(axis), undefined);
      var childPadding; // Legacy
      if (sliderPadding === undefined) {
        sliderPadding = GetValue$6(config, 'space.slider', undefined);
        if (sliderPadding === undefined) {
          if (isScrollXYMode) {
            sliderPadding = 0;
          } else {
            childPadding = GetValue$6(config, 'space.child', 0);
          }
        }
      }
      ...
      if (isAxisY) {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              left: GetValue$6(childPadding, 'right', childPadding)
            };
          }
        } else {
          // left
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              right: GetValue$6(childPadding, 'left', childPadding)
            };
          }
        }
      } else {
        if (sliderPosition === 0) {
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              top: GetValue$6(childPadding, 'bottom', childPadding)
            };
          }
        } else {
          // top
          ...
          if (childPadding === undefined) {
            ...
            padding = {
              bottom: GetValue$6(childPadding, 'top', childPadding)
            };
          }
        }
      }
      ...
      topPatent["hideUnscrollableSlider".concat(axis)] = GetValue$6(sliderConfig, 'hideUnscrollableSlider', false);
      topPatent["adaptThumb".concat(axis, "SizeMode")] = GetValue$6(sliderConfig, 'adaptThumbSize', false);
      topPatent["minThumb".concat(axis, "Size")] = GetValue$6(sliderConfig, 'minThumbSize', undefined);
    } else {
    ...
    if (isScrollXYMode) {
      scrollerConfig = GetValue$6(config, scrollerConfigKey, true);
    } else {
      if (config.hasOwnProperty(scrollerConfigKey)) {
        scrollerConfig = GetValue$6(config, scrollerConfigKey, true);
      } else {
        scrollerConfig = GetValue$6(config, 'scroller', true);
      }
    }
    ...
    var mouseWheelScrollerConfig = GetValue$6(config, isScrollXYMode ? "mouseWheelScroller".concat(axis) : 'mouseWheelScroller', false),
      mouseWheelScroller;
  ...
  var CreateScrollableSizer = function CreateScrollableSizer(parent, config) {
    ...
    var parentMinWidth = GetValue$5(config, 'width');
    var parentMinHeight = GetValue$5(config, 'height');
    if (!parentMinWidth) {
      var expandChildWidth = GetValue$5(config, 'child.expandWidth', true);
      if (!expandChildWidth) {
        columnProportions[1] = 0; // Calculate parent's width by child's width
      }
    }
    if (!parentMinHeight) {
      var expandChildHeight = GetValue$5(config, 'child.expandHeight', true);
  ...
  var Scrollable = /*#__PURE__*/function (_Sizer) {
    ...
    function Scrollable(scene, config) {
      ...
      _this.type = GetValue$4(config, 'type', 'rexScrollable');
      ...
      var header = GetValue$4(config, 'header', undefined);
      if (header) {
        var align = GetValue$4(config, 'align.header', 'center');
        var headerSpace = GetValue$4(config, 'space.header', 0);
        var padding;
        if (!isRevererXY) {
          padding = {
            bottom: headerSpace
        ...
        _this.add(header, {
          ...
          align: align,
          padding: padding,
          expand: GetValue$4(config, 'expand.header', true)
        });
      }
      ...
      var footer = GetValue$4(config, 'footer', undefined);
      if (footer) {
        var align = GetValue$4(config, 'align.footer', 'center');
        var footerSpace = GetValue$4(config, 'space.footer', 0);
        var padding;
        if (!isRevererXY) {
          padding = {
            top: footerSpace
        ...
        _this.add(footer, {
          ...
          align: align,
          padding: padding,
          expand: GetValue$4(config, 'expand.footer', true)
        });
      }
      _this.addChildrenMap('background', background);
  ...
  var TextBlock = /*#__PURE__*/function (_BaseSizer) {
    ...
    function TextBlock(scene, x, y, minWidth, minHeight, config) {
      ...
      _this.text = GetValue$3(config, 'content', '');
      _this._textOY = 0;
      _this.execeedTopState = false;
      _this.execeedBottomState = false;
      _this.setClampMode(GetValue$3(config, 'clamplTextOY', true));
      _this.alwaysScrollable = GetValue$3(config, 'alwaysScrollable', false);
      ...
      _this.textCropEnable = GetValue$3(config, 'textCrop', !!textObject.setCrop);
      var textMaskEnable = GetValue$3(config, 'textMask', !_this.textCropEnable);
      if (background) {
        _this.addBackground(background);
      }
  ...
  var TextArea = /*#__PURE__*/function (_Scrollable) {
    ...
    function TextArea(scene, config) {
      ...
      var textWidth = GetValue$2(config, 'textWidth', undefined);
      var textHeight = GetValue$2(config, 'textHeight', undefined);
      var textCrop = GetValue$2(config, 'textCrop', !!textObject.setCrop);
      var textMask = GetValue$2(config, 'textMask', !textCrop);
      var content = GetValue$2(config, 'content', '');
      var textBlock = new TextBlock(scene, {
        ...
        content: content,
        clamplTextOY: GetValue$2(config, 'clamplChildOY', false),
        alwaysScrollable: GetValue$2(config, 'alwaysScrollable', false)
      });
      ...
      var spaceConfig = GetValue$2(config, 'space', undefined);
      if (spaceConfig) {
  ...
  var CreateTextArea = function CreateTextArea(scene, config, creators) {
    ...
    var createText = GetValue$1(creators, 'text', CreateText);
    var createTrack = GetValue$1(creators, 'track', CreateBackground);
    var createThumb = GetValue$1(creators, 'thumb', CreateBackground);
    if (createBackground) {
