  ...
  var AlphaMaskImage = /*#__PURE__*/function (_Canvas) {
    ...
    _createClass(AlphaMaskImage, [{
      ...
      value: function setTexture(key, frame, config) {
        ...
        ctx.drawImage(maskTextureFrame.source.image, maskTextureFrame.cutX, maskTextureFrame.cutY, maskTextureFrame.cutWidth, maskTextureFrame.cutHeight, 0, 0, width, height);
        ctx.restore();
