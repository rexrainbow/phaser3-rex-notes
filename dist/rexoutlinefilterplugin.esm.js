...
class OutlineFilter extends Renderer.WebGL.RenderNodes.BaseFilterShader {
...
class OutlineController extends Filters.Controller {
    static FilterName = FilterName;
...
export { OutlineFilterPlugin as default };
