import { Events, Scene, Game, Utils, Math, Plugins } from 'phaser';
...
const DistanceBetween = Math.Distance.Between;
const RotateAroundDistance = Math.RotateAroundDistance;
...
class DragPlugin extends Plugins.BasePlugin {
