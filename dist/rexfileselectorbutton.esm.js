import { VERSION, BlendModes, Structs, Utils, GameObjects, Scenes, Math as Math$1, Class, Geom, Cameras, Display, Events, Scene, Game, Tweens, Filters, Renderer as Renderer$1, CANVAS, TintModes as TintModes$2, DOM } from 'phaser';
...
const RemoveItem$6 = Utils.Array.Remove;
...
var GetValue$T = Utils.Objects.GetValue;
...
var RemoveItem$3 = Utils.Array.Remove;
...
class CircleController extends Filters.Controller {
    ...
    resetFromJSON(o) {
        this.setThickness(GetValue$d(o, 'thickness', 8));
        this.setScale(GetValue$d(o, 'scale', 1));
        this.setFeather(GetValue$d(o, 'feather', 0.005));
        this.setColor(GetValue$d(o, 'color', 0xFF33B2));
        this.setBackgroundColor(GetValue$d(o, 'backgroundColor', 0xFF0000));
        this.setBackgroundAlpha(GetValue$d(o, 'backgroundAlpha', 0.4));
...
const Merge$1 = Utils.Objects.Merge;
...
const Merge = Utils.Objects.Merge;
...
const GetAll = Utils.Array.GetAll;
...
const BringToTop = Utils.Array.BringToTop;
const SendToBack = Utils.Array.SendToBack;
const MoveUp = Utils.Array.MoveUp;
const MoveDown = Utils.Array.MoveDown;
const MoveAbove = Utils.Array.MoveAbove;
const MoveBelow = Utils.Array.MoveBelow;
...
export { FileSelectorButton as default };
