import { Events, Scene, Game, Utils, Math, Tweens, Plugins, GameObjects } from 'phaser';
...
class FadePlugin extends Plugins.BasePlugin {
    ...
    injectMethodsToRootClass() {
        this.injectMethods(GameObjects.GameObject.prototype);
        return this;
    }
}
