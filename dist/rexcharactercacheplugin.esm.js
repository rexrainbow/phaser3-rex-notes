import { Events, Game, Scene, Utils, GameObjects, Plugins } from 'phaser';
...
const BitmapTextClass = CreateBitmapTextClass(GameObjects.BitmapText);
const DynamicBitmapTextClass = CreateBitmapTextClass(GameObjects.DynamicBitmapText);
...
const TextGameObjectClass = GameObjects.Text;
...
class CharacterCachePlugin extends Plugins.BasePlugin {
...
export { CharacterCachePlugin as default };
