  ...
  var Anchor = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Anchor, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var onResizeCallback = GetValue$V(o, 'onResizeCallback', DefaultResizeCallback);
        var onResizeCallbackScope = GetValue$V(o, 'onResizeCallbackScope');
        this.setResizeCallback(onResizeCallback, onResizeCallbackScope);
        var onUpdateViewportCallback = GetValue$V(o, 'onUpdateViewportCallback');
        var onUpdateViewportCallbackScope = GetValue$V(o, 'onUpdateViewportCallbackScope');
      ...
      if (isAxisY) {
        if (sliderPosition === 0) {
          ...
          if (!childPadding) {
            ...
            padding = {
              left: GetValue$4(childPadding, 'right', 0)
            };
          }
        } else {
          // left
          ...
          if (!childPadding) {
            ...
            padding = {
              right: GetValue$4(childPadding, 'left', 0)
            };
          }
        }
      } else {
        if (sliderPosition === 0) {
          ...
          if (!childPadding) {
            ...
            padding = {
              top: GetValue$4(childPadding, 'bottom', 0)
            };
          }
        } else {
          // top
          ...
          if (!childPadding) {
            ...
            padding = {
              bottom: GetValue$4(childPadding, 'top', 0)
            };
          }
        }
      }
