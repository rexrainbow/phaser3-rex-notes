    ...
    if (child) {
      ...
      if (typeof childSpace !== 'number') {
        ...
        if (scrollMode === 0) {
          ...
          this.childMargin.top = GetValue$3(paddingConfig, 'top', 0);
          this.childMargin.bottom = GetValue$3(paddingConfig, 'bottom', 0);
        } else {
          childPadding.top = GetValue$3(paddingConfig, 'top', 0);
          childPadding.bottom = GetValue$3(paddingConfig, 'bottom', 0);
          this.childMargin.top = GetValue$3(paddingConfig, 'left', 0);
          this.childMargin.bottom = GetValue$3(paddingConfig, 'right', 0);
        }
      } else {
        if (sliderConfig) {
          // Has slider
