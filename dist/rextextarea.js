  ...
  */
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      drawContainer = GetValue$J(config, 'drawContainer');
    }
  ...
  Object.assign(methods$5, Parent, AddChild$1, RemoveChild$1, ChildState, Transform, Position, Rotation, Scale$1, Visible, Alpha, Active, ScrollFactor, Mask, Depth, Children, Tween, AddToContainer, Layer, RenderTexture);
  ...
  var DownChild = function DownChild(config) {
    var overConfig = GetValue$r(config, 'down', undefined);
  ...
  var UpChild = function UpChild(config) {
    var overConfig = GetValue$q(config, 'up', undefined);
  ...
  var Slider$1 = /*#__PURE__*/function (_Sizer) {
    ...
    function Slider(scene, config) {
      ...
      _this.eventEmitter = GetValue$9(config, 'eventEmitter', _assertThisInitialized(_this));
      _this.reverseAxis = GetValue$9(config, 'reverseAxis', false); // Add elements
