(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rextextarea = factory(global.Phaser));
    ...
    var SetupSyncFlags = function (state, config) {
        ...
        if (typeof (config) === 'boolean') {
            ...
            state.syncCameraFilter = GetValue$17(config, 'syncCameraFilter', true);
            state.syncDisplayList = GetValue$17(config, 'syncDisplayList', true);
        }
    ...
    */
    ...
    var DrawBounds$2 = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$15(config, 'fillAlpha');
            padding = GetValue$15(config, 'padding');
            includeParent = GetValue$15(config, 'includeParent');
        }
    ...
    class TickTask extends ComponentBase {
        constructor(parent, config) {
            ...
            this.setTickingMode(GetValue$_(config, 'tickingMode', 1));
            // boot() later
        }
    ...
    */
    ...
    var SetChildrenInteractive = function (gameObject, config) {
        ...
        gameObject._childrenInteractive = {
            ...
            targetMode: GetValue$w(config, 'targetMode', 'parent'),
    ...
    let Base$2 = class Base extends ContainerLite {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            var origin = GetValue$v(config, 'origin', 0.5);
            var originX = GetValue$v(config, 'originX', origin);
            var originY = GetValue$v(config, 'originY', origin);
            this.setOrigin(originX, originY);

            this.setMinSize(minWidth, minHeight);
            this.setName(GetValue$v(config, 'name', ''));
            this.rexSizer = {};
            this.space = {};
            ...
            this.setInnerPadding(GetValue$v(config, 'space', 0));
            ...
            this.setSizerEventsEnable(GetValue$v(config, 'sizerEvents', false));
            this.setDirty(true);
    ...
    class Sizer extends Base$2 {
        constructor(scene, x, y, minWidth, minHeight, orientation, config) {
            ...
            this.setItemSpacing(GetValue$t(config, 'space.item', 0));
            this.setStartChildIndex(GetValue$t(config, 'startChildIndex', 0));
    ...
    */
    ...
    class RoundRectangle extends PolygnBase {
        constructor(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
            ...
            this.setIteration(GetValue$n(radiusConfig, 'iteration', undefined));
            this.setPosition(x, y);
    ...
    class StyleManager extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.style = GetValue$m(config, 'style', this);
            ...
            this.onModifyStyle = GetValue$m(config, 'onModifyStyle');
        }
        ...
        class ProgressBase extends BaseClass {
            bootProgressBase(config) {
                ...
                this
                    ...
                    .setEaseValueDuration(GetValue$l(config, 'easeValue.duration', 0))
                    .setEaseValueFunction(GetValue$l(config, 'easeValue.ease', 'Linear'));
    ...
    class LineProgress extends ProgressBase(BaseShapes) {
        constructor(scene, x, y, width, height, barColor, value, config) {
            ...
            this.setTrackColor(GetValue$k(config, 'trackColor', undefined));
            this.setBarColor(barColor);
            this.setTrackStroke(GetValue$k(config, 'trackStrokeThickness', 2), GetValue$k(config, 'trackStrokeColor', undefined));

            this.setSkewX(GetValue$k(config, 'skewX', 0));
...
`;
    ...
    */
    ...
    class BaseTextBlock extends Base$2 {
        constructor(scene, x, y, minWidth, minHeight, config) {
            if (IsPlainObject(x)) {
                config = x;
