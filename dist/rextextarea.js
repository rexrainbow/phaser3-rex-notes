  ...
  */
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$L(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$K(config, 'tickEventName', defaultEventName);
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.setTransitInCallback(GetValue$B(config, 'transitIn'));
      _this.setTransitOutCallback(GetValue$B(config, 'transitOut'));
      _this.oneShotMode = GetValue$B(config, 'destroy', false);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$y(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$y(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }
  ...
  var GetScrollMode = function GetScrollMode(config, key) {
    var scrollMode = GetValue$d(config, 'scrollMode', 0); // Vertical
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      var iteration = GetValue$b(radiusConfig, 'iteration', undefined);
