  ...
  */
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$_(config, 'color');
      lineWidth = GetValue$_(config, 'lineWidth');
      fillColor = GetValue$_(config, 'fillColor');
      fillAlpha = GetValue$_(config, 'fillAlpha', 1);
      padding = GetValue$_(config, 'padding', 0);
    }
  ...
  */
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      if (GetValue$H(config, 'openOnStart', true)) {
  ...
  var GetScrollMode = function GetScrollMode(config, key, defaultValue) {
    ...
    var scrollMode = GetValue$m(config, key, defaultValue);
  ...
  var Add = function Add(gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
    ...
    if (IsPlainObject$7(columnIndex)) {
      ...
      columnIndex = GetValue$l(config, 'column', undefined);
      rowIndex = GetValue$l(config, 'row', undefined);
    ...
    if (IsPlainObject$7(expand)) {
      config.expandWidth = GetValue$l(expand, 'width', false);
      config.expandHeight = GetValue$l(expand, 'height', false);
    } else {
  ...
  var ResetGrid = function ResetGrid(columnCount, rowCount, columnProportions, rowProportions, space) {
    ...
    // space
    this.setColumnSpace(GetValue$k(space, 'column', 0));
    this.setRowSpace(GetValue$k(space, 'row', 0));
    var scene = this.scene;
  ...
  var GridSizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function GridSizer(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
      ...
      if (IsPlainObject$6(x)) {
        ...
        columnCount = GetValue$j(config, 'column', config.col || 0);
        rowCount = GetValue$j(config, 'row', 0);
        columnProportions = GetValue$j(config, 'columnProportions', 0);
        rowProportions = GetValue$j(config, 'rowProportions', 0);
      ...
      _this.sizerChildren = [];
      _this.addChildrenMap('items', _this.sizerChildren);
      _this.setCreateCellContainerCallback(GetValue$j(config, 'createCellContainerCallback'));
      _this.setIndentLeft(GetValue$j(config, 'space.indentLeftOdd', 0), GetValue$j(config, 'space.indentLeftEven', 0));
      _this.setIndentTop(GetValue$j(config, 'space.indentTopOdd', 0), GetValue$j(config, 'space.indentTopEven', 0));
      _this.resetGrid(columnCount, rowCount, columnProportions, rowProportions, GetValue$j(config, 'space', undefined));
      return _this;
    }
  ...
  var GetValue$i = Phaser.Utils.Objects.GetValue;
  var AddMainChild = function AddMainChild(topPatent, childParent, config) {
    ...
    if (child) {
      ...
      if (typeof childSpace === 'number') {
        ...
        switch (topPatent.scrollMode) {
          case 0:
            childMargin.top = GetValue$i(childSpace, 'top', childSpace);
            childMargin.bottom = GetValue$i(childSpace, 'bottom', childSpace);
            childMargin.left = 0;
            childMargin.right = 0;
            break;
          case 1:
            childMargin.top = GetValue$i(childSpace, 'left', childSpace);
            childMargin.bottom = GetValue$i(childSpace, 'right', childSpace);
            childMargin.left = 0;
            childMargin.right = 0;
            break;
          default:
            ...
            childMargin.top = GetValue$i(childSpace, 'top', childSpace);
            childMargin.bottom = GetValue$i(childSpace, 'bottom', childSpace);
            childMargin.left = GetValue$i(childSpace, 'left', childSpace);
            childMargin.right = GetValue$i(childSpace, 'right', childSpace);
            break;
        }
      }
  ...
  */
  ...
  var RoundRectangle = /*#__PURE__*/function (_Shape) {
    ...
    function RoundRectangle(scene, x, y, width, height, radiusConfig, fillColor, fillAlpha) {
      ...
      if (_this.shapeType === 0) {
        var radius = GetValue$g(radiusConfig, 'radius', radiusConfig);
      ...
      var iteration = GetValue$g(radiusConfig, 'iteration', undefined);
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$f(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$f(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$f(config, 'onModifyStyle');
      return _this;
    }
  ...
  var StatesNineSlice = /*#__PURE__*/function (_PhaserNineSlice) {
    ...
    function StatesNineSlice(scene, config) {
      ...
      var key = GetValue$e(config, 'key', null);
      var frame = GetValue$e(config, 'frame', null);
      var width = GetValue$e(config, 'width', 0);
      var height = GetValue$e(config, 'height', 0);
      var leftWidth = GetValue$e(config, 'leftWidth', 0);
      var rightWidth = GetValue$e(config, 'rightWidth', 0);
      var topHeight = GetValue$e(config, 'topHeight', 0);
      var bottomHeight = GetValue$e(config, 'bottomHeight', 0);
  ...
  var StatesImage = /*#__PURE__*/function (_PhaserImage) {
    ...
    function StatesImage(scene, config) {
      ...
      var key = GetValue$d(config, 'key', '');
      var frame = GetValue$d(config, 'frame', undefined);
  ...
  var SetStretchMode = function SetStretchMode(mode) {
    if (IsPlainObject$3(mode)) {
      this.stretchMode.edge = parseMode(GetValue$c(mode, 'edge', 0));
      this.stretchMode.internal = parseMode(GetValue$c(mode, 'internal', 0));
    } else {
      mode = parseMode(mode);
    ...
    var NinePatch = /*#__PURE__*/function (_GOClass) {
      ...
      function NinePatch(scene, x, y, width, height, key, baseFrame, columns, rows, config) {
        ...
        if (IsPlainObject$2(x)) {
          ...
          width = GetValue$b(config, 'width', 1);
          height = GetValue$b(config, 'height', 1);
          key = GetValue$b(config, 'key', undefined);
          baseFrame = GetValue$b(config, 'baseFrame', undefined);
          columns = GetValue$b(config, 'columns', undefined);
          rows = GetValue$b(config, 'rows', undefined);
        ...
        if (columns === undefined) {
          var leftWidth = GetValue$b(config, 'leftWidth', undefined);
          var rightWidth = GetValue$b(config, 'rightWidth', undefined);
          if (leftWidth !== undefined && rightWidth !== undefined) {
            columns = [leftWidth, undefined, rightWidth];
          }
        }
        if (rows === undefined) {
          var topHeight = GetValue$b(config, 'topHeight', undefined);
          var bottomHeight = GetValue$b(config, 'bottomHeight', undefined);
        ...
        _this.setGetFrameNameCallback(GetValue$b(config, 'getFrameNameCallback', undefined));
        _this.setStretchMode(GetValue$b(config, 'stretchMode', 0));
        _this.setPreserveRatio(GetValue$b(config, 'preserveRatio', true));
        var maxFixedPartScale = GetValue$b(config, 'maxFixedPartScale', 1);
        var maxFixedPartScaleX = GetValue$b(config, 'maxFixedPartScaleX', maxFixedPartScale);
        var maxFixedPartScaleY = GetValue$b(config, 'maxFixedPartScaleY', undefined);
  ...
  var Scroller = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(Scroller, [{
      ...
      value: function resetFromJSON(o) {
        ...
        var dragRate = GetValue$5(o, 'dragRate', 1);
        dragRate = dragRate * (GetValue$5(o, 'dragReverse', false) ? -1 : 1);
  ...
  var AddSlider = function AddSlider(topPatent, sliderParent, axis, config) {
    ...
    if (isScrollXYMode) {
      sliderConfig = GetValue$3(config, sliderConfigKey, undefined);
    } else {
      if (config.hasOwnProperty(sliderConfigKey)) {
        sliderConfig = GetValue$3(config, sliderConfigKey, undefined);
      } else {
        sliderConfig = GetValue$3(config, 'slider', undefined);
      }
    }
    if (sliderConfig) {
      ...
      3. space.child
      */
      var sliderPadding = GetValue$3(config, "space.slider".concat(axis), undefined);
      if (sliderPadding === undefined) {
        sliderPadding = GetValue$3(config, 'space.slider', undefined);
        if (sliderPadding === undefined) {
          if (isScrollXYMode) {
            sliderPadding = 0;
          } else {
            sliderPadding = GetValue$3(config, 'space.child', 0);
      ...
      topPatent["hideUnscrollableSlider".concat(axis)] = GetValue$3(sliderConfig, 'hideUnscrollableSlider', false);
      topPatent["adaptThumb".concat(axis, "SizeMode")] = GetValue$3(sliderConfig, 'adaptThumbSize', false);
      topPatent["minThumb".concat(axis, "Size")] = GetValue$3(sliderConfig, 'minThumbSize', undefined);
    } else {
    ...
    if (isScrollXYMode) {
      scrollerConfig = GetValue$3(config, scrollerConfigKey, true);
    } else {
      if (config.hasOwnProperty(scrollerConfigKey)) {
        scrollerConfig = GetValue$3(config, scrollerConfigKey, true);
      } else {
        scrollerConfig = GetValue$3(config, 'scroller', true);
      }
    }
    ...
    var mouseWheelScrollerConfig = GetValue$3(config, isScrollXYMode ? "mouseWheelScroller".concat(axis) : 'mouseWheelScroller', false),
      mouseWheelScroller;
