(function (global, factory) {
  ...
  var SetupSyncFlags = function SetupSyncFlags(state, config) {
    ...
    if (typeof config === 'boolean') {
      ...
      state.syncPosition = GetValue$1K(config, 'syncPosition', true);
      state.syncRotation = GetValue$1K(config, 'syncRotation', true);
      state.syncScale = GetValue$1K(config, 'syncScale', true);
      state.syncAlpha = GetValue$1K(config, 'syncAlpha', true);
      state.syncScrollFactor = GetValue$1K(config, 'syncScrollFactor', true);
    }
  };
  var AddChild$2 = {
  ...
  */
  ...
  var Snapshot = function Snapshot(config) {
    ...
    var x = GetValue$1J(config, 'x', undefined);
    var y = GetValue$1J(config, 'y', undefined);
    var width = GetValue$1J(config, 'width', undefined);
    var height = GetValue$1J(config, 'height', undefined);
    var originX = GetValue$1J(config, 'originX', 0);
    var originY = GetValue$1J(config, 'originY', 0);
    var padding = GetValue$1J(config, 'padding', 0);
    var scrollX, scrollY;
  ...
  var DrawBounds$2 = function DrawBounds(gameObjects, graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      strokeColor = GetValue$1I(config, 'color');
      lineWidth = GetValue$1I(config, 'lineWidth');
      fillColor = GetValue$1I(config, 'fillColor');
      fillAlpha = GetValue$1I(config, 'fillAlpha', 1);
      padding = GetValue$1I(config, 'padding', 0);
    }
  ...
  var DrawBounds$1 = function DrawBounds(graphics, config) {
    var drawContainer = GetValue$1H(config, 'drawContainer', true);
    var gameObjects = GetValue$1H(config, 'children');
  ...
  var DrawBounds = function DrawBounds(graphics, config) {
    ...
    if (typeof config === 'number') {
      ...
      color = GetValue$1G(config, 'color');
      lineWidth = GetValue$1G(config, 'lineWidth');
      var nameTextConfig = GetValue$1G(config, 'name', false);
      if (nameTextConfig) {
        createTextCallback = GetValue$1G(nameTextConfig, 'createTextCallback', DefaultCreateTextCallback);
        createTextCallbackScope = GetValue$1G(nameTextConfig, 'createTextCallbackScope', undefined);
        textAlign = GetValue$1G(nameTextConfig, 'align', 'left-top');
  ...
  var GetBoundsConfig = function GetBoundsConfig(config, out) {
    ...
    if (typeof config === 'number') {
      ...
      out.left = GetValue$1F(config, 'left', 0);
      out.right = GetValue$1F(config, 'right', 0);
      out.top = GetValue$1F(config, 'top', 0);
      out.bottom = GetValue$1F(config, 'bottom', 0);
    }
    return out;
  };
  ...
  var SetPadding$1 = function SetPadding(padding, key, value) {
    ...
    if (keyType === 'string') {
      ...
      padding.left = GetValue$1E(key, 'left', 0);
      padding.right = GetValue$1E(key, 'right', 0);
      padding.top = GetValue$1E(key, 'top', 0);
      padding.bottom = GetValue$1E(key, 'bottom', 0);
    }
    return padding;
  };
  ...
  var ComponentBase = /*#__PURE__*/function () {
    function ComponentBase(parent, config) {
      ...
      this.setEventEmitter(GetValue$1D(config, 'eventEmitter', true));
  ...
  var TickTask = /*#__PURE__*/function (_ComponentBase) {
    ...
    function TickTask(parent, config) {
      ...
      _this.setTickingMode(GetValue$1C(config, 'tickingMode', 1));
      // boot() later
      return _this;
    }
  ...
  var SceneUpdateTickTask = /*#__PURE__*/function (_TickTask) {
    ...
    function SceneUpdateTickTask(parent, config) {
      ...
      _this.tickEventName = GetValue$1B(config, 'tickEventName', defaultEventName);
  ...
  var Timer = /*#__PURE__*/function () {
    ...
    _createClass(Timer, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.state = GetValue$1A(o, 'state', IDLE$6);
        this.timeScale = GetValue$1A(o, 'timeScale', 1);
        this.delay = GetValue$1A(o, 'delay', 0);
        this.repeat = GetValue$1A(o, 'repeat', 0);
        this.repeatCounter = GetValue$1A(o, 'repeatCounter', 0);
        this.repeatDelay = GetValue$1A(o, 'repeatDelay', 0);
        this.duration = GetValue$1A(o, 'duration', 0);
        this.nowTime = GetValue$1A(o, 'nowTime', 0);
        this.justRestart = GetValue$1A(o, 'justRestart', false);
      }
    }, {
      key: "toJSON",
  ...
  var EaseValueTaskBase = /*#__PURE__*/function (_TimerTask) {
    ...
    _createClass(EaseValueTaskBase, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1z(o, 'timer'));
        this.setEnable(GetValue$1z(o, 'enable', true));
        this.setTarget(GetValue$1z(o, 'target', this.parent));
        this.setDelay(GetAdvancedValue$4(o, 'delay', 0));
        this.setDuration(GetAdvancedValue$4(o, 'duration', 1000));
        this.setEase(GetValue$1z(o, 'ease', 'Linear'));
        this.setRepeat(GetValue$1z(o, 'repeat', 0));
        return this;
      }
    }, {
      key: "setEnable",
  ...
  var ShakePosition = /*#__PURE__*/function (_TickTask) {
    ...
    _createClass(ShakePosition, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.timer.resetFromJSON(GetValue$1v(o, 'timer'));
        this.setEnable(GetValue$1v(o, 'enable', true));
        this.setMode(GetValue$1v(o, 'mode', 1));
        this.isRunning = GetValue$1v(o, 'isRunning', false);
        this.setMagnitudeMode(GetValue$1v(o, 'magnitudeMode', 1));
        this.setAxisMode(GetValue$1v(o, "axis", 0));
        this.setDuration(GetValue$1v(o, 'duration', 500));
        this.setMagnitude(GetValue$1v(o, 'magnitude', 10));
        this.ox = GetValue$1v(o, 'ox', undefined);
        this.oy = GetValue$1v(o, 'oy', undefined);
        return this;
      }
    }, {
      key: "toJSON",
      ...
      value: function start(duration, magnitude) {
        if (typeof duration !== 'number') {
          var config = duration;
          magnitude = GetValue$1v(config, 'magnitude', undefined);
          duration = GetValue$1v(config, 'duration', undefined);
        }
  ...
  var EaseValueTask = /*#__PURE__*/function (_EaseValueTaskBase) {
    ...
    _createClass(EaseValueTask, [{
      ...
      value: function start(config) {
        ...
        var target = this.target;
        this.propertyKey = GetValue$1u(config, 'key', 'value');
        var currentValue = target[this.propertyKey];
        this.fromValue = GetValue$1u(config, 'from', currentValue);
        this.toValue = GetValue$1u(config, 'to', currentValue);
        this.setEase(GetValue$1u(config, 'ease', this.ease));
        this.setDuration(GetValue$1u(config, 'duration', this.duration));
        this.setRepeat(GetValue$1u(config, 'repeat', 0));
        this.setDelay(GetValue$1u(config, 'delay', 0));
        this.setRepeatDelay(GetValue$1u(config, 'repeatDelay', 0));
   ...
   */
  var GetValue$1t = function GetValue(source, key, defaultValue) {
  ...
  var FSM$1 = /*#__PURE__*/function () {
    ...
    */
    function FSM(config) {
      ...
      var states = GetValue$1t(config, 'states', undefined);
      if (states) {
        this.addStates(states);
      }

      // Attach extend members
      var extend = GetValue$1t(config, 'extend', undefined);
      if (extend) {
      ...
      // Event emitter
      var eventEmitter = GetValue$1t(config, 'eventEmitter', undefined);
      var EventEmitterClass = GetValue$1t(config, 'EventEmitterClass', undefined);
    ...
    _createClass(FSM, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.start(GetValue$1t(o, 'start', undefined));
        var init = GetValue$1t(o, 'init', undefined);
        if (init) {
          init.call(this);
        }
        return this;
    ...
    _createClass(FSM, [{
      ...
      */
      ...
      value: function resetFromJSON(o) {
        ...
        this._scene = GetValue$1t(o, 'scene', undefined);
        return this;
      }
    }, {
      key: "stateProperties",
  ...
  */
  ...
  var OpenCloseTransition = /*#__PURE__*/function (_ComponentBase) {
    ...
    function OpenCloseTransition(gameObject, config) {
      ...
      _this.setTransitInTime(GetValue$1s(config, 'duration.in', 200));
      _this.setTransitOutTime(GetValue$1s(config, 'duration.out', 200));
      _this.setTransitInCallback(GetValue$1s(config, 'transitIn'));
      _this.setTransitOutCallback(GetValue$1s(config, 'transitOut'));
      _this.oneShotMode = GetValue$1s(config, 'destroy', false);
      _this.delayCallTimer = undefined;
      _this._state = new State(_assertThisInitialized(_this), {
        eventEmitter: false,
        initState: GetValue$1s(config, 'initState', 'IDLE')
      });
  ...
  var TouchEventStop = /*#__PURE__*/function (_ComponentBase) {
    ...
    _createClass(TouchEventStop, [{
      key: "resetFromJSON",
      value: function resetFromJSON(o) {
        this.setHitAreaMode(GetValue$1r(o, 'hitAreaMode', 0));
        this.setEnable(GetValue$1r(o, 'enable', true));
        this.setStopMode(GetValue$1r(o, 'stopAllLevels', true));
        return this;
      }
    }, {
      key: "boot",
  ...
  var Cover = /*#__PURE__*/function (_FullWindowRectangle) {
    ...
    function Cover(scene, config) {
      ...
      var fillColor = GetValue$1q(config, 'color', 0x0);
      var fillAlpha = GetValue$1q(config, 'alpha', 0.8);
  ...
  var Modal$1 = /*#__PURE__*/function (_OpenCloseTransition) {
    ...
    function Modal(gameObject, config) {
      ...
      config.destroy = GetValue$1p(config, 'destroy', true);
      _this = _super.call(this, gameObject, config);
      // this.parent = gameObject;
      // this.scene

      // Cover : key of modal, to block touch input        
      var coverConfig = GetValue$1p(config, 'cover');
      _this.cover = coverConfig !== false ? CreateCover(gameObject, coverConfig) : undefined;
      if (_this.cover) {
        _this.setCoverTransitInCallback(GetValue$1p(coverConfig, 'transitIn', DefaultCoverTransitInCallback));
        _this.setCoverTransitOutCallback(GetValue$1p(coverConfig, 'transitOut', DefaultCoverTransitOutCallback));
      }

      // Close conditions:
      var touchOutsideClose = GetValue$1p(config, 'touchOutsideClose', false);
      var timeOutDuration = GetValue$1p(config, 'duration.hold', -1);
      var timeOutClose = GetValue$1p(config, 'timeOutClose', timeOutDuration >= 0);
      var anyTouchClose = GetValue$1p(config, 'anyTouchClose', false);
      var manualClose = GetValue$1p(config, 'manualClose', false);
      if (manualClose) {
      ...
      if (GetValue$1p(config, 'openOnStart', true)) {
  ...
  var DownChild = function DownChild(config) {
    var downConfig = GetValue$1l(config, 'down', undefined);
    if (downConfig === false) {
      return;
  ...
  var UpChild = function UpChild(config) {
    var upConfig = GetValue$1k(config, 'up', undefined);
    if (upConfig === false) {
      return;
  ...
  var OverChild = function OverChild(config) {
    var overConfig = GetValue$1j(config, 'over', undefined);
    if (overConfig === false) {
      return;
  ...
  var ClickChild = function ClickChild(config) {
    var clickConfig = GetValue$1i(config, 'click', undefined);
  ...
  var Swipe = /*#__PURE__*/function (_OnePointerTracer) {
    ...
    _createClass(Swipe, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.setVelocityThreshold(GetValue$1e(o, 'velocityThreshold', 1000));
        this.setDirectionMode(GetValue$1e(o, 'dir', '8dir'));
        return this;
      }
    }, {
      key: "onDragStart",
  ...
  var TwoPointersTracer = /*#__PURE__*/function () {
    ...
    _createClass(TwoPointersTracer, [{
      ...
      value: function resetFromJSON(o) {
        ...
        this.bounds = GetValue$1d(o, 'bounds', undefined);
  ...
  var Add$5 = function Add(gameObject, proportion, align, paddingConfig, expand, childKey, index, minWidth, minHeight, fitRatio) {
    ...
    if (proportion === null) {
      ...
      proportion = GetValue$16(config, 'proportion', undefined);
      align = GetValue$16(config, 'align', ALIGN_CENTER$2);
      paddingConfig = GetValue$16(config, 'padding', 0);
      expand = GetValue$16(config, 'expand', false);
      childKey = GetValue$16(config, 'key', undefined);
      index = GetValue$16(config, 'index', undefined);
      if (!gameObject.isRexSizer) {
        minWidth = GetValue$16(config, 'minWidth', undefined);
        minHeight = GetValue$16(config, 'minHeight', undefined);
      }
      fitRatio = GetValue$16(config, 'fitRatio', 0); // width/height
    }
  ...
  var Sizer = /*#__PURE__*/function (_BaseSizer) {
    ...
    function Sizer(scene, x, y, minWidth, minHeight, orientation, config) {
      ...
      if (IsPlainObject$i(x)) {
        ...
        orientation = GetValue$15(config, 'orientation', 0);
      ...
      _this.setItemSpacing(GetValue$15(config, 'space.item', 0));
      _this.setStartChildIndex(GetValue$15(config, 'startChildIndex', 0));
      _this.setRTL(GetValue$15(config, 'rtl', false));
  ...
  var Label = /*#__PURE__*/function (_LabelBase) {
    ...
    function Label(scene, config) {
      ...
      var icon = GetValue$14(config, 'icon', undefined);
      var iconMask = GetValue$14(config, 'iconMask', undefined);
      var text = GetValue$14(config, 'text', undefined);
      var action = GetValue$14(config, 'action', undefined);
      var actionMask = GetValue$14(config, 'actionMask', undefined);
      // Align
      var align = GetValue$14(config, 'align', undefined); // undefined/left/top: no space
      ...
      if (icon) {
        ...
        if (_this.orientation === 0) {
          if (text || action) {
            padding = {
              right: GetValue$14(config, 'space.icon', 0),
              top: GetValue$14(config, 'space.iconTop', 0),
              bottom: GetValue$14(config, 'space.iconBottom', 0)
            };
          }
        } else {
          if (text || action) {
            padding = {
              bottom: GetValue$14(config, 'space.icon', 0),
              left: GetValue$14(config, 'space.iconLeft', 0),
              right: GetValue$14(config, 'space.iconRight', 0)
            };
          }
        }
        var fitRatio = GetValue$14(config, 'squareFitIcon', false) ? 1 : 0;
        _this.add(icon, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var iconSize = GetValue$14(config, 'iconSize', undefined);
          _this.setIconSize(GetValue$14(config, 'iconWidth', iconSize), GetValue$14(config, 'iconHeight', iconSize));
        }
      }
      if (text) {
        var textSpace = GetValue$14(config, 'space.text', 0);
        var expandTextWidth = GetValue$14(config, 'expandTextWidth', false);
        var expandTextHeight = GetValue$14(config, 'expandTextHeight', false);
      ...
      if (action) {
        ...
        if (_this.orientation === 0) {
          padding = {
            top: GetValue$14(config, 'space.actionTop', 0),
            bottom: GetValue$14(config, 'space.actionBottom', 0)
          };
        } else {
          padding = {
            left: GetValue$14(config, 'space.actionLeft', 0),
            right: GetValue$14(config, 'space.actionRight', 0)
          };
        }
        var fitRatio = GetValue$14(config, 'squareFitAction', false) ? 1 : 0;
        _this.add(action, {
          proportion: 0,
          padding: padding,
          fitRatio: fitRatio
        ...
        if (!fitRatio) {
          var actionSize = GetValue$14(config, 'actionSize');
          _this.setActionSize(GetValue$14(config, 'actionWidth', actionSize), GetValue$14(config, 'actionHeight', actionSize));
        }
      }
    ...
    _createClass(RoundRectangle, [{
      ...
      set: function set(value) {
        ...
        if (typeof value === 'number') {
          ...
          defaultRadiusX = GetValue$13(value, 'x', 0);
          defaultRadiusY = GetValue$13(value, 'y', 0);
        }
        var radius = this.cornerRadius;
        radius.tl = GetRadius(GetValue$13(value, 'tl', undefined), defaultRadiusX, defaultRadiusY);
        radius.tr = GetRadius(GetValue$13(value, 'tr', undefined), defaultRadiusX, defaultRadiusY);
        radius.bl = GetRadius(GetValue$13(value, 'bl', undefined), defaultRadiusX, defaultRadiusY);
        radius.br = GetRadius(GetValue$13(value, 'br', undefined), defaultRadiusX, defaultRadiusY);
      }
    }, {
      key: "radiusTL",
      get: function get() {
  ...
  var SetRadius = function SetRadius(radius, value) {
    if (typeof value === 'number') {
      ...
      radius.x = GetValue$13(value, 'x', 0);
      radius.y = GetValue$13(value, 'y', 0);
    }
    SetConvex(radius);
  };
  ...
  */
  ...
  var StyleManager = /*#__PURE__*/function (_ComponentBase) {
    ...
    function StyleManager(gameObject, config) {
      ...
      _this.style = GetValue$11(config, 'style', _assertThisInitialized(_this));
      var propertiesMap = GetValue$11(config, 'propertiesMap');
      ...
      _this.onModifyStyle = GetValue$11(config, 'onModifyStyle');
      return _this;
    }
  ...
  var StatesText = /*#__PURE__*/function (_PhaserText) {
    ...
    function StatesText(scene, config) {
      ...
      var x = GetValue$_(config, 'x', 0);
      var y = GetValue$_(config, 'y', 0);
      var text = GetValue$_(config, 'text', '');
  ...
  var DataMethods = {
    ...
    getData: function getData(key, defaultValue) {
      this.enableData();
      return key === undefined ? this.data : GetValue$1t(this.data, key, defaultValue);
    },
  ...
  var GetValueFromAliasKeys = function GetValueFromAliasKeys(source, key0, key1, key2, defaultValue) {
    if (HasValue(source, key0)) {
      return GetValue$1t(source, key0);
    } else if (key1 && HasValue(source, key1)) {
      return GetValue$1t(source, key1);
    } else if (key2 && HasValue(source, key2)) {
      return GetValue$1t(source, key2);
    } else {
      return defaultValue;
    }
  };
