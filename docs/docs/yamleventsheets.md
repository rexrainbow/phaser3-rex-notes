...
- `fade` :
    ...
    - A plain object contains `mode`, `time`
        - `fade.mode` : Fade mode
            ...
            - `'revealUp'`, or `2` : [Reveal](shader-builtin.md#wipereveal) up for fade-in.
            - `'revealDown'`, or `3` : [Reveal](shader-builtin.md#wipereveal) down for fade-in.
            - `'revealLeft'`, or `4` : [Reveal](shader-builtin.md#wipereveal) left for fade-in.
            - `'revealRight'`, or `5` : [Reveal](shader-builtin.md#wipereveal) right for fade-in.
