...
var AddDragDropItemBehavior = function(itemsBox?: any) {
    // itemsBox is a Sizer
    ...
    for (var i = 0, cnt = items.length; i < cnt; i++) {
        ...
        item
            ...
            .on('sizer.dragend', function(pointer?: any, dragX?: any, dragY?: any, dropped?: any) {
                if (dropped?: any) { // Process 'drop' event
                    return;
                }
...
var AddDropZone = function(itemsBox?: any) {
...
var ArrangeItems = function(itemsBox0?: any, itemsBox1?: any) {
    var items = [];
