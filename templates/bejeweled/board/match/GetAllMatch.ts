import RefreshSymbolCache from './RefreshSymbolCache';
import GetMatchN from './GetMatchN';
...
var GetAllMatch = function() {
    ...
    var matchLines = [];
    for (var n = 5; n >= 3; n--) {
        GetMatchN.call(this, n, function(result?: any, board?: any) {
...
var SubSetTest = function(setA?: any, setB?: any) {
