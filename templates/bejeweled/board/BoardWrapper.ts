...
import { ClearMask } from '../../../plugins/utils/mask/MaskMethods';

import { Utils as PhaserUtils } from 'phaser';
const GetValue = PhaserUtils.Objects.GetValue;

class BoardWrapper {
    activateAreaMaskGameObject: any;
    board: any;
    candidateSymbols: any;
    chessCallbackScope: any;
    chessCreateCallback: any;
    chessMoveTo: any;
    chessTileZ: any;
    enableBoardLayer: any;
    initSymbols: any;
    layer: any;
    match: any;
    matchAcceptList: any;
    ...
    setBoardWidth(width?: any) {
        this.board.setBoardWidth(width);
        return this;
    }

    setBoardHeight(height?: any) {
    ...
    setInitSymbols(symbols?: any) {
        this.initSymbols = symbols; // 2d array
        return this;
    }

    chessToTileXYZ(chess?: any) {
