import SimpleTextBox from '../../../ui/simpletextbox/SimpleTextBox';
import TransitionImagePack from '../../../ui/transitionimagepack/TransitionImagePack';
import AIOSpinner from '../../../ui/aiospinner/AIOSpinner';
...
import KeyMap from '../../../../plugins/utils/input/KeyMap';
...
var GenerateDefaultCreateGameObjectCallback = function (
    ...
    return function (
        ...
        if (!creators.hasOwnProperty('action')) {
            creators.action = function(scene?: any, config?: any) {
                if (config === undefined) {
                    config = {};
                }
        ...
        */
        ...
        var SetFastTypingVariableByKeyboard = function(event?: any, fastTypingValue?: any) {
