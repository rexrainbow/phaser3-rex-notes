...
import RefreshSymbolCache from '../match/RefreshSymbolCache';
import GetMatchN from '../match/GetMatchN';
import RandomSymbol from '../chess/RandomSymobl';
...
var BreakMatch3 = function() {
    ...
    GetMatchN.call(this, 3, function(result?: any, board?: any) {
