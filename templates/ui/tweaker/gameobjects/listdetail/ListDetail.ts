...
import EditorContainer from './scrollable/EditorContainer';
import ListTable from './gridtable/ListTable';
import OnToolbarMethods from './OnToolbarMethods';
...
class ListDetail extends SplitPanels {
    ...
    childrenMap: any;
    displayNameLabelCallback: any;
    emit: any;
    getMaxInputRowTitleWidth: any;
    indexLabelCallback: any;
    onToolbarDelete: any;
    onToolbarDuplicate: any;
    onToolbarNext: any;
    onToolbarPrevious: any;
    onToolbarReset: any;
    readOnly: any;
    selectedIndex: any;
    selectedItem: any;
    ...
    onSelectCell(cellContainer?: any, cellIndex?: any) {
        // cellContainer in ListTable (left panel)
        this.selectItem(cellIndex);
    }

    onItemsChange(changeType?: any, detail?: any) {
    ...
    onEditorValueChange(value?: any, oldValue?: any, bindingTarget?: any, bindingKey?: any) {
        if (!bindingTarget) {
            return;
        }
    ...
    selectItem(index?: any, scrollToRow?: any) {
    ...
    updateEditorTitle(index?: any, item?: any, items?: any) {
        if (index === undefined) {
