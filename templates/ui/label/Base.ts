...
import SetDisplaySize from '../../../plugins/utils/size/SetDisplaySize';
...
class LabelBase extends Sizer {
    ...
    */
    ...
    setIconTexture(key?: any, frame?: any) {
    ...
    setIconSize(width?: any, height?: any) {
        if (height === undefined) {
            height = width;
        }
    ...
    setActionTexture(key?: any, frame?: any) {
    ...
    setActionSize(width?: any, height?: any) {
        if (height === undefined) {
            height = width;
        }
