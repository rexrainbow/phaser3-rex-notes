...
class TabPages extends GridSizer {
    ...
    constructor(scene?: any, config?: any) {
        ...
        // Register events
        tabs.on('button.click', function(tab?: any) {
            var key = tab.name;
        ...
        tabs.on('button.statechange', function(tab?: any, index?: any, value?: any, previousValue?: any) {
            var eventName = (value) ? 'tab.focus' : 'tab.blur';
            this.emit(eventName, tab, tab.name);
        }, this)

        pages.on('pagevisible', function(pageObject?: any, key?: any, pages?: any) {
            this.emit('page.focus', pageObject, key);
        })

        pages.on('pageinvisible', function(pageObject?: any, key?: any, pages?: any) {
