...
import Drag from '../../../plugins/input/drag/Drag';
import OnDragSplitter from './methods/OnDragSplitter';
...
class SplitPanels extends Sizer {
    ...
    emit: any;
    getSizerConfig: any;
    minFirstChildSize: any;
    minSecondChildSize: any;
    splitterDragBehavior: any;
    type: any;
    ...
    setMinLeftPanelWidth(value?: any) {
        this.minLeftPanelWidth = value;
        return this;
    }

    setMinRightPanelWidth(value?: any) {
        this.minRightPanelWidth = value;
        return this;
    }

    setMinTopPanelHeight(value?: any) {
        this.minTopPanelHeight = value;
        return this;
    }

    setMinBottomPanelHeight(value?: any) {
