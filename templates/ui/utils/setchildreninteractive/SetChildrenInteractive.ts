import DownChild from './DownChild';
import UpChild from './UpChild';
import OverChild from './OverChild';
import ClickChild from './ClickChild';
import TapChild from './TapChild';
...
var SetChildrenInteractive = function(gameObject?: any, config?: any) {
