...
import GetScrollMode from '../GetScrollMode';
import CreateScrollableSizer from './methods/CreateScrollableSizer';
...
class Scrollable extends Sizer {
    ...
    setScrollerYEnable(enabled?: any) {
    ...
    setScrollerXEnable(enabled?: any) {
        if (enabled === undefined) {
            enabled = true;
        }
    ...
    setMouseWheelScrollerEnable(enabled?: any) {
        if (enabled === undefined) {
            enabled = true;
        }
    ...
    setMouseWheelScrollerYEnable(enabled?: any) {
    ...
    setMouseWheelScrollerXEnable(enabled?: any) {
        if (enabled === undefined) {
            enabled = true;
        }
