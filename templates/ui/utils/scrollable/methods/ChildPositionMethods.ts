...
export default {
    setChildOY(value?: any, clamp?: any) {
        if (clamp === undefined) {
            clamp = false;
        }
        if (clamp?: any) {
    ...
    addChildOY(inc?: any, clamp?: any) {
        this.setChildOY(this.childOY + inc, clamp);
        return this;
    },

    setT(value?: any, clamp?: any) {
        if (clamp === undefined) {
            clamp = false;
        }
        if (clamp?: any) {
    ...
    setChildOX(value?: any, clamp?: any) {
        if (clamp === undefined) {
            clamp = false;
        }
        if (clamp?: any) {
    ...
    addChildOX(inc?: any, clamp?: any) {
        this.setChildOX(this.childOX + inc, clamp);
        return this;
    },

    setS(value?: any, clamp?: any) {
        if (clamp === undefined) {
            clamp = false;
        }
        if (clamp?: any) {
