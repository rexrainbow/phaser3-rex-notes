import ExtendNodeClass from './NodeBase';
...
import DefaultCreateNodeBodyCallback from '../../builders/DefaultCreateNodeBodyCallback';
...
class Node extends ExtendNodeClass(Sizer) {
    ...
    constructor(scene?: any, config?: any, createCallbackData?: any) {
