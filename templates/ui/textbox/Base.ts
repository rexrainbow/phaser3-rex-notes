...
} from '../../../plugins/utils/text/GetTextObjectType';
...
var TextBoxBase = function(GOClass?: any, type?: any) {
    if (type === undefined) {
        type = 'rexTextBox';
    }
            ...
            if (expandTextWidth || expandTextHeight) {
                ...
                switch (textObjectType?: any) {
                    ...
                    case TagTextType:
                        ...
                        text.resize = function(width?: any, height?: any) {
                ...
                if (expandTextWidth?: any) {
                    text._minWidth = 0;
                }
                if (expandTextHeight?: any) {
                    text._minHeight = 0;
                }
            }
