...
var AppendFromPathSegment = function(srcPathData?: any, accumulationLengths?: any, startT?: any, endT?: any, destPathData?: any) {
    if (endT === undefined) {
        endT = startT;
        startT = 0;
    }
...
var AddPathSegment = function(srcPathData?: any, accumulationLengths?: any, startL?: any, endL?: any, destPathData?: any) {
...
var GetInterpolation = function(pathData?: any, i0?: any, i1?: any, t?: any) {
    var p0 = pathData[i0], p1 = pathData[i1];
    return Linear(p0, p1, t);
}

var WrapT = function(t?: any) {
    if (t === 0) {
        return 0;
    } else if ((t % 1) === 0) {
        return 1;
...
export default {
    ...
    appendFromPathSegment(src?: any, startT?: any, endT?: any) {
        if (startT === undefined) {
