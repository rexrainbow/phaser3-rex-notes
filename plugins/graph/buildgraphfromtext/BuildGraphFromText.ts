import { Parser } from './flowparser/parser';
import GetDefaultCreateEdgeGameObjectCallback from './methods/GetDefaultCreateEdgeGameObjectCallback';

var BuildGraphFromText = function(graph?: any, config?: any) {
    graph.clear();
