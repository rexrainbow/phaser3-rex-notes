...
/*
  ...
  Parser.prototype: {
    ...
    productions_: [...],
    performAction: function anonymous(yytext?: any, yyleng?: any, yylineno?: any, yy?: any, yystate?: any, $$?: any, _$?: any),
    table: [...],
    defaultActions: {...},
    parseError: function(str?: any, hash?: any),
    parse: function(input?: any),

    lexer: {
        EOF: 1,
        parseError: function(str?: any, hash?: any),
        setInput: function(input?: any),
        input: function(),
        unput: function(str?: any),
        more: function(),
        less: function(n?: any),
        pastInput: function(),
        upcomingInput: function(),
        showPosition: function(),
        test_match: function(regex_match_array?: any, rule_index?: any),
        next: function(),
        lex: function(),
        begin: function(condition?: any),
        popState: function(),
        _currentRules: function(),
        topState: function(),
        pushState: function(condition?: any),
        ...
        performAction: function(yy?: any, yy_?: any, $avoiding_name_collisions?: any, YY_START?: any),
        rules: [...],
...
*/
var parser = (function(){
var o=function(k?: any,v?: any,o?: any,l?: any){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,7,9,10,25,26,27,28,35,36],$V1=[1,19],$V2=[1,20],$V3=[1,22],$V4=[32,33,34],$V5=[2,41],$V6=[1,28],$V7=[1,26],$V8=[1,27],$V9=[2,44],$Va=[7,9,10],$Vb=[7,9,10,23,32,33,34],$Vc=[1,7,9,25,26,27,28,35,36],$Vd=[2,16],$Ve=[1,39],$Vf=[2,18],$Vg=[1,41],$Vh=[1,47],$Vi=[1,48],$Vj=[1,55],$Vk=[1,58],$Vl=[1,59],$Vm=[9,19,24,27,35],$Vn=[9,19,24],$Vo=[19,24,27,35];
...
performAction: function anonymous(yytext?: any, yyleng?: any, yylineno?: any, yy?: any, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
/* this == yyval */
...
parseError: function parseError(str?: any, hash?: any) {
    if (hash.recoverable) {
        this.trace(str);
    } else {
...
parse: function parse(input?: any) {
  ...
  function merged(a?: any, b?: any) {
    return mergeInto(mergeInto({}, a || {}), b || {});
  }
  function splitNodeParameters(parameters?: any) {
  ...
  function makeEdgeKey(sourceId?: any, targetId?: any) {
   ...
   */
  function ensureNode(nodeId?: any, newParameters?: any) {
  ...
  function getOrCreateNamedDummy(label?: any) {
   ...
   */
  var dedupePolicy = "first-wins";
  function addEdge(sourceId?: any, targetId?: any, edgeParameters?: any) {
...
setInput:function(input?: any, yy?: any) {
        this.yy = yy || this.yy || {};
        this._input = input;
...
test_match:function(match?: any, indexed_rule?: any) {
        var token,
            lines,
            backup;
...
begin:function begin(condition?: any) {
...
topState:function topState(n?: any) {
...
pushState:function pushState(condition?: any) {
...
options: {},
performAction: function anonymous(yy?: any,yy_?: any,$avoiding_name_collisions?: any,YY_START?: any) {
var YYSTATE=YY_START;
switch($avoiding_name_collisions?: any) {
