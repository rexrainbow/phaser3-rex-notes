...
import CircleFilter from '../circle/CircleFilter';
import CircleController from '../circle/CircleController';


var InstallCircleFX = function(game?: any) {
    game = GetGame(game);
    ...
    AddFilterListMethod(
        'addP3Bloom',
        function(color?: any, offsetX?: any, offsetY?: any, blurStrength?: any, strength?: any, steps?: any) {
    ...
    AddFilterListMethod(
        'addP3Circle',
        function(thickness?: any, color?: any, backgroundColor?: any, scale?: any, feather?: any) {
