...
import FragSrc from './dissolve-frag';

import { Renderer as PhaserRenderer } from 'phaser';
class DissolveFilter extends PhaserRenderer.WebGL.RenderNodes.BaseFilterShader {
    programManager: any;
    ...
    setupTextures(controller?: any, textures?: any, drawingContext?: any) {
