...
class WarpController extends PhaserFilters.Controller {
    ...
    // frequencyX
    setFrequencyX(value?: any) {
        this.frequencyX = value;
        return this;
    }

    // frequencyY
    setFrequencyY(value?: any) {
        this.frequencyY = value;
        return this;
    }

    setFrequency(width?: any, height?: any) {
        if (height === undefined) {
            height = width;
        }
    ...
    // amplitudeX
    setAmplitudeX(value?: any) {
        this.amplitudeX = value;
        return this;
    }

    // amplitudeY
    setAmplitudeY(value?: any) {
        this.amplitudeY = value;
        return this;
    }

    setAmplitude(x?: any, y?: any) {
        if (y === undefined) {
            y = x;
        }
        this.amplitudeX = x;
