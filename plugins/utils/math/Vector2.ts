...
var Vector2 = new Class({
     ...
     * @return {Phaser.Math.Vector2} This Vector2.
     */
    setFromObject: function(obj?: any) {
        this.x = obj.x || 0;
        this.y = obj.y || 0;
     ...
     * @return {Phaser.Math.Vector2} This Vector2.
     */
    setToPolar: function(azimuth?: any, radius?: any) {
     ...
     * @return {Phaser.Math.Vector2} This Vector2.
     */
    transformMat3: function(mat?: any) {
        var x = this.x;
        var y = this.y;
        var m = mat.val;
     ...
     * @return {Phaser.Math.Vector2} This Vector2.
     */
    transformMat4: function(mat?: any) {
        var x = this.x;
        var y = this.y;
        var m = mat.val;
