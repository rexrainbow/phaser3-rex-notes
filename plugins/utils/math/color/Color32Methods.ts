import InterpolateColor32 from './InterpolateColor32';

import { Display as PhaserDisplay } from 'phaser';
const Color = PhaserDisplay.Color;

export default {
    rgbaToColor32(r?: any, g?: any, b?: any, a?: any) {
        return (a << 24) | (r << 16) | (g << 8) | b;
    },

    color32ToColorInt(color32?: any) {
        return color32 & 0xffffff;
    },

    color32ToAlpha(color32?: any) {
        return color32 >>> 24;
    },

    color32ToColorObject(color32?: any, out?: any) {
