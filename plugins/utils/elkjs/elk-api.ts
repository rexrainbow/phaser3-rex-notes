...
var _createClass = function() { function defineProperties(target?: any, props?: any) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function(Constructor?: any, protoProps?: any, staticProps?: any) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ELK = function() {
  function ELK() {
    ...
    if (typeof workerUrl !== 'undefined' && typeof workerFactory === 'undefined') {
      ...
      factory = function factory(url?: any) {
  ...
  _createClass(ELK, [{
    key: 'layout',
    value: function layout(graph?: any) {
...
var PromisedWorker = function() {
  function PromisedWorker(worker?: any) {
    var _this2 = this;
    ...
    this.resolvers = {};
    this.worker = worker;
    this.worker.onmessage = function(answer?: any) {
  ...
  _createClass(PromisedWorker, [{
    key: 'postMessage',
    value: function postMessage(msg?: any) {
      var id = this.id || 0;
      this.id = id + 1;
      msg.id = id;
      var self = this;
      return new Promise(function(resolve?: any, reject?: any) {
        ...
        self.resolvers[id] = function(err?: any, res?: any) {
          if (err?: any) {
    ...
    key: 'receive',
    value: function receive(self?: any, answer?: any) {
