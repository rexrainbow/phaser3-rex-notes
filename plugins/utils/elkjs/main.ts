...
function _possibleConstructorReturn(self?: any, call?: any) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function _inherits(subClass?: any, superClass?: any) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var ELKNode = function(_ELK?: any) {
  ...
  function ELKNode() {
    ...
    if (options.workerUrl) {
      if (workerThreadsExist?: any) {
        var Worker = require('web-worker');
        optionsClone.workerFactory = function(url?: any) {
