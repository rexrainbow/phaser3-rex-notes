...
var MIDIParser = {
	...
	parse: function(input?: any, _callback?: any){
	...
	addListener: function(_fileElement?: any, _callback?: any){
		...
		_fileElement.addEventListener('change', function(InputEvt?: any){				// set the 'file selected' event handler
	...
	Uint8: function(FileAsUint8Array?: any){
		var file = {
			data: null,
			pointer: 0,
			movePointer: function(_bytes?: any){										// move the pointer negative and positive direction
				this.pointer += _bytes;
				return this.pointer;
			},
			readInt: function(_bytes?: any){ 											// get integer from next _bytes group (big-endian)
			...
			readStr: function(_bytes?: any){											// read as ASCII chars, the followoing _bytes
				var text = '';
