import IsASCIIString from '../string/IsASCIIString';

var TextWrapByCharCallback = function(text?: any, textObject?: any) {
    var output = [];
...
var GetTokenArray = function(text?: any, wrapMode?: any) {
    var tokenArray;
...
var WrapLine = function(context?: any, text?: any, wrapWidth?: any, wrapMode?: any, output?: any) {
    if (text.length <= 100) {
