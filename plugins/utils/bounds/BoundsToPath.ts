...
var BoundsToPath = function(gameObject?: any, out?: any) {
    if (out === undefined) {
...
var Create4Lines = function() {
    var path = new PhaserCurves.Path();
    for (var i = 0; i < 4; i++) {
        path.add(new PhaserCurves.Line({ x: 0, y: 0 }, { x: 0, y: 0 }));
    }
    return path;
}

var CopyEndPoint = function(curLine?: any, prevLine?: any) {
    curLine.p0.x = prevLine.p1.x;
    curLine.p0.y = prevLine.p1.y;
}

var CopyStartPoint = function(curLine?: any, prevLine?: any) {
