...
class BatchHandlerTriangles extends BatchHandlerQuad {
    _renderOptionsChanged: any;
    batchTextures: any;
    currentBatchEntry: any;
    floatsPerInstance: any;
    instanceCount: any;
    instancesPerBatch: any;
    manager: any;
    maxVerticesPerBatch: any;
    renderOptions: any;
    run: any;
    updateRenderOptions: any;
    updateShaderConfig: any;
    vertexBufferLayout: any;
    verticesPerInstance: any;
    ...
    _generateElementIndices(instances?: any) {
