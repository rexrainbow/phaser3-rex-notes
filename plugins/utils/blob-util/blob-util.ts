(function(global?: any, factory?: any) {
    ...
    /** @private */
    function loadImage(src?: any, crossOrigin?: any) {
     ...
     * @returns Blob
     */
    function createBlob(parts?: any, properties?: any) {
        parts = parts || [];
     ...
     *
     * ```js
     * blobUtil.blobToBinaryString(blob).then(function(binaryString?: any) {
     *   // success
     ...
     */
    function blobToBinaryString(blob?: any) {
        return new Promise(function(resolve?: any, reject?: any) {
            var reader = new FileReader();
            var hasBinaryString = typeof reader.readAsBinaryString === 'function';
            reader.onloadend = function() {
                var result = reader.result || '';
                if (hasBinaryString?: any) {
     ...
     * @returns Blob
     */
    function base64StringToBlob(base64?: any, type?: any) {
     ...
     * @returns Blob
     */
    function binaryStringToBlob(binary?: any, type?: any) {
     ...
     *
     * ```js
     * blobUtil.blobToBase64String(blob).then(function(base64String?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     * @returns Promise that resolves with the binary string
     */
    function blobToBase64String(blob?: any) {
    ...
    function blobToDataURL(blob?: any) {
        return blobToBase64String(blob).then(function(base64String?: any) {
     ...
     *
     * ```js
     * blobUtil.imgSrcToDataURL('http://mysite.com/img.png').then(function(dataURL?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     *                          'Anonymous', 1.0).then(function(dataURL?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     * @returns Promise that resolves with the data URL string
     */
    function imgSrcToDataURL(src?: any, type?: any, crossOrigin?: any, quality?: any) {
        type = type || 'image/png';
        return loadImage(src, crossOrigin).then(imgToCanvas).then(function(canvas?: any) {
     ...
     *
     * ```js
     * blobUtil.canvasToBlob(canvas).then(function(blob?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     *
     * ```js
     * blobUtil.canvasToBlob(canvas, 'image/webp').then(function(blob?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     */
    function canvasToBlob(canvas?: any, type?: any, quality?: any) {
     ...
     *
     * ```js
     * blobUtil.imgSrcToBlob('http://mysite.com/img.png').then(function(blob?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     *                          'Anonymous', 1.0).then(function(blob?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     * @returns Promise that resolves with the <code>Blob</code>
     */
    function imgSrcToBlob(src?: any, type?: any, crossOrigin?: any, quality?: any) {
        type = type || 'image/png';
        return loadImage(src, crossOrigin).then(imgToCanvas).then(function(canvas?: any) {
     ...
     *
     * ```js
     * blobUtil.blobToArrayBuffer(blob).then(function(arrayBuff?: any) {
     *   // success
     * }).catch(function(err?: any) {
     *   // error
     * });
     ...
     */
    function arrayBufferToBinaryString(buffer?: any) {
        var binary = '';
     ...
     */
    function binaryStringToArrayBuffer(binary?: any) {
