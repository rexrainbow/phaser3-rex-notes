...
export default {
    setBackgroundMusic2Loop(value?: any) {
        if (value === undefined) {
            value = true;
        }
    ...
    setBackgroundMusic2FadeTime(time?: any) {
    ...
    // Internal method
    setCurrentBackgroundMusic2(music?: any) {
    ...
    playBackgroundMusic2(key?: any, config?: any) {
    ...
    fadeInBackgroundMusic2(time?: any) {
        if (this.backgroundMusic2) {
    ...
    fadeOutBackgroundMusic2(time?: any, isStopped?: any) {
        if (this.backgroundMusic2) {
    ...
    crossFadeBackgroundMusic2(key?: any, time?: any) {
        if (!this.hasAudio(key)) {
            console.error(`[Sound manager] Audio key'${key}' is not existed`);
            return this;
        }
    ...
    setBackgroundMusic2Mute(mute?: any) {
        if (mute === undefined) {
            mute = true;
        }
    ...
    setBackgroundMusic2Volume(volume?: any) {
        this.backgroundMusic2Volume = volume;
        return this;
    },

    setBackgroundMusic2Rate(rate?: any) {
        if (this.backgroundMusic2) {
    ...
    setBackgroundMusic2Detune(detune?: any) {
        if (this.backgroundMusic2) {
