import GetBoundsOfGameObjects from '../bounds/GetBoundsOfGameObjects';
...
var GetValue = PhaserUtils.Objects.GetValue;

var Snapshot = function(config?: any) {
    if (!config) {
        return;
    }
