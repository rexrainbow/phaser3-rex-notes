import GetStyle from '../canvas/GetStyle';
...
var GetBounds = function(points?: any, out?: any) {
    if (out === undefined) {
        out = {};
    }
...
var IndentPoints = function(points?: any, bounds?: any, lineWidth?: any) {
    if (lineWidth === 0) {
        return points;
    }
...
var Indent = function(value?: any, halfBound?: any, offset?: any) {
    if (value < halfBound) {
        return (value + offset);
...
var OffsetPoints = function(points?: any, x?: any, y?: any) {
    if (y === undefined) {
        y = x;
    }
