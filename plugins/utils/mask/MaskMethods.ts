import IsWebGLRenderMode from '../system/IsWebGLRenderMode';

import { Filters as PhaserFilters } from 'phaser';
const MaskController = PhaserFilters.Mask;

var SetMask = function(gameObject?: any, maskGameObject?: any, invert?: any, maskType?: any) {
...
var WebGLSetSharedMask = function(gameObject?: any, maskGameObject?: any, invert?: any) {
...
var WebGLSetPrivateMask = function(gameObject?: any, maskGameObject?: any, invert?: any, maskType?: any) {
    if (!gameObject.filters) {
        if (!gameObject.enableFilters) {
            return;
        }
...
var CanvasSetMask = function(gameObject?: any, maskGameObject?: any) {
...
var ClearMask = function(gameObject?: any) {
    if (!gameObject.mask) {
        return;
    }
...
var WebglClearSharedMask = function(gameObject?: any) {
    if (!gameObject.mask) {
        return;
    }
...
var WebGLClearPrivateMask = function(gameObject?: any, maskTpe?: any) {
    if (!gameObject.mask) {
        return;
    }
...
var CanvasClearMask = function(gameObject?: any) {
    gameObject.mask = null;
}
