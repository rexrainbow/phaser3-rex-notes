...
import Timer from '../../utils/componentbase/timerticktask/Timer';
...
class ShakePosition extends TickTask {
    ...
    setMagnitudeMode(magnitudeMode?: any) {
    ...
    setMagnitude(magnitude?: any) {
        this.magnitude = magnitude;
        return this;
    }

    start(duration?: any, magnitude?: any) {
    ...
    shake(duration?: any, magnitude?: any) {
