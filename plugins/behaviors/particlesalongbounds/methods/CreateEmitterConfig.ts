...
import BoundsToPoints from './BoundsToPoints';

const GetValue = PhaserUtils.Objects.GetValue;
const TickTime = (1000 / 60);

var CreateEmitterConfig = function(gameObject?: any, config?: any) {
    ...
    if (emitterConfig.hasOwnProperty('frequency')) {
        ...
        emitterConfig.emitCallback = function(particle?: any, emitter?: any) {
