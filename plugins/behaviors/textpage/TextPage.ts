...
} from '../../utils/text/GetTextObjectType';
import GetTextObjectType from '../../utils/text/GetTextObjectType';
import TextToLines from '../../utils/text/TextToLines';
import TextHeightToLineCount from '../../utils/text/TextHeightToLineCount';
...
class TextPage extends ComponentBase {
    ...
    setMaxLines(maxLines?: any) {
        this.maxLines = maxLines;
        return this;
    }

    setPageBreak(pageBreak?: any) {
    ...
    getPageIndexByLineIndex(lineIndex?: any) {
    ...
    getLineIndexByHeight(lineIndex?: any, pageHeight?: any) {
    ...
    getLastStartLineIndexByHeight(pageHeight?: any) {
        if (pageHeight <= 0) {
            return 0;
        }
        var lines = this.lines.lines;
    ...
    getLineIndexByStartOffset(targetOffset?: any) {
        var lines = this.lines.lines;
        if (!lines || lines.length === 0) {
            return 0;
        }
    ...
    getLineIndexByStartOffsetCeil(targetOffset?: any) {
        var lines = this.lines.lines;
        if (!lines || lines.length === 0) {
            return 0;
        }
