...
class Bounds extends TickTask {
    ...
    setBoundsTarget(gameObject?: any) {
        this.boundsTarget = gameObject;
        return this;
    }

    setBounds(boundsConfig?: any) {
        if (!boundsConfig) {
            return this;
        }
...
var GetBoundHitMode = function(mode?: any) {
    if (typeof (mode) === 'string') {
