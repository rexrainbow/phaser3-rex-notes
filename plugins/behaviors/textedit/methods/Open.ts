import { SetLastOpenedEditor } from './LastOpenedEditor';
import IsFunction from '../../../utils/object/IsFunction';
import CreateInputTextFromText from './CreateInputText';
import NextTick from '../../../utils/time/NextTick';

import { Utils as PhaserUtils } from 'phaser';
const GetValue = PhaserUtils.Objects.GetValue;
const Merge = PhaserUtils.Objects.Merge;

var Open = function(config?: any, onCloseCallback?: any) {
    if (config === undefined) {
        config = {};
    }
    ...
    if (onCreateInputTextCallback?: any) {
    ...
    this.inputText
        .on('textchange', function(inputText?: any) {
            ...
            if (customOnTextChanged?: any) { // Custom on-text-changed callback
