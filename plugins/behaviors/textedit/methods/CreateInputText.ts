...
import IsTextGameObject from '../../../utils/text/IsTextGameObject';

import { Utils as PhaserUtils } from 'phaser';
const GetValue = PhaserUtils.Objects.GetValue;
const Clone = PhaserUtils.Objects.Clone;

var CreateInputText = function(text?: any, config?: any) {
    if (config === undefined) {
        config = {};
    }
    config = Clone(config);
...
var GetHAlign = function(style?: any) {
...
var GetVAlign = function(style?: any) {
