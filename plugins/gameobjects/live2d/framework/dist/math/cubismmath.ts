...
var CubismMath = /** @class */ (function() {
     ...
     */
    CubismMath.range = function(value?: any, min?: any, max?: any) {
        if (value < min) {
            value = min;
        }
        else if (value > max) {
     ...
     * @return 値の平方根
     */
    CubismMath.sqrt = function(x?: any) {
        return Math.sqrt(x);
    };
    /**
     * 立方根を求める
     ...
     * @return 値の立方根
     */
    CubismMath.cbrt = function(x?: any) {
        if (x === 0) {
            return x;
        }
        var cx = x;
     ...
     */
    CubismMath.getEasingSine = function(value?: any) {
        if (value < 0.0) {
            return 0.0;
        }
        else if (value > 1.0) {
     ...
     * @return 大きい方の値
     */
    CubismMath.max = function(left?: any, right?: any) {
     ...
     * @return 小さい方の値
     */
    CubismMath.min = function(left?: any, right?: any) {
     ...
     */
    CubismMath.degreesToRadian = function(degrees?: any) {
     ...
     */
    CubismMath.radianToDegrees = function(radian?: any) {
     ...
     */
    CubismMath.directionToRadian = function(from?: any, to?: any) {
     ...
     */
    CubismMath.directionToDegrees = function(from?: any, to?: any) {
     ...
     */
    CubismMath.radianToDirection = function(totalAngle?: any) {
     ...
     * @return  二次方程式の解
     */
    CubismMath.quadraticEquation = function(a?: any, b?: any, c?: any) {
     ...
     */
    CubismMath.cardanoAlgorithmForBezier = function(a?: any, b?: any, c?: any, d?: any) {
