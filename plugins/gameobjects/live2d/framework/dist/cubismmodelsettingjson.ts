...
var __extends = (this && this.__extends) || (function() {
    var extendStatics = function(d?: any, b?: any) {
 ...
 */
var CubismModelSettingJson = /** @class */ (function(_super?: any) {
     ...
     */
    function CubismModelSettingJson(buffer?: any, size?: any) {
     ...
     * @return テクスチャの名前
     */
    CubismModelSettingJson.prototype.getTextureFileName = function(index?: any) {
        return this._jsonValue
            .at(FrequestNode.FrequestNode_Textures)
     ...
     */
    CubismModelSettingJson.prototype.getHitAreaId = function(index?: any) {
     ...
     */
    CubismModelSettingJson.prototype.getHitAreaName = function(index?: any) {
        return this._jsonValue
            .at(FrequestNode.FrequestNode_HitAreas)
            .getValueByIndex(index)
     ...
     * @return 表情の名前
     */
    CubismModelSettingJson.prototype.getExpressionName = function(index?: any) {
        return this._jsonValue
     ...
     * @return 表情設定ファイルの名前
     */
    CubismModelSettingJson.prototype.getExpressionFileName = function(index?: any) {
        return this._jsonValue
            .at(FrequestNode.FrequestNode_Expressions)
            .getValueByIndex(index)
     ...
     * @return モーショングループの名前
     */
    CubismModelSettingJson.prototype.getMotionGroupName = function(index?: any) {
        if (!this.isExistMotionGroups()) {
            return null;
        }
        return this._jsonValue
     ...
     * @return モーショングループの数
     */
    CubismModelSettingJson.prototype.getMotionCount = function(groupName?: any) {
     ...
     * @return モーションファイルの名前
     */
    CubismModelSettingJson.prototype.getMotionFileName = function(groupName?: any, index?: any) {
        if (!this.isExistMotionGroupName(groupName)) {
            return '';
        }
        return this._jsonValue
     ...
     * @return サウンドファイルの名前
     */
    CubismModelSettingJson.prototype.getMotionSoundFileName = function(groupName?: any, index?: any) {
     ...
     * @return フェードイン処理時間[秒]
     */
    CubismModelSettingJson.prototype.getMotionFadeInTimeValue = function(groupName?: any, index?: any) {
     ...
     */
    CubismModelSettingJson.prototype.getMotionFadeOutTimeValue = function(groupName?: any, index?: any) {
     ...
     */
    CubismModelSettingJson.prototype.getLayoutMap = function(outLayoutMap?: any) {
     ...
     * @return パラメータID
     */
    CubismModelSettingJson.prototype.getEyeBlinkParameterId = function(index?: any) {
        if (!this.isExistEyeBlinkParameters()) {
            return null;
        }
        for (var i = 0; i < this._jsonValue.at(FrequestNode.FrequestNode_Groups).getSize(); i++) {
     ...
     * @return パラメータID
     */
    CubismModelSettingJson.prototype.getLipSyncParameterId = function(index?: any) {
        if (!this.isExistLipSyncParameters()) {
            return null;
        }
        for (var i = 0; i < this._jsonValue.at(FrequestNode.FrequestNode_Groups).getSize(); i++) {
     ...
     * @return false キーが存在しない
     */
    CubismModelSettingJson.prototype.isExistMotionGroupName = function(groupName?: any) {
     ...
     * @return false キーが存在しない
     */
    CubismModelSettingJson.prototype.isExistMotionSoundFile = function(groupName?: any, index?: any) {
        var node = this._jsonValue
            .at(FrequestNode.FrequestNode_Motions)
            .getValueByString(groupName)
            .getValueByIndex(index)
     ...
     * @return false キーが存在しない
     */
    CubismModelSettingJson.prototype.isExistMotionFadeIn = function(groupName?: any, index?: any) {
        var node = this._jsonValue
            .at(FrequestNode.FrequestNode_Motions)
            .getValueByString(groupName)
            .getValueByIndex(index)
     ...
     * @return false キーが存在しない
     */
    CubismModelSettingJson.prototype.isExistMotionFadeOut = function(groupName?: any, index?: any) {
        var node = this._jsonValue
            .at(FrequestNode.FrequestNode_Motions)
            .getValueByString(groupName)
            .getValueByIndex(index)
...
(function(Live2DCubismFramework?: any) {
