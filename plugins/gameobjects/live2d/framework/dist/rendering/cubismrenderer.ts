...
var CubismRenderer = /** @class */ (function() {
     ...
     * レンダラのインスタンスを解放する
     */
    CubismRenderer.delete = function(renderer?: any) {
        renderer = null;
    };
    /**
     * レンダラの初期化処理を実行する
     ...
     */
    CubismRenderer.prototype.initialize = function(model?: any) {
        this._model = model;
    };
    /**
     * モデルを描画する
     ...
     */
    CubismRenderer.prototype.setMvpMatrix = function(matrix44?: any) {
     ...
     */
    CubismRenderer.prototype.setModelColor = function(red?: any, green?: any, blue?: any, alpha?: any) {
        if (red < 0.0) {
            red = 0.0;
        }
        else if (red > 1.0) {
     ...
     */
    CubismRenderer.prototype.setIsPremultipliedAlpha = function(enable?: any) {
     ...
     * 有効にするならtrue、無効にするならfalseをセットする
     */
    CubismRenderer.prototype.setIsCulling = function(culling?: any) {
     ...
     * @param n パラメータの値
     */
    CubismRenderer.prototype.setAnisotropy = function(n?: any) {
        this._anisortopy = n;
    };
    /**
     * テクスチャの異方性フィルタリングのパラメータをセットする
