...
var CubismString = /** @class */ (function() {
     ...
     * @return 書式を適用した文字列
     */
    CubismString.getFormatedString = function(format?: any) {
        var args = [];
     ...
     */
    CubismString.isStartWith = function(text?: any, startWord?: any) {
        var textIndex = 0;
     ...
     * @return 解析結果の数値
     */
    CubismString.stringToFloat = function(string?: any, length?: any, position?: any, outEndPos?: any) {
        var i = position;
