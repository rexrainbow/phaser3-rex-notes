...
exports.CubismLogPrint = function(level?: any, fmt?: any, args?: any) {
    CubismDebug.print(level, '[CSM]' + fmt, args);
};
exports.CubismLogPrintIn = function(level?: any, fmt?: any, args?: any) {
    exports.CubismLogPrint(level, fmt + '\n', args);
};
exports.CSM_ASSERT = function(expr?: any) {
    console.assert(expr);
};
if (cubismframeworkconfig_1.CSM_LOG_LEVEL <= cubismframeworkconfig_1.CSM_LOG_LEVEL_VERBOSE) {
    exports.CubismLogVerbose = function(fmt?: any) {
        var args = [];
    ...
    exports.CubismLogDebug = function(fmt?: any) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    exports.CubismLogInfo = function(fmt?: any) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    exports.CubismLogWarning = function(fmt?: any) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
    ...
    exports.CubismLogError = function(fmt?: any) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
...
var CubismDebug = /** @class */ (function() {
     ...
     * @param args 可変長引数
     */
    CubismDebug.print = function(logLevel?: any, format?: any, args?: any) {
        ...
        if (!logPrint)
            return;
        var buffer = format.replace(/\{(\d+)\}/g, function(m?: any, k?: any) {
            return args[k];
        });
        logPrint(buffer);
    };
     ...
     */
    CubismDebug.dumpBytes = function(logLevel?: any, data?: any, length?: any) {
