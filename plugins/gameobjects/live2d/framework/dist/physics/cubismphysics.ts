...
var CubismPhysics = /** @class */ (function() {
     ...
     * @return 作成されたインスタンス
     */
    CubismPhysics.create = function(buffer?: any, size?: any) {
     ...
     */
    CubismPhysics.delete = function(physics?: any) {
        if (physics != null) {
            physics.release();
            physics = null;
        }
     ...
     */
    CubismPhysics.prototype.evaluate = function(model?: any, deltaTimeSeconds?: any) {
        var totalAngle;
        var weight;
        var radAngle;
        var outputValue;
     ...
     * @param options オプション
     */
    CubismPhysics.prototype.setOptions = function(options?: any) {
     ...
     * @param size バッファのサイズ
     */
    CubismPhysics.prototype.parse = function(physicsJson?: any, size?: any) {
...
function getInputTranslationXFromNormalizedParameterValue(targetTranslation?: any, targetAngle?: any, value?: any, parameterMinimumValue?: any, parameterMaximumValue?: any, parameterDefaultValue?: any, normalizationPosition?: any, normalizationAngle?: any, isInverted?: any, weight?: any) {
    targetTranslation.x +=
...
function getInputTranslationYFromNormalizedParamterValue(targetTranslation?: any, targetAngle?: any, value?: any, parameterMinimumValue?: any, parameterMaximumValue?: any, parameterDefaultValue?: any, normalizationPosition?: any, normalizationAngle?: any, isInverted?: any, weight?: any) {
    targetTranslation.y +=
        normalizeParameterValue(value, parameterMinimumValue, parameterMaximumValue, parameterDefaultValue, normalizationPosition.minimum, normalizationPosition.maximum, normalizationPosition.defalut, isInverted) * weight;
}
function getInputAngleFromNormalizedParameterValue(targetTranslation?: any, targetAngle?: any, value?: any, parameterMinimumValue?: any, parameterMaximumValue?: any, parameterDefaultValue?: any, normalizaitionPosition?: any, normalizationAngle?: any, isInverted?: any, weight?: any) {
    targetAngle.angle +=
...
function getOutputTranslationX(translation?: any, particles?: any, particleIndex?: any, isInverted?: any, parentGravity?: any) {
...
function getOutputTranslationY(translation?: any, particles?: any, particleIndex?: any, isInverted?: any, parentGravity?: any) {
...
function getOutputAngle(translation?: any, particles?: any, particleIndex?: any, isInverted?: any, parentGravity?: any) {
    var outputValue;
    if (particleIndex >= 2) {
...
function getRangeValue(min?: any, max?: any) {
...
function getDefaultValue(min?: any, max?: any) {
    var minValue = cubismmath_1.CubismMath.min(min, max);
    return minValue + getRangeValue(min, max) / 2.0;
}
function getOutputScaleTranslationX(translationScale?: any, angleScale?: any) {
    return JSON.parse(JSON.stringify(translationScale.x));
}
function getOutputScaleTranslationY(translationScale?: any, angleScale?: any) {
    return JSON.parse(JSON.stringify(translationScale.y));
}
function getOutputScaleAngle(translationScale?: any, angleScale?: any) {
 ...
 */
function updateParticles(strand?: any, strandCount?: any, totalTranslation?: any, totalAngle?: any, windDirection?: any, thresholdValue?: any, deltaTimeSeconds?: any, airResistance?: any) {
    var totalRadian;
    var delay;
    var radian;
    var currentGravity;
 ...
 */
function updateOutputParameterValue(parameterValue?: any, parameterValueMinimum?: any, parameterValueMaximum?: any, translation?: any, output?: any) {
    var outputScale;
    var value;
    var weight;
...
function normalizeParameterValue(value?: any, parameterMinimum?: any, parameterMaximum?: any, parameterDefault?: any, normalizedMinimum?: any, normalizedMaximum?: any, normalizedDefault?: any, isInverted?: any) {
    var result = 0.0;
