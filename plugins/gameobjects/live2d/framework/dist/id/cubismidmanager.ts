...
var CubismIdManager = /** @class */ (function() {
     ...
     * @param count IDの個数
     */
    CubismIdManager.prototype.registerIds = function(ids?: any) {
     ...
     * @param id ID名
     */
    CubismIdManager.prototype.registerId = function(id?: any) {
        var result = null;
        if ('string' == typeof id) {
     ...
     * @param id ID名
     */
    CubismIdManager.prototype.getId = function(id?: any) {
     ...
     * @return false 存在しない
     */
    CubismIdManager.prototype.isExist = function(id?: any) {
        if ('string' == typeof id) {
     ...
     */
    CubismIdManager.prototype.findId = function(id?: any) {
        for (var i = 0; i < this._ids.getSize(); ++i) {
            if (this._ids
                .at(i)
                .getString()
