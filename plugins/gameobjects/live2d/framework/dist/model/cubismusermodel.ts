...
var CubismUserModel = /** @class */ (function() {
    ...
    function CubismUserModel() {
         ...
         * @return モーションクラス
         */
        this.loadMotion = function(buffer?: any, size?: any, name?: any, onFinishedMotionHandler?: any) { return cubismmotion_1.CubismMotion.create(buffer, size, onFinishedMotionHandler); };
        // 各変数初期化
        this._moc = null;
        this._model = null;
     ...
     * @param v 初期化状態
     */
    CubismUserModel.prototype.setInitialized = function(v?: any) {
        this._initialized = v;
    };
    /**
     * 更新状態の取得
     ...
     * @param v 更新状態
     */
    CubismUserModel.prototype.setUpdating = function(v?: any) {
        this._updating = v;
    };
    /**
     * マウスドラッグ情報の設定
     ...
     */
    CubismUserModel.prototype.setDragging = function(x?: any, y?: any) {
     ...
     * @param z Z軸方向の加速度
     */
    CubismUserModel.prototype.setAcceleration = function(x?: any, y?: any, z?: any) {
     ...
     * @param a 不透明度
     */
    CubismUserModel.prototype.setOpacity = function(a?: any) {
        this._opacity = a;
    };
    /**
     * 不透明度の取得
     ...
     */
    CubismUserModel.prototype.loadModel = function(buffer?: any) {
     ...
     * @param name 表情の名前
     */
    CubismUserModel.prototype.loadExpression = function(buffer?: any, size?: any, name?: any) {
     ...
     * @param size バッファのサイズ
     */
    CubismUserModel.prototype.loadPose = function(buffer?: any, size?: any) {
     ...
     * @param size バッファのサイズ
     */
    CubismUserModel.prototype.loadUserData = function(buffer?: any, size?: any) {
     ...
     * @param size    バッファのサイズ
     */
    CubismUserModel.prototype.loadPhysics = function(buffer?: any, size?: any) {
     ...
     */
    CubismUserModel.prototype.isHit = function(drawableId?: any, pointX?: any, pointY?: any) {
     ...
     */
    CubismUserModel.prototype.motionEventFired = function(eventValue?: any) {
     ...
     */
    CubismUserModel.cubismDefaultMotionEventCallback = function(caller?: any, eventValue?: any, customData?: any) {
