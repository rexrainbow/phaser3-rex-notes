...
var CubismModel = /** @class */ (function() {
     ...
     * @param model モデル
     */
    function CubismModel(model?: any) {
        this._model = model;
     ...
     * @return パーツのインデックス
     */
    CubismModel.prototype.getPartIndex = function(partId?: any) {
        var partIndex;
     ...
     * @param opacity 不透明度
     */
    CubismModel.prototype.setPartOpacityByIndex = function(partIndex?: any, opacity?: any) {
     ...
     */
    CubismModel.prototype.setPartOpacityById = function(partId?: any, opacity?: any) {
     ...
     * @return パーツの不透明度
     */
    CubismModel.prototype.getPartOpacityByIndex = function(partIndex?: any) {
        if (this._notExistPartOpacities.isExist(partIndex)) {
     ...
     * @return パーツの不透明度
     */
    CubismModel.prototype.getPartOpacityById = function(partId?: any) {
        // 高速化のためにPartIndexを取得できる機構になっているが、外部からの設定の時は呼び出し頻度が低いため不要
        var index = this.getPartIndex(partId);
        if (index < 0) {
     ...
     * @return パラメータのインデックス
     */
    CubismModel.prototype.getParameterIndex = function(parameterId?: any) {
        var parameterIndex;
     ...
     * @return パラメータの最大値
     */
    CubismModel.prototype.getParameterMaximumValue = function(parameterIndex?: any) {
     ...
     * @return パラメータの最小値
     */
    CubismModel.prototype.getParameterMinimumValue = function(parameterIndex?: any) {
     ...
     * @return パラメータのデフォルト値
     */
    CubismModel.prototype.getParameterDefaultValue = function(parameterIndex?: any) {
     ...
     * @return パラメータの値
     */
    CubismModel.prototype.getParameterValueByIndex = function(parameterIndex?: any) {
     ...
     * @return パラメータの値
     */
    CubismModel.prototype.getParameterValueById = function(parameterId?: any) {
     ...
     * @param weight 重み
     */
    CubismModel.prototype.setParameterValueByIndex = function(parameterIndex?: any, value?: any, weight?: any) {
     ...
     * @param weight 重み
     */
    CubismModel.prototype.setParameterValueById = function(parameterId?: any, value?: any, weight?: any) {
        if (weight === void 0) { weight = 1.0; }
     ...
     * @param weight 重み
     */
    CubismModel.prototype.addParameterValueByIndex = function(parameterIndex?: any, value?: any, weight?: any) {
        if (weight === void 0) { weight = 1.0; }
     ...
     * @param weight 重み
     */
    CubismModel.prototype.addParameterValueById = function(parameterId?: any, value?: any, weight?: any) {
        if (weight === void 0) { weight = 1.0; }
        var index = this.getParameterIndex(parameterId);
     ...
     * @param weight 重み
     */
    CubismModel.prototype.multiplyParameterValueById = function(parameterId?: any, value?: any, weight?: any) {
        if (weight === void 0) { weight = 1.0; }
        var index = this.getParameterIndex(parameterId);
     ...
     * @param weight 重み
     */
    CubismModel.prototype.multiplyParameterValueByIndex = function(parameterIndex?: any, value?: any, weight?: any) {
        if (weight === void 0) { weight = 1.0; }
     ...
     */
    CubismModel.prototype.getDrawableIndex = function(drawableId?: any) {
     ...
     * @return drawableのID
     */
    CubismModel.prototype.getDrawableId = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableTextureIndices = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableDynamicFlagVertexPositionsDidChange = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableVertexIndexCount = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableVertexCount = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableVertices = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableVertexIndices = function(drawableIndex?: any) {
     ...
     * @return drawableの頂点リスト
     */
    CubismModel.prototype.getDrawableVertexPositions = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableVertexUvs = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableOpacity = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableCulling = function(drawableIndex?: any) {
     ...
     */
    CubismModel.prototype.getDrawableBlendMode = function(drawableIndex?: any) {
        var constantFlags = this._model.drawables.constantFlags;
     ...
     */
    CubismModel.prototype.getDrawableInvertedMaskBit = function(drawableIndex?: any) {
        var constantFlags = this._model.drawables.constantFlags;
     ...
     */
    CubismModel.prototype.getDrawableDynamicFlagIsVisible = function(drawableIndex?: any) {
        var dynamicFlags = this._model.drawables.dynamicFlags;
     ...
     */
    CubismModel.prototype.getDrawableDynamicFlagVisibilityDidChange = function(drawableIndex?: any) {
        var dynamicFlags = this._model.drawables.dynamicFlags;
     ...
     */
    CubismModel.prototype.getDrawableDynamicFlagOpacityDidChange = function(drawableIndex?: any) {
        var dynamicFlags = this._model.drawables.dynamicFlags;
     ...
     */
    CubismModel.prototype.getDrawableDynamicFlagRenderOrderDidChange = function(drawableIndex?: any) {
        var dynamicFlags = this._model.drawables.dynamicFlags;
