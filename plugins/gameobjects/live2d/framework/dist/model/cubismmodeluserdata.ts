...
var CubismModelUserData = /** @class */ (function() {
     ...
     * @return 作成されたインスタンス
     */
    CubismModelUserData.create = function(buffer?: any, size?: any) {
     ...
     */
    CubismModelUserData.delete = function(modelUserData?: any) {
     ...
     * @param size      バッファのサイズ
     */
    CubismModelUserData.prototype.parseUserData = function(buffer?: any, size?: any) {
