...
var CubismModelUserDataJson = /** @class */ (function() {
     ...
     * @param size      バッファのサイズ
     */
    function CubismModelUserDataJson(buffer?: any, size?: any) {
     ...
     * @return ユーザーデータのタイプ
     */
    CubismModelUserDataJson.prototype.getUserDataTargetType = function(i?: any) {
        return this._json
            .getRoot()
     ...
     */
    CubismModelUserDataJson.prototype.getUserDataId = function(i?: any) {
     ...
     * @return ユーザーデータ
     */
    CubismModelUserDataJson.prototype.getUserDataValue = function(i?: any) {
        return this._json
            .getRoot()
            .getValueByString(UserData)
            .getValueByIndex(i)
