...
var CubismPose = /** @class */ (function() {
     ...
     * @return 作成されたインスタンス
     */
    CubismPose.create = function(pose3json?: any, size?: any) {
     ...
     */
    CubismPose.delete = function(pose?: any) {
        if (pose != null) {
            pose = null;
        }
    };
     ...
     */
    CubismPose.prototype.updateParameters = function(model?: any, deltaTimeSeconds?: any) {
     ...
     */
    CubismPose.prototype.reset = function(model?: any) {
        var beginIndex = 0;
        for (var i = 0; i < this._partGroupCounts.getSize(); ++i) {
     ...
     * @param model 対象のモデル
     */
    CubismPose.prototype.copyPartOpacities = function(model?: any) {
     ...
     */
    CubismPose.prototype.doFade = function(model?: any, deltaTimeSeconds?: any, beginIndex?: any, partGroupCount?: any) {
...
var PartData = /** @class */ (function() {
     ...
     * =演算子のオーバーロード
     */
    PartData.prototype.assignment = function(v?: any) {
        this.partId = v.partId;
        for (var ite = v.link.begin(); ite.notEqual(v.link.end()); ite.preIncrement()) {
            this.link.pushBack(ite.ptr().clone());
        }
     ...
     */
    PartData.prototype.initialize = function(model?: any) {
