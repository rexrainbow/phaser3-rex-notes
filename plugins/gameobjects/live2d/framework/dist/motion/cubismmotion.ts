...
function lerpPoints(a?: any, b?: any, t?: any) {
    var result = new cubismmotioninternal_1.CubismMotionPoint();
    result.time = a.time + (b.time - a.time) * t;
    result.value = a.value + (b.value - a.value) * t;
    return result;
}
function linearEvaluate(points?: any, time?: any) {
...
function bezierEvaluate(points?: any, time?: any) {
...
function bezierEvaluateBinarySearch(points?: any, time?: any) {
    var x_error = 0.01;
    var x = time;
...
function bezierEvaluateCardanoInterpretation(points?: any, time?: any) {
    var x = time;
    var x1 = points[0].time;
    var x2 = points[3].time;
    var cx1 = points[1].time;
...
function steppedEvaluate(points?: any, time?: any) {
    return points[0].value;
}
function inverseSteppedEvaluate(points?: any, time?: any) {
    return points[1].value;
}
function evaluateCurve(motionData?: any, index?: any, time?: any) {
 ...
 * モーションのクラス。
 */
var CubismMotion = /** @class */ (function(_super?: any) {
     ...
     * @return 作成されたインスタンス
     */
    CubismMotion.create = function(buffer?: any, size?: any, onFinishedMotionHandler?: any) {
     ...
     */
    CubismMotion.prototype.doUpdateParameters = function(model?: any, userTimeSeconds?: any, fadeWeight?: any, motionQueueEntry?: any) {
     ...
     * @param loop ループ情報
     */
    CubismMotion.prototype.setIsLoop = function(loop?: any) {
        this._isLoop = loop;
    };
    /**
     * ループ情報の取得
     ...
     */
    CubismMotion.prototype.setIsLoopFadeIn = function(loopFadeIn?: any) {
     ...
     */
    CubismMotion.prototype.setParameterFadeInTime = function(parameterId?: any, value?: any) {
        var curves = this._motionData.curves;
     ...
     */
    CubismMotion.prototype.setParameterFadeOutTime = function(parameterId?: any, value?: any) {
        var curves = this._motionData.curves;
        for (var i = 0; i < this._motionData.curveCount; ++i) {
            if (parameterId == curves.at(i).id) {
     ...
     */
    CubismMotion.prototype.getParameterFadeInTime = function(parameterId?: any) {
        var curves = this._motionData.curves;
        for (var i = 0; i < this._motionData.curveCount; ++i) {
            if (parameterId == curves.at(i).id) {
     ...
     */
    CubismMotion.prototype.getParameterFadeOutTime = function(parameterId?: any) {
        var curves = this._motionData.curves;
        for (var i = 0; i < this._motionData.curveCount; ++i) {
            if (parameterId == curves.at(i).id) {
     ...
     */
    CubismMotion.prototype.setEffectIds = function(eyeBlinkParameterIds?: any, lipSyncParameterIds?: any) {
     ...
     * @param size        バッファのサイズ
     */
    CubismMotion.prototype.parse = function(motionJson?: any, size?: any) {
     ...
     */
    CubismMotion.prototype.getFiredEvent = function(beforeCheckTimeSeconds?: any, motionTimeSeconds?: any) {
