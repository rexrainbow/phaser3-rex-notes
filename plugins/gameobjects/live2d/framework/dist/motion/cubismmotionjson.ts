...
var CubismMotionJson = /** @class */ (function() {
     ...
     * @param size バッファのサイズ
     */
    function CubismMotionJson(buffer?: any, size?: any) {
    ...
    CubismMotionJson.prototype.getEvaluationOptionFlag = function(flagType?: any) {
     ...
     * @return カーブの種類
     */
    CubismMotionJson.prototype.getMotionCurveTarget = function(curveIndex?: any) {
        return this._json
            .getRoot()
     ...
     * @return カーブのID
     */
    CubismMotionJson.prototype.getMotionCurveId = function(curveIndex?: any) {
     ...
     * @return false 存在しない
     */
    CubismMotionJson.prototype.isExistMotionCurveFadeInTime = function(curveIndex?: any) {
        return !this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     * @return false 存在しない
     */
    CubismMotionJson.prototype.isExistMotionCurveFadeOutTime = function(curveIndex?: any) {
        return !this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     * @return フェードイン時間[秒]
     */
    CubismMotionJson.prototype.getMotionCurveFadeInTime = function(curveIndex?: any) {
        return this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     * @return フェードアウト時間[秒]
     */
    CubismMotionJson.prototype.getMotionCurveFadeOutTime = function(curveIndex?: any) {
        return this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     */
    CubismMotionJson.prototype.getMotionCurveSegmentCount = function(curveIndex?: any) {
        return this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     * @return セグメントの値
     */
    CubismMotionJson.prototype.getMotionCurveSegment = function(curveIndex?: any, segmentIndex?: any) {
        return this._json
            .getRoot()
            .getValueByString(Curves)
            .getValueByIndex(curveIndex)
     ...
     * @return イベントの時間[秒]
     */
    CubismMotionJson.prototype.getEventTime = function(userDataIndex?: any) {
        return this._json
            .getRoot()
     ...
     * @return イベントの文字列
     */
    CubismMotionJson.prototype.getEventValue = function(userDataIndex?: any) {
...
(function(EvaluationOptionFlag?: any) {
