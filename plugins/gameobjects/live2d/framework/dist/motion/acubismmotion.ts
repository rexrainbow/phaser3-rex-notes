...
var ACubismMotion = /** @class */ (function() {
    ...
    function ACubismMotion() {
         ...
         */
        this.setFinishedMotionHandler = function(onFinishedMotionHandler?: any) { return (_this._onFinishedMotion = onFinishedMotionHandler); };
        /**
         * モーション再生終了コールバックの取得
         *
     ...
     * インスタンスの破棄
     */
    ACubismMotion.delete = function(motion?: any) {
        motion.release();
        motion = null;
    };
    /**
     ...
     */
    ACubismMotion.prototype.updateParameters = function(model?: any, motionQueueEntry?: any, userTimeSeconds?: any) {
     ...
     */
    ACubismMotion.prototype.setFadeInTime = function(fadeInSeconds?: any) {
     ...
     */
    ACubismMotion.prototype.setFadeOutTime = function(fadeOutSeconds?: any) {
     ...
     */
    ACubismMotion.prototype.setWeight = function(weight?: any) {
        this._weight = weight;
    };
    /**
     * モーション適用の重みの取得
     ...
     */
    ACubismMotion.prototype.setOffsetTime = function(offsetSeconds?: any) {
     ...
     */
    ACubismMotion.prototype.getFiredEvent = function(beforeCheckTimeSeconds?: any, motionTimeSeconds?: any) {
