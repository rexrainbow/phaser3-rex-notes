 ...
 * 表情のモーションクラス。
 */
var CubismExpressionMotion = /** @class */ (function(_super?: any) {
     ...
     * @return 作成されたインスタンス
     */
    CubismExpressionMotion.create = function(buffer?: any, size?: any) {
     ...
     */
    CubismExpressionMotion.prototype.doUpdateParameters = function(model?: any, userTimeSeconds?: any, weight?: any, motionQueueEntry?: any) {
...
(function(ExpressionBlendType?: any) {
