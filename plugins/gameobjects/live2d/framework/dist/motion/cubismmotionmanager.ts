 ...
 * モーションの管理を行うクラス
 */
var CubismMotionManager = /** @class */ (function(_super?: any) {
     ...
     * @param   val     優先度
     */
    CubismMotionManager.prototype.setReservePriority = function(val?: any) {
     ...
     */
    CubismMotionManager.prototype.startMotionPriority = function(motion?: any, autoDelete?: any, priority?: any) {
     ...
     */
    CubismMotionManager.prototype.updateMotion = function(model?: any, deltaTimeSeconds?: any) {
     ...
     */
    CubismMotionManager.prototype.reserveMotion = function(priority?: any) {
        if (priority <= this._reservePriority ||
