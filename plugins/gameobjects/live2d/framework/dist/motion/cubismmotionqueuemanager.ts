...
var CubismMotionQueueManager = /** @class */ (function() {
     ...
     */
    CubismMotionQueueManager.prototype.startMotion = function(motion?: any, autoDelete?: any, userTimeSeconds?: any) {
        if (motion == null) {
     ...
     * @return false 終了していない
     */
    CubismMotionQueueManager.prototype.isFinishedByHandle = function(motionQueueEntryNumber?: any) {
    ...
    /**
         * 指定したCubismMotionQueueEntryの取得
          ...
          */
    CubismMotionQueueManager.prototype.getCubismMotionQueueEntry = function(motionQueueEntryNumber?: any) {
        //------- 処理を行う -------
     ...
     */
    CubismMotionQueueManager.prototype.setEventCallback = function(callback?: any, customData?: any) {
     ...
     */
    CubismMotionQueueManager.prototype.doUpdateMotion = function(model?: any, userTimeSeconds?: any) {
        var updated = false;
        // ------- 処理を行う --------
        // 既にモーションがあれば終了フラグを立てる
        for (var ite = this._motions.begin(); ite.notEqual(this._motions.end());) {
