...
export default {
    setDepth(value?: any, containerOnly?: any) {
        this.depth = value;
    ...
    moveMyDepthBelow(gameObject?: any) {
        return this.moveDepthBelow(gameObject);
    },

    moveDepthAbove(gameObject?: any) {
        var displayList = this.displayList;
        if (!displayList) {
            return this;
        }
    ...
    moveMyDepthAbove(gameObject?: any) {
        return this.moveDepthAbove(gameObject);
    },

    bringChildToTop(child?: any) {
