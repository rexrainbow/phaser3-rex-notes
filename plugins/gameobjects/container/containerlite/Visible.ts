...
export default {
    ...
    resetChildVisibleState(child?: any) {
        var localState = GetLocalState(child);
    ...
    // Internal method
    setChildLocalVisible(child?: any, visible?: any) {
    ...
    // Internal method
    setChildMaskVisible(child?: any, visible?: any) {
        if (visible === undefined) {
            visible = true;
        }
        var localState = GetLocalState(child);
    ...
    getChildLocalVisible(child?: any) {
        var localState = GetLocalState(child);
