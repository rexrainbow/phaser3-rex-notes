...
var Add = function(gameObject?: any, config?: any) {
...
var AddLocal = function(gameObject?: any, config?: any) {
    this.setParent(gameObject);
...
var SetupSyncFlags = function(state?: any, config?: any) {
    if (config === undefined) {
        config = true;
    }
...
var SyncDisplayList = function(gameObject?: any, state?: any) {
...
export default {
    ...
    // Don't override this method
    pinLocal(gameObject?: any, config?: any) {
        if (Array.isArray(gameObject)) {
            this.addMultiple(gameObject, config);
        } else {
    ...
    addLocalMultiple(gameObjects?: any) {
        for (var i = 0, cnt = gameObjects.length; i < cnt; i++) {
