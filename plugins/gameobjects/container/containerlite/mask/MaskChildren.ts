...
var MaskChildren = function ({
    ...
    for (var i = 0, cnt = children.length; i < cnt; i++) {
        ...
        if (child.getBounds) {
            ...
            switch (visiblePointsNumber?: any) {
...
var IsVisible = function(gameObject?: any) {
    ...
    while (1) {
        ...
        if (!localState) { // Top game object
            ...
            if (parent?: any) { // Test parent's visible
                gameObject = parent;
                continue;
...
var ContainsPoints = function(rectA?: any, rectB?: any) {
    var top = rectB.top,
        bottom = rectB.bottom,
        left = rectB.left,
        right = rectB.right;
...
var SetVisible = function(parent?: any, child?: any, maskGameObject?: any) {
...
var SetPartiallyVisible = function(parent?: any, child?: any, maskGameObject?: any) {
    if (!child.hasOwnProperty('isRexContainerLite')) {
...
var SetInvisible = function(parent?: any, child?: any, maskGameObject?: any) {
    if (!child.hasOwnProperty('isRexContainerLite')) {
        ClearMask(child);
