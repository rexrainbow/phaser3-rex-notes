...
export default {
    ...
    removeFromLayer(addToScene?: any) {
    ...
    addToParentContainer(gameObject?: any) {
    ...
    addToPatentLayer(gameObject?: any) {
        // Do nothing if gameObject is not in any displayList
        if (!gameObject.displayList) {
            return this;
        }
