...
import NumberInputUpdateCallback from '../../../../behaviors/hiddentextedit/defaultcallbacks/NumberInputUpdateCallback';
import SelectRange from './SelectRange';
import MoveCursor from './MoveCursor';
import ClearSelectRange from './ClearSelectRange';
import ClearCursor from './ClearCursor';
...
class HiddenTextEdit extends HiddenTextEditBase {
    ...
    cursorMoveStartIndex: any;
    firstClickAfterOpen: any;
    isOpened: any;
    onUpdateCallback: any;
    parent: any;
    prevCursorPosition: any;
    prevSelectionEnd: any;
    prevSelectionStart: any;
    requestCursorPosition: any;
    selectAll: any;
    selectAllWhenFocus: any;
    selectionEnd: any;
    selectionStart: any;
    selectText: any;
    ...
    setSelectAllWhenFocusEnable(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
    ...
    setRequestCursorPosition(value?: any) {
        if (!this.isOpened) {
            return this;
        }
