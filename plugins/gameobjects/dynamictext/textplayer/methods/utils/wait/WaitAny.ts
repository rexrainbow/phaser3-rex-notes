import { IsWaitCameraEffect } from './WaitCameraEffect';
import { IsWaitGameObject, WaitGameObject } from './WaitGameObject'

import { Input as PhaserInput } from 'phaser';
const KeyCodes = PhaserInput.Keyboard.KeyCodes;

var WaitAny = function(textPlayer?: any, names?: any, callback?: any, scope?: any) {
