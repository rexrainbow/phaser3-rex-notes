...
var IsPropTag = function(tags?: any, goType?: any) {
    // goType.name.prop
    return (tags.length === 3) && (tags[0] === goType);
}

var OnParseCallGameObjectMethodTag = function(textPlayer?: any, parser?: any, config?: any) {
    var goType = config.name;
    parser
        .on(`+`, function(tag?: any, ...parameters) {
...
var CallMethod = function(params?: any) {
