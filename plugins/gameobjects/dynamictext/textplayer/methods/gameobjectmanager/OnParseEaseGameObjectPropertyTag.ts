...
var IsEasePropertyTag = function(tags?: any, goType?: any) {
    // goType.name.prop.to
    return (tags.length === 4) && (tags[0] === goType) && EaseMode[tags[3]];
}

var OnParseEaseGameObjectPropertyTag = function(textPlayer?: any, parser?: any, config?: any) {
    var goType = config.name;
    var gameObjectManager = textPlayer.getGameObjectManager(goType);
    parser
        .on(`+`, function(tag?: any, value?: any, duration?: any, ease?: any, repeat?: any) {
...
var EaseProperty = function(params?: any) {
