...
var OnParsePlayBackgroundMusicTag = function(textPlayer?: any, parser?: any, config?: any) {
    var tagName = 'bgm';
    parser
...
var PlayBackgroundMusic = function(params?: any) {
    var name = params[0];
...
var PlayBackgroundMusic2 = function(params?: any) {
    var name = params[0];
    var fadeInTime = params[1];
