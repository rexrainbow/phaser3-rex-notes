...
import OnTextureChange from './OnTextureChange';
...
var GetValueFromConfigs = function(key?: any, defaultValue?: any, ...configs) {
...
export default {
    setTransitionDirection(dir?: any) {
    ...
    setEaseFunction(ease?: any) {
        this.easeFunction = ease;
        return this;
    },

    setNextTexture(texture?: any, frame?: any) {
    ...
    transit(texture?: any, frame?: any, mode?: any) {
        if (this.isRunning) {
    ...
    addTransitionMode(name?: any, config?: any) {
