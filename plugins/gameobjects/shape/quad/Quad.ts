...
import PointMethods from './methods/PointMethods';
import QuadGeom from './methods/QuadGeom';
...
class Quad extends PolygnBase {
    ...
    geom: any;
    init: any;
    insertBottomSidePoint: any;
    insertLeftSidePoint: any;
    insertRightSidePoint: any;
    insertTopSidePoint: any;
    pathData: any;
    pathIndexes: any;
    setFillStyle: any;
    setPosition: any;
...
var SortPoints = function(points?: any) {
    if (points.length <= 1) {
        return;
    }
    points.sort(function(pointA?: any, pointB?: any) {
