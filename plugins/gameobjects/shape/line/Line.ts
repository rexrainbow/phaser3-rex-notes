...
class Line extends BaseShapes {
    ...
    padding: any;
    setDashPattern: any;
    setHeadFillStyle: any;
    setHeadShape: any;
    setHeadSize: any;
    setHeadStrokeStyle: any;
    setPointRadius: any;
    setStrokeStyle: any;
    setTailFillStyle: any;
    setTailShape: any;
    setTailSize: any;
    setTailStrokeStyle: any;
    type: any;
    updateData: any;

    constructor(scene?: any, points?: any, lineWidth?: any, color?: any, alpha?: any, config?: any) {
    ...
    setLine(points?: any, lineType?: any) {
        if (points === undefined) {
            points = [];
        }
