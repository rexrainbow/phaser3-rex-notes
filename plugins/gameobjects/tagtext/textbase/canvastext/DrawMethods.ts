...
var GetEndLineIndex = function(lines?: any, targetOffset?: any) {
...
export default {
    draw(startX?: any, startY?: any, textWidth?: any, textHeight?: any) {
    ...
    drawPen(pen?: any, offsetX?: any, offsetY?: any, rtlOffset?: any, lineHeight?: any) {
        offsetX += pen.x;
    ...
    drawRectangle(x?: any, y?: any, width?: any, height?: any, color?: any, style?: any) {
        if (this.autoRound) {
            x = Math.round(x);
            y = Math.round(y);
        }
    ...
    drawLine(x?: any, y?: any, width?: any, height?: any, color?: any, style?: any) {
        if (this.autoRound) {
            x = Math.round(x);
            y = Math.round(y);
        }
    ...
    drawText(x?: any, y?: any, text?: any, style?: any) {
        if (this.autoRound) {
            x = Math.round(x);
            y = Math.round(y);
        }
    ...
    drawImage(x?: any, y?: any, imgKey?: any, color?: any, style?: any) {
        y -= this.startYOffset;
