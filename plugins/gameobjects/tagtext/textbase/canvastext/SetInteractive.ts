...
var OnAreaDown = function(pointer?: any, localX?: any, localY?: any, event?: any) {
...
var OnAreaUp = function(pointer?: any, localX?: any, localY?: any, event?: any) {
    var area = this.hitAreaManager.getFirst(localX, localY);
    if (area === null) {
        return;
    }
...
var OnAreaOverOut = function(pointer?: any, localX?: any, localY?: any, event?: any) {
...
var FireEvent = function(eventName?: any, key?: any, pointer?: any, localX?: any, localY?: any, event?: any) {
    this.parent.emit(`${eventName}-${key}`, pointer, localX, localY, event);
    this.parent.emit(eventName, key, pointer, localX, localY, event);
}

var SetCursorStyle = function(scene?: any, area?: any, cursorStyle?: any) {
