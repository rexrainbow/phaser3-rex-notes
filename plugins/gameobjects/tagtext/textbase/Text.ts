...
import WrapTextLinesPoolClass from './wraptext/WrapTextLinesPool';
...
import AppendText from '../../../utils/text/AppendText';
...
class Text extends TextBase {
    ...
    setScrollY(value?: any, clamp?: any) {
        if (clamp === undefined) {
            clamp = false;
        }
        if (clamp?: any) {
    ...
    setInteractive(hitArea?: any, hitAreaCallback?: any, dropZone?: any) {
    ...
    setUrlTagCursorStyle(cursor?: any) {
    ...
    getWrappedText(text?: any, start?: any, end?: any) {
    ...
    getSubString(text?: any, start?: any, end?: any) {
        if (typeof (text) === 'number') {
            end = start;
            start = text;
            text = undefined;
    ...
    copyPenManager(penManager?: any) {
        return this.canvasText.copyPenManager(penManager);
    }

    getPenManager(text?: any, penManager?: any) {
    ...
    addImage(key?: any, config?: any) {
        this.imageManager.add(key, config);
        return this;
    }

    drawAreaBounds(graphics?: any, color?: any) {
    ...
    getHitArea(worldX?: any, worldY?: any, camera?: any) {
