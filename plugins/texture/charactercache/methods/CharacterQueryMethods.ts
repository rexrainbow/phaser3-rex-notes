...
var CreateCharacterItem = function(character?: any) {
    return {
        character: character,
        freq: 0,
        alive: false,
...
var GetChatacter = function(collection?: any, character?: any) {
...
var GetInCacheCharacterItems = function(collection?: any, config?: any) {
...
var GetLockedCharacterItems = function(collection?: any) {
    return collection.find({ lock: true });
}

var GetAllItems = function(collection?: any, config?: any) {
