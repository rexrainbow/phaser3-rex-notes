...
import InstallTap from './InstallTap';
import InstallPress from './InstallPress';
...
class Input {
    ...
    pointer: any;
    press: any;
    prevTilePosition: any;
    swipe: any;
    tap: any;
    tilePosition: any;
    touchZone: any;

    constructor(board?: any, config?: any) {
    ...
    onBoardDestroy(parent?: any, fromScene?: any) {
