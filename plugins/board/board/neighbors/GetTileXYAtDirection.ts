...
var GetTileXYAtDirection = function(chess?: any, directions?: any, distance?: any, out?: any) {
    ...
    if (isNumberDirection && isNumberDistance) {
        ...
        var resultTileXY;
        if (isNumberDirection?: any) {  // directions is a number, distance is an object or list
            ...
            for (var i = 0, cnt = directions.length; i < cnt; i++) {
                if (isNumberDistance?: any) { // return a single tileXY
