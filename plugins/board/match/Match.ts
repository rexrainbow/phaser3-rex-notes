...
class Match {
    ...
    setSymbol(tileX?: any, tileY?: any, symbol?: any) {
    ...
    refreshSymbols(callback?: any, scope?: any) {
        var board = this.board;
    ...
    setWildcard(symbol?: any) {
        this.wildcard = symbol;
        return this;
    }

    tileXYToKey(tileX?: any, tileY?: any) {
        return tileX + (tileY * this.board.width);
    }

    keyToTileXY(key?: any, out?: any) {
        if (out === undefined) {
            out = {};
        } else if (out === true) {
            out = globTileXY;
