...
import HexagonGrid from '../utils/grid/hexagon/Hexagon';
import GlobZone from '../utils/actions/GlobZone';
import AlignIn from '../utils/align/align/in/QuickSet';
...
var GridAlign = function(items?: any, options?: any) {
