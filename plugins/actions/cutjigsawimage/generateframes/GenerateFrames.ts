import FrameManager from '../../../texture/framemanager/FrameManager';
import GenerateEdges from './GenerateEdges';
import DefaultDrawShapeCallback from './jigsawpiece/DefaultDrawShapeCallback';
import JigsawPieceRenderTexurue from './jigsawpiece/JigsawPieceRenderTexurue';
import DrawCanvasPieceCallback from './jigsawpiece/DrawCanvasPieceCallback';
import NOOP from '../../../utils/object/NOOP';

var DefaultGetFrameNameCallback = function(c?: any, r?: any) {
    return `${c},${r}`;
}
    ...
    for (var r = 0; r < rows; r++) {
        for (var c = 0; c < columns; c++) {
            ...
            if (useDynamicTexture?: any) {
                ...
                // Use canvas-texture
                frameManager.draw(frameName, function(canvas?: any, context?: any, frameSize?: any) {
