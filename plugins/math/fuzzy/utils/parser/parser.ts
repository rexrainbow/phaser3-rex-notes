...
*/
var parser = (function(){
var o=function(k?: any,v?: any,o?: any,l?: any){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[1,6],$V2=[1,7],$V3=[1,10],$V4=[1,11],$V5=[1,12],$V6=[2,14],$V7=[1,15],$V8=[5,16,17],$V9=[5,13,14,16,17];
...
parse: function parse(input?: any) {
    ...
    function GetOperator1(operator?: any, op1?: any) {
        operator = operator.toLowerCase();
        return [operator, op1];
    }

    function GetOperator2(operator?: any, op1?: any, op2?: any) {
        operator = operator.toLowerCase();
        var result = [operator];
