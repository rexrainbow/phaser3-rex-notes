...
import KeyHub from './methods/KeyHub';
import Methods from './methods/Methods';
import KeyMap from '../../utils/input/KeyMap';
...
class KeysHub extends ComponentBase {
    ...
    plugKeyObject(keyObject?: any, key?: any) {
        if (!keyObject) {
