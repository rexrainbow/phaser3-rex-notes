...
import CreateFakeKeyboardEvent from '../../../utils/input/CreateFakeKeyboardEvent';
...
class KeyHub extends Key {
    ...
    constructor(parent?: any, keyCode?: any) {
    ...
    plugKeyObject(keyObject?: any) {
        if (keyObject.refKeyHub) {
            keyObject.refKeyHub.unplugKeyObject(keyObject);
        }

        AddItem(this.ports, keyObject, 0, function(keyObject?: any) {
            keyObject
    ...
    unplugKeyObject(keyObject?: any) {
        ...
        RemoveItem(this.ports, keyObject, function(keyObject?: any) {
            keyObject
