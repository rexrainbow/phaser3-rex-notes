...
import DrapSpeed from '../../dragspeed';
import SlowDown from '../../utils/movement/SlowDown';
...
class Scroller extends ComponentBase {
    ...
    setSlidingDeceleration(dec?: any) {
        this.slidingDeceleration = dec;
        return this;
    }

    setBackDeceleration(dec?: any) {
        this.backDeceleration = dec;
        return this;
    }

    setDragRate(ratio?: any) {
        this.dragRate = ratio;
        return this;
    }

    setBounds(value0?: any, value1?: any) {
