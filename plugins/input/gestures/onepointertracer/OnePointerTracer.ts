...
class OnePointerTracer extends TickTask {
    ...
    destroy: any;
    emit: any;
    isTouchingAnyObject: any;
    lastPointer: any;
    movedState: any;
    onLastPointerMove: any;
    pointer: any;
    pointerCamera: any;
    recongizedState: any;
    scene: any;
    ...
    onPointerDown(pointer?: any, gameObjects?: any) {
        if (!this.enable) {
            return;
        }
    ...
    setRecongizedStateObject(stateObject?: any) {
    ...
    isPointerInGameObject(gameObject?: any, preTest?: any, postTest?: any) {
