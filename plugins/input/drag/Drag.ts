...
class Drag extends ComponentBase {
    ...
    onDragStart(pointer?: any, dragX?: any, dragY?: any) {
        if (this.isDragging) {
            return;
        }
    ...
    onDrag(pointer?: any, dragX?: any, dragY?: any) {
    ...
    onDragEnd(pointer?: any, dragX?: any, dragY?: any, dropped?: any) {
        if (this.pointer !== pointer) {
            return;
        }
        this.pointer = undefined;
