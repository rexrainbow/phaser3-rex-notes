...
class LevelCounter extends EventEmitter {
    ...
    checkLevel(level?: any, exp?: any) {
        return (exp >= this.getExp(level)) && (exp < this.getExp(level + 1));
    }

    gainExp(incExp?: any, callback?: any, scope?: any) {
        if (callback?: any) {
    ...
    setExp(exp?: any, callback?: any, scope?: any) {
        if (callback?: any) {
            this.on('levelup', callback, scope);
        }
    ...
    setLevel(level?: any, callback?: any, scope?: any) {
        if (callback?: any) {
            this.on('levelup', callback, scope);
        }
