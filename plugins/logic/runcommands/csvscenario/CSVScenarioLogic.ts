...
import CmdHandlers from './commands/CmdHandlers';
import { WaitComplete } from '../../../utils/promise/WaitEvent';
import Timer from './timer/DefaultTimer';
...
class CSVScenarioLogic {
    ...
    setEventEmitter: any;
    timer: any;
    translateCommandNameCallback: any;
    waitEvent: any;
    ...
    // Override
    boot(parent?: any, config?: any) {
        return this;
    }

    // Override
    createTimer(parent?: any, config?: any) {
    ...
    load(strCmd?: any, scope?: any, config?: any) {
        this.clear();
