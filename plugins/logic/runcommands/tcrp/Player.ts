...
class Player extends ComponentBase {
    ...
    load(commands?: any, scope?: any, config?: any) {
        ...
        if (this.dtMode === 0) {
            commands.sort(function(itemA?: any, itemB?: any) {
                var dtA = itemA[0],
                    dtB = itemB[0];
                return (dtA > dtB) ? 1 :
                    (dtA < dtB) ? -1 : 0;
        ...
        ArrayCopy(this.commands, commands);
        this.scope = scope;
        return this;
    }
