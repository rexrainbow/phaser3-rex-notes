...
import DefaultValueConverter from '../../../utils/string/TypeConvert';
...
class BracketParser {
    ...
    setMultipleLinesTagEnable(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
    ...
    setTranslateTagNameCallback(callback?: any) {
        this.translateTagNameCallback = callback;
        return this;
    }

    setValueConverter(converter?: any) {
        if (converter === true) {
...
const BypassValueConverter = function(s?: any) { return s; }
