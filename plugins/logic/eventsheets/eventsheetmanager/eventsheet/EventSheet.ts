import { BehaviorTree, IfSelector, IDLE, RUNNING } from '../../../behaviortree/index';
...
class EventSheet extends BehaviorTree {
    ...
    constructor(eventSheetManager?: any, config?: any) {
        if (config === undefined) {
            config = {};
        }
    ...
    start(blackboard?: any, target?: any) {
