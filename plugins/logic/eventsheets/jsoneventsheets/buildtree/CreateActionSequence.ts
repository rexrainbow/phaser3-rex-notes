...
import BreakDecorator from '../../eventsheetmanager/nodes/BreakDecorator';
import ContinueDecorator from '../../eventsheetmanager/nodes/ContinueDecorator';
...
var CreateActionSequence = function(actions?: any, title?: any, hasLabel?: any) {
...
- Selector
  ...
  ...
*/
var CreateIFNode = function(nodeData?: any) {
...
*/
var CreateWhileNode = function(nodeData?: any) {
    // Prepare nodes
...
*/
var CreateRepeatNode = function(nodeData?: any) {
    // Prepare nodes
    var breakDecorator = new BreakDecorator();
  ...
  - RepeatUntilFailure(Decorator)
    - condition block: If(Decorator)
      - Sequence
        ...
        - step block: Sequence
*/
var CreateForNode = function(nodeData?: any) {
    // Prepare nodes
    var breakDecorator = new BreakDecorator();
...
*/
var CreateSequenceNode = function(nodeData?: any, config = {}) {
