var GetConditionExpression = function(nodes?: any) {
    ...
    switch (nodes.length) {
        ...
        default:
            expression = nodes.map(function(node?: any) {
...
var GetANDExpression = function(node?: any) {
    ...
    switch (lines.length) {
        ...
        default:
            expression = lines.map(function(line?: any) { return `(${line})` }).join(' && ');
            break;
