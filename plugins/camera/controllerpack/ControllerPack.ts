...
class ControllerPack extends ComponentBase {
    panScrollEnableSave: any;

    _camera: any;
    _enable: any;
    boundsScroll: any;
    boundsScrollEnableSave: any;
    mouseWheelZoom: any;
    mouseWheelZoomEnableSave: any;
    panScroll: any;
    pinchZoom: any;
    pinchZoomEnableSave: any;
    scene: any;
    ...
    setBoundsScrollEnable = function(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
    ...
    setMouseWheelZoomEnable(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
    ...
    setPinchZoomEnable = function(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
    ...
    setPanScrollEnable = function(enable?: any) {
        if (enable === undefined) {
            enable = true;
        }
