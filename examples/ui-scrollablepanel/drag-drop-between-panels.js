            ...
            if (!child.drag) {
                ...
                child
                    .on('dragstart', function (pointer, dragX, dragY) {
                        ...
                        if (child.displayList !== child.scene.children) {
                            // Child is at render layer of scrollable panel
                            child.setData('layer', child.displayList);
                            child.addToScene(child.scene);  // Move out from render layer to scene
                        }
                    })
