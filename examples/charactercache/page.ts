...
import CharacterCachePlugin from '../../plugins/charactercache-plugin';
import TextPagePlugin from '../../plugins/textpage-plugin'
...
class Demo extends Phaser.Scene {
    ...
    create() {
        ...
        // Create bitmaptext
        var txt = characterCache.addBitmapText(this, 100, 100);
