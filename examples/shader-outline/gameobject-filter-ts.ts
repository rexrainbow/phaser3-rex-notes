...
import OutlineFilterPlugin from '../../plugins/outlinefilter-plugin';
        ...
        for (var i = 0; i < 20; i++) {
            ...
            gameObject
                ...
                .on('pointerover', function () {
                    ...
                    */
                    var filters = gameObject.enableFilters().filters;
                    if (!filters) {
                        return;
                    }

                    var controller0 = filters.internal.addRexOutline({
                            thickness: 3,
                            outlineColor: 0xff8a50
                        })
                        .setPaddingOverride(null)

                    var controller1 = filters.internal.addRexOutline({
                            thickness: 3,
                            outlineColor: 0xc41c00
                        })
                        .setPaddingOverride(null)
