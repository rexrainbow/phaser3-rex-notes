...
import AwaitComlinkLoaderPlugin from '../../plugins/awaitcomlinkloader-plugin';
...
class Demo extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.rexAwaitComlink({
            ...
            workerFilePath: './examples/awaitcomlinkloader/worker-object.js',
            run: 'run',
            ...
            async onBegin(data, comlinkObj, worker) {
                console.log('onBegin', data);
                textObject.text += `a=${data.a}, b=${data.b}\n`;
                console.log(comlinkObj);
                console.log(worker);
