...
import PathFollowerPlugin from '../../plugins/pathfollower-plugin';
...
class Demo extends Phaser.Scene {
    ...
    create() {
        ...
        var gameObject0 = this.add.rectangle(0, 0, 30, 30, COLOR_MAIN);
        ...
        var gameObject1 = this.add.rectangle(0, 0, 30, 30, COLOR_MAIN);
