...
import CanvasDataPlugin from '../../plugins/canvasdata-plugin';
import CreateRectangleTexture from '../../plugins/utils/texture/CreateRectangleTexture';
import CameraControllerPlugin from '../../plugins/cameracontroller-plugin';
